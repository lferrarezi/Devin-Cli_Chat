"use strict";var c=require("vscode"),u=require("fs"),l=require("path"),y=require("os"),F=require("child_process"),Xe=require("crypto"),Ee="devinCliChat",et=["auto","sonnet","opus","swe","gpt"],ae=["auto","adaptive","sonnet","opus","swe","gpt","codex"],de="devinCliChat.chatHistory.v1",oe="devinCliChat.firstInstallLayout.v1",tt=50,ee=1024*1024,te=50,nt=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),g,L,W,P,G=new Map,_={at:0,values:void 0},H={at:0,values:void 0},j={at:0,values:void 0};function f(n){let e=new Date().toISOString();P&&P.appendLine(`[${e}] ${n}`)}function Ae(){return 1e4}function at(){return Math.max(0,Number(m().get("cacheModelosMs")||18e5))}function R(){_={at:0,values:void 0},H={at:0,values:void 0},j={at:0,values:void 0}}function Ie(n){return/^[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}$/.test(String(n||"").trim())}function m(){return c.workspace.getConfiguration(Ee)}function v(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].uri.fsPath:void 0}function B(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].name:"sem pasta aberta"}function Te(n){if(!n)return n;let e=String(n);return e==="~"?y.homedir():e.startsWith("~/")||e.startsWith("~\\")?l.join(y.homedir(),e.slice(2)):e}function S(n){let e=Te(n);return e&&(l.isAbsolute(e)?e:l.join(v()||y.homedir(),e))}function pe(n){try{return!!n&&u.existsSync(n)}catch{return!1}}function Le(){return Xe.randomBytes(18).toString("base64")}function C(n,e){if(typeof n!="string")return;let a=e||2e4;return n.length>a?n.slice(0,a):n}function ke(n){return typeof n=="boolean"?n:void 0}function ot(n){return typeof n=="string"&&/^[a-zA-Z0-9][a-zA-Z0-9._:-]{0,159}$/.test(n)}function Pe(n){if(!n||typeof n!="object"||Array.isArray(n))return null;let e=C(n.type,40);if(new Set(["ready","cancelRun","verifyCli","requestSelection","attachMenu","attachFiles","pickWorkspaceFiles","manualModel","refreshModels","review","selection","insertSelection","newChat","getHistory","clearHistory","importSkillFile"]).has(e))return{type:e};if(e==="clientError")return{type:e,text:C(n.text,2e3)||""};if(e==="send"){let t=C(n.text,2e5);if(t===void 0)return null;let o={type:e,text:t},i=C(n.displayText,2e5),s=ke(n.echo),r=ke(n.hasExplicitContext);return i!==void 0&&(o.displayText=i),s!==void 0&&(o.echo=s),r!==void 0&&(o.hasExplicitContext=r),o}if(e==="terminal"){let t=C(n.text,2e5);return t===void 0?null:{type:e,text:t}}if(e==="searchWorkspaceFiles")return{type:e,query:C(n.query||"",200)||""};if(e==="setModel"||e==="setMode"||e==="setAgent"||e==="toggleSkill"){let t=C(n.value,200);return t===void 0?null:{type:e,value:t}}if(e==="listWorkspace"||e==="attachFolder"||e==="attachWorkspacePath"){let t=C(n.path||"",2e3);return t===void 0?null:{type:e,path:t}}return(e==="loadSession"||e==="deleteSession"||e==="exportSession")&&ot(n.id)?{type:e,id:n.id}:null}function Be(n){let e=String(n||"").trim();if(!e.startsWith("/"))return null;let t=(e.slice(1).split(/\s+/).shift()||"").toLowerCase(),i=e.slice(t.length+2).trim()||"o contexto atual",r={review:"Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.",tests:`Proponha e implemente testes para ${i}. Priorize cobertura de comportamento, regressao e caminhos de erro.`,plan:`Crie um plano tecnico objetivo para ${i}. Agrupe por impacto, risco e ordem de execucao.`,explain:`Explique ${i} com foco em arquitetura, fluxo de dados e pontos de manutencao.`,security:`Revise ${i} com foco em riscos de seguranca, entrada nao confiavel, execucao de comandos e exposicao de dados.`,docs:`Gere documentacao pratica para ${i}, incluindo objetivo, uso, limites e exemplos.`,"commit-msg":"Gere uma mensagem de commit convencional para as mudancas atuais, com escopo claro e resumo curto."}[t];return r?{command:t,text:r,displayText:e}:null}function z(n){return String(n??"").replace(/\r?\n/g," ").trim()}function De(n){let e=n||{},a=[];a.push("# "+(z(e.title)||"Sessao Devin")),a.push(""),a.push("- Workspace: "+(z(e.workspace)||B())),a.push("- Modelo: "+(z(e.model)||"auto")),a.push("- Agente: "+(z(e.agent)||"auto")),a.push("- Modo: "+(z(e.mode)||"resposta-integrada")),e.createdAt&&a.push("- Criada em: "+new Date(e.createdAt).toISOString()),e.updatedAt&&a.push("- Atualizada em: "+new Date(e.updatedAt).toISOString()),a.push("");let t=Array.isArray(e.messages)?e.messages:[];for(let o of t){let i=String(o&&o.role||"message").toLowerCase();a.push("## "+i.charAt(0).toUpperCase()+i.slice(1)),o&&o.ts&&a.push("_"+new Date(o.ts).toISOString()+"_"),a.push(""),a.push(String(o&&o.text||"").trim()),a.push("")}return a.join(`
`).trim()+`
`}function D(n){return`'${String(n).replace(/'/g,"'\\''")}'`}function $e(n){return String(n??"").replace(/\u0000/g,"")}function N(n){let e=String(n||"").trim().toLowerCase();return!e||e==="default"||e==="padrao"||e==="padr\xE3o"?"auto":Ie(e)?e:"auto"}function Fe(n){return N(n)}function Ce(){return[...ae]}function it(n){try{return pe(n)?JSON.parse(u.readFileSync(n,"utf8")):void 0}catch{return}}function st(){if(process.platform==="win32"){let n=process.env.APPDATA||l.join(y.homedir(),"AppData","Roaming");return l.join(n,"devin","config.json")}return l.join(y.homedir(),".config","devin","config.json")}function ue(){let n=it(st());return n&&n.agent?Fe(n.agent.model):void 0}function M(){let n=m().get("modeloAtual");return Fe(n??(ue()||"auto"))}function Ne(){let n=m().get("modeloAtual");return N(n??(ue()||"auto"))}function Z(){return String(m().get("agenteAtual")||"auto")}function K(){return String(m().get("modoExecucaoChat")||"resposta-integrada")}function I(){let n=m().get("skillsSelecionadas")||[];return Array.isArray(n)?n.map(String).filter(Boolean):[]}function w(){return String(m().get("caminhoDevin")||"devin")}function E(){return v()||y.homedir()}function Se(n){try{if(u.existsSync(n))return u.realpathSync.native?u.realpathSync.native(n):u.realpathSync(n)}catch{}return l.resolve(n)}function rt(n,e){let a=l.relative(n,e);return a===""||!!a&&!a.startsWith("..")&&!l.isAbsolute(a)}function J(n){let e=v();if(!e)return null;let a=Se(e),t=String(n||"").replace(/\\/g,l.sep).trim(),o=l.isAbsolute(t)?l.resolve(t):l.resolve(a,t),i=Se(o);return rt(a,i)?i:null}function ze(){return[Te(m().get("gitBashPath")),process.env.GIT_BASH_PATH,"C:\\Program Files\\Git\\bin\\bash.exe","C:\\Program Files\\Git\\usr\\bin\\bash.exe","C:\\Program Files (x86)\\Git\\bin\\bash.exe",l.join(y.homedir(),"AppData","Local","Programs","Git","bin","bash.exe")].filter(Boolean).find(pe)}function lt(){return process.platform==="win32"&&m().get("usarGitBashNoWindows",!0)?ze():process.env.SHELL||void 0}function Q(){let n=[...(m().get("argumentosPadrao")||[]).map(String).filter(Boolean)],e=String(m().get("argumentoModelo")||"").trim(),a=Ne();return e&&a&&a!=="auto"&&n.push(e,a),n}function $(n){let e=m().get("prefixoPromptPadrao")||"",a=Ne()||M()||"auto",t=Z(),o=I(),i=[`Workspace VS Code: ${B()}`,v()?`Diretorio raiz: ${v()}`:"Diretorio raiz: nao ha pasta aberta",`Modelo selecionado: ${a}`,`Agente selecionado: ${t}`,o.length?`Skills disponiveis: ${o.join(", ")}`:""].filter(Boolean).join(`
`),s=t!=="auto"?`Use o perfil/subagente Devin chamado "${t}" quando aplicavel. Se a CLI nao aceitar selecao direta de agente nesta chamada, trate este agente como persona operacional e siga as instrucoes do respectivo AGENT.md.`:"",r=o.length?`Invoque a skill via tool 'skill' quando aplicavel: ${o.map(d=>`"${d}"`).join(", ")}. Siga as instrucoes do respectivo SKILL.md.`:"";return $e([e,i,s,r,n].filter(Boolean).join(`

`))}function ct(n){let e=D(w()),a=Q().map(D).join(" ");return n?[e,a,"-p","--",D($(n))].filter(Boolean).join(" "):[e,a].filter(Boolean).join(" ")}function dt(n){return n?String(n).split(/\r?\n/).filter(e=>!/were not migrated because they already exist/i.test(e)).filter(e=>!/migration.*already exist/i.test(e)).join(`
`).trim():""}function _e(n,e,a){let t=dt(e),o=[n||"",t||"",a&&a.message?a.message:""].join(`
...
`)||"Sem saida do Devin CLI."}function ie(n){let e=lt(),a=c.window.createTerminal({name:m().get("nomeTerminal")||"Devin Cli Chat",cwd:E(),shellPath:e,shellArgs:process.platform==="win32"&&e?["--login","-i"]:void 0});a.show(!0),a.sendText(ct(n))}function U(n){return n||"__default__"}function me(n,e){let a=U(n);return G.set(a,Object.assign({sessionId:a,cancelRequested:!1,startedAt:Date.now()},e||{})),G.get(a)}function O(n){return G.get(U(n))}function he(n){G.delete(U(n))}function He(){return Array.from(G.keys())}function fe(n){let e=O(n);if(!e)return!1;e.cancelRequested=!0;let a=e.process;if(!a||a.killed)return!1;try{return a.kill(),!0}catch(t){return f(`cancelIntegratedRun erro: ${t&&t.message?t.message:String(t)}`),!1}}function je(n,e){return new Promise(a=>{let t=U(e&&e.sessionId),o=[...Q(),"-p","--",$(n)];f(`runIntegrated: session=${t} ${w()} ${o.slice(0,-1).join(" ")} -- [prompt ${$(n).length} chars]`),f(`  cwd: ${E()}`);let i=!1;function s(r){i||(i=!0,he(t),a(r))}try{let r=F.execFile(w(),o,{cwd:E(),timeout:Number(m().get("timeoutChatMs")||3e5),maxBuffer:16777216,windowsHide:!0},(d,p,h)=>{let x=O(t);if(x&&x.cancelRequested){s("Execucao cancelada pelo usuario.");return}if(d&&f(`runIntegrated erro: code=${d.code} signal=${d.signal} killed=${d.killed} msg=${d.message}`),h&&h.trim()&&f(`runIntegrated stderr: ${h.slice(0,500)}`),p&&p.trim()&&f(`runIntegrated stdout: ${p.slice(0,200)}...`),d&&process.platform==="win32"){ne(n,d,{sessionId:t}).then(s);return}s(_e(p,h,d))});me(t,{process:r,mode:"integrated"}),r.on("error",d=>{f(`runIntegrated child error: ${d.message}`);let p=O(t);if(p&&p.cancelRequested){s("Execucao cancelada pelo usuario.");return}process.platform==="win32"?ne(n,d,{sessionId:t}).then(s):s(`Falha ao iniciar Devin CLI: ${d.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)})}catch(r){f(`runIntegrated catch: ${r.message}`);let d=O(t);if(d&&d.cancelRequested){s("Execucao cancelada pelo usuario.");return}process.platform==="win32"?ne(n,r,{sessionId:t}).then(s):s(`Falha ao iniciar Devin CLI: ${r.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)}})}function ne(n,e,a){return new Promise(t=>{let o=U(a&&a.sessionId),i=ze();if(!i){t(`Falha ao executar Devin CLI: ${e.message}

Git Bash nao foi encontrado. Configure devinCliChat.gitBashPath ou ajuste devinCliChat.caminhoDevin.`);return}let s=Q().map(D).join(" "),r=`${D(w())} ${s} -p -- ${D($(n))}`,d=F.exec(r,{cwd:E(),shell:i,timeout:Number(m().get("timeoutChatMs")||3e5),maxBuffer:1024*1024*16},(p,h,x)=>{let k=O(o);if(he(o),k&&k.cancelRequested){t("Execucao cancelada pelo usuario.");return}let T=_e(h,x,p);t(T.replace("Falha ao executar Devin CLI:","Falha ao executar Devin CLI via Git Bash:"))});me(o,{process:d,mode:"bash"})})}async function b(n,e){await m().update(n,e,c.ConfigurationTarget.Workspace),R(),le(),g&&g.refreshMeta()}function pt(){let n=m().get("modelosDisponiveis")||[];return Array.isArray(n)?n.map(String).map(e=>e.trim()).filter(Boolean):[]}function ut(){let n=m().get("arquivosCacheModelos")||[],e=Array.isArray(n)?n.map(S).filter(Boolean):[];if(process.platform==="win32"){let a=process.env.LOCALAPPDATA||l.join(y.homedir(),"AppData","Local");e.push(l.join(a,"Devin","CLI","team_settings.bin")),e.push(l.join(a,"Devin","CLI","model_configs.bin"))}else e.push(l.join(y.homedir(),".local","share","Devin","CLI","team_settings.bin")),e.push(l.join(y.homedir(),".local","share","Devin","CLI","model_configs.bin"));return Array.from(new Set(e))}function Re(n){return et.includes(String(n||"").trim().toLowerCase())}function mt(){let n=Number(m().get("limiteBytesCacheModelos")||5242880),e=[];for(let a of ut())try{if(!pe(a))continue;let t=u.statSync(a);if(!t.isFile()||t.size>n)continue;let s=u.readFileSync(a).toString("utf8").match(/[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}/g)||[];for(let r of s)Re(r)&&e.push(r)}catch{}return Array.from(new Set(e))}function Oe(){return new Promise(n=>{let e=String(m().get("comandoDescobertaModelos")||"").trim();if(!e){n([]);return}try{F.execFile(w(),e.split(/\s+/),{cwd:E(),timeout:Number(m().get("timeoutDescobertaModelosMs")||2500),windowsHide:!0},(a,t)=>{if(a||!t){n([]);return}try{let i=JSON.parse(t),s=Array.isArray(i)?i:i&&i.models||[];n(s.map(r=>typeof r=="string"?r:r&&(r.name||r.id)).filter(Boolean));return}catch{}let o=t.match(/[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}/g)||[];n(o.filter(Re))})}catch{n([])}})}function V(){let n=at(),e=Date.now();if(n>0&&_.values&&e-_.at<n)return _.values;let a=[M(),ue(),...pt(),...mt(),...Ce()].map(N).filter(Boolean),t=Array.from(new Set([...Ce(),...a]));return _={at:e,values:t},t}function ge(){let n=Date.now();if(H.values&&n-H.at<Ae())return H.values;let e=[S(m().get("diretorioAgentesWorkspace")||".devin/agents"),S(m().get("diretorioAgentesGlobal")||"~/.config/devin/agents")],a=["auto"];for(let o of e)try{if(!o||!u.existsSync(o))continue;for(let i of u.readdirSync(o)){let s=l.join(o,i,"AGENT.md");u.existsSync(s)&&a.push(i)}}catch{}let t=Array.from(new Set(a));return H={at:n,values:t},t}function ve(){let n=Date.now();if(j.values&&n-j.at<Ae())return j.values;let e=[S(m().get("diretorioSkillsWorkspace")||".devin/skills"),S(m().get("diretorioSkillsGlobal")||"~/.config/devin/skills"),S(".claude/skills"),S("~/.claude/skills")],a=[];for(let o of e)try{if(!o||!u.existsSync(o))continue;for(let i of u.readdirSync(o)){let s=l.join(o,i,"SKILL.md");u.existsSync(s)&&a.push(i)}}catch{}let t=Array.from(new Set(a)).sort();return j={at:n,values:t},t}function qe(n){return l.basename(String(n||""),l.extname(String(n||""))).normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9._-]+/g,"-").replace(/^[._-]+|[._-]+$/g,"").replace(/-{2,}/g,"-")||"skill"}function ht(){return S(m().get("diretorioSkillsWorkspace")||".devin/skills")}function ft(n,e){let a=l.join(n,e),t=2;for(;u.existsSync(a);)a=l.join(n,`${e}-${t}`),t++;return a}function We(n){let e=String(n||"");if(!e||l.extname(e).toLowerCase()!==".md")throw new Error("Selecione um arquivo .md para importar como skill.");if(!u.existsSync(e)||!u.statSync(e).isFile())throw new Error("Arquivo de skill nao encontrado: "+e);let a=ht();if(!a)throw new Error("Diretorio padrao de skills nao resolvido.");let t=qe(e),o=ft(a,t),i=l.basename(o);u.mkdirSync(o,{recursive:!0});let s=l.join(o,"SKILL.md");return u.copyFileSync(e,s),R(),{name:i,file:s,dir:o}}function se(){let n=c.window.activeTextEditor;if(!n)return"Nenhum editor ativo.";let e=n.document,a=n.selection&&!n.selection.isEmpty?e.getText(n.selection):e.getText();return[`Arquivo: ${e.uri.fsPath}`,"Conteudo:","```",a.slice(0,6e4),"```"].join(`
`)}function Me(n){return n?Math.max(1,Math.ceil(String(n).length/4)):0}function gt(n){if(!n||!n.selection||n.selection.isEmpty)return null;let e=n.document,a=n.selection,t=e.getText(a);if(!t||!t.trim())return null;let o=e.uri.fsPath,i=l.basename(o),s=a.start.line+1,r=a.end.line+1;return{id:"sel-"+Date.now().toString(36),file:o,base:i,language:e.languageId,startLine:s,endLine:r,text:t,preview:t.split(`
`).slice(0,2).join(" ").slice(0,80),label:`${i}:${s}-${r}`}}function Ge(){try{if(m().get("usarContextoEditorAutomatico")===!1)return null;let e=String(m().get("modoContextoEditorAutomatico")||"selecao-ou-arquivo");if(e==="desativado")return null;let a=c.window.activeTextEditor;if(!a)return null;let t=a.document;if(!t||!t.uri||t.uri.scheme!=="file")return null;let o=t.uri.fsPath,i=l.basename(o),s=t.languageId||l.extname(o).slice(1)||"",r="```",d=a.selection,p=!!(d&&!d.isEmpty);if(e!=="somente-arquivo"&&p){let X=t.getText(d);if(!X||!X.trim())return null;let Ze=d.start.line+1,Qe=d.end.line+1,we=`${i}:${Ze}-${Qe}`,Ye=["","",`[Contexto automatico do editor: ${we}]`,r+s,X,r].join(`
`);return{label:we,promptBlock:Ye}}if(e==="somente-selecao")return null;let h=t.getText();if(!h||!h.trim())return null;let x=Number(m().get("limiteBytesContextoEditorAutomatico")),k=Number.isFinite(x)&&x>0?x:2e5,T=Buffer.from(h,"utf8"),Y=T.length>k,Je=Y?T.subarray(0,k).toString("utf8"):h,be=Y?`${i} (truncado)`:i,ye=["","",`[Contexto automatico do editor: ${be}]`,r+s,Je,r];return Y&&ye.push(`[NOTA: arquivo truncado em ${k} bytes para limitar o tamanho do contexto automatico.]`),{label:be,promptBlock:ye.join(`
`)}}catch{return null}}function re(){try{return F.execFileSync("git",["diff","--no-ext-diff"],{cwd:E(),encoding:"utf8",maxBuffer:1024*1024*8,windowsHide:!0})}catch(n){return`Nao foi possivel obter git diff: ${n.message}`}}function le(){L||(L=c.window.createStatusBarItem(c.StatusBarAlignment.Right,90),L.command="devinCliChat.abrirPainel",L.show()),L.text=`Devin: ${M()} / ${Z()}`,L.tooltip=`Workspace: ${B()} | Modo: ${K()} | Skills: ${I().length}`}async function xe(){let n=await c.window.showInputBox({title:"Modelo Devin",prompt:"Aliases aceitos pelo Devin CLI nesta build: auto, sonnet, opus, swe, gpt.",value:M()==="auto"?"":M()});if(!n||!n.trim())return;let e=N(n);e!==String(n).trim().toLowerCase()&&c.window.showInformationMessage(`Modelo "${n.trim()}" nao e aceito por esta versao do Devin CLI. Usando "${e}".`),await b("modeloAtual",e)}async function vt(){let n=await c.window.showQuickPick([...V(),"+ Informar modelo manual"],{placeHolder:"Selecione o modelo Devin"});if(n){if(n.startsWith("+"))return xe();await b("modeloAtual",n)}}async function xt(){let n=ve(),e="+ Importar arquivo .md como skill",a=new Set(I()),t=[{label:e,description:"Copia para o diretorio padrao de skills"},...n.map(s=>({label:s,picked:a.has(s)}))],o=await c.window.showQuickPick(t,{canPickMany:!0,placeHolder:n.length?"Selecione skills disponiveis para o Devin":"Importe um .md ou selecione skills disponiveis"});if(!o)return;let i=o.filter(s=>s.label!==e).map(s=>s.label);if(o.some(s=>s.label===e)){let s=await Ve({selectImported:!1});s&&i.push(s.name)}await b("skillsSelecionadas",Array.from(new Set(i)))}async function Ve(n){let e=await c.window.showOpenDialog({canSelectFiles:!0,canSelectFolders:!1,canSelectMany:!1,filters:{Markdown:["md"]},title:"Importar arquivo Markdown como skill Devin"});if(!e||!e.length)return null;try{let a=We(e[0].fsPath);if(!n||n.selectImported!==!1){let t=new Set(I());t.add(a.name),await b("skillsSelecionadas",Array.from(t))}return g&&g.refreshMeta(),c.window.showInformationMessage(`Skill "${a.name}" importada para ${a.file}.`),a}catch(a){return c.window.showErrorMessage("Falha ao importar skill: "+(a&&a.message?a.message:String(a))),null}}function A(){try{return W&&W.globalState.get(de)||[]}catch{return[]}}async function q(n){try{W&&await W.globalState.update(de,n.slice(0,tt))}catch{}}function Ue(n){try{if(!n||!n.globalState||n.globalState.get(oe))return!1;let e=n.globalState.get(de)||[];return!Array.isArray(e)||e.length===0}catch{return!1}}async function Ke(n){if(!Ue(n))return!1;try{return await c.workspace.getConfiguration("workbench").update("sideBar.location","right",c.ConfigurationTarget.Global),await n.globalState.update(oe,!0),f("Primeira instalacao: sideBar.location definido como right."),!0}catch(e){f("Falha ao posicionar sidebar a direita: "+(e&&e.message?e.message:String(e)));try{await n.globalState.update(oe,!0)}catch{}return!1}}var ce=class{constructor(e){this.context=e,this.view=void 0,this.busy=!1,this.session=this.newSession()}newSession(){return{id:"sess-"+Date.now().toString(36)+"-"+Math.random().toString(36).slice(2,6),title:"Nova conversa",createdAt:Date.now(),updatedAt:Date.now(),workspace:B(),model:M(),agent:Z(),mode:K(),skills:I(),messages:[]}}async persistSession(){if(!this.session||!this.session.messages.length)return;let e=A(),a=e.findIndex(t=>t.id===this.session.id);if(this.session.updatedAt=Date.now(),!this.session.title||this.session.title==="Nova conversa"){let t=this.session.messages.find(o=>o.role==="user");t&&(this.session.title=String(t.text).slice(0,60).replace(/\s+/g," ").trim())}a>=0?e[a]=this.session:e.unshift(this.session),e.sort((t,o)=>(o.updatedAt||0)-(t.updatedAt||0)),await q(e)}resolveWebviewView(e){this.view=e,e.webview.options={enableScripts:!0,localResourceRoots:[this.context.extensionUri]},e.webview.html=this.html(e.webview),f("WebView resolvida e HTML injetado."),e.webview.onDidReceiveMessage(async a=>{try{let t=Pe(a);if(!t){f("Mensagem webview rejeitada por validacao.");return}let o=t.type;if(f(`Mensagem recebida do webview: type=${o}`),o==="ready"){this.refreshMeta(),this.replaySession(),this.pushCurrentSelection();return}if(o==="clientError"){f(`ERRO no cliente webview: ${t.text||"sem detalhes"}`),this.post({type:"message",role:"assistant",text:"Falha no painel: "+(t.text||"erro sem detalhes")});return}if(o==="cancelRun"){let i=fe(this.session&&this.session.id);this.post({type:"action",ok:i,text:i?"Cancelamento solicitado.":"Nenhuma execucao integrada ativa para cancelar."});return}if(o==="verifyCli"){this.verifyCli();return}if(o==="requestSelection"){this.pushCurrentSelection(!0);return}if(o==="attachMenu"){await this.chooseAttachSource();return}if(o==="attachFiles"){await this.attachFiles();return}if(o==="pickWorkspaceFiles"){await this.pickWorkspaceFiles();return}if(o==="listWorkspace"){this.listWorkspaceDir(t.path||"");return}if(o==="attachFolder"){await this.attachFolder(t.path||"");return}if(o==="attachWorkspacePath"){await this.attachWorkspacePath(t.path||"");return}if(o==="searchWorkspaceFiles"){await this.searchWorkspaceFiles(t.query||"");return}if(o==="send"){await this.send(t.text||"",{echoUser:t.echo!==!1,displayText:t.displayText||t.text||"",hasExplicitContext:!!t.hasExplicitContext});return}if(o==="terminal"){ie(t.text||""),this.post({type:"action",ok:!0,text:"Terminal aberto."});return}if(o==="setModel"){await b("modeloAtual",N(t.value||"auto"));return}if(o==="setMode"){await b("modoExecucaoChat",t.value||"resposta-integrada");return}if(o==="setAgent"){await b("agenteAtual",t.value||"auto");return}if(o==="importSkillFile"){let i=await Ve();i&&this.post({type:"action",ok:!0,text:"Skill importada: "+i.name});return}if(o==="toggleSkill"){let i=new Set(I());t.value&&i.has(t.value)?i.delete(t.value):t.value&&i.add(t.value),await b("skillsSelecionadas",Array.from(i));return}if(o==="manualModel"){await xe();return}if(o==="refreshModels"){this.refreshMeta();let i=await Oe();if(i.length){let s=Array.from(new Set([...m().get("modelosDisponiveis")||[],...i]));await m().update("modelosDisponiveis",s,c.ConfigurationTarget.Workspace)}this.refreshMeta(),this.post({type:"action",ok:!0,text:"Modelos atualizados ("+V().length+" disponiveis)."});return}if(o==="review"){await this.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+re()+"\n```",{echoUser:!0});return}if(o==="selection"){await this.send(`Analise o contexto do editor atual.

`+se(),{echoUser:!0});return}if(o==="insertSelection"){this.post({type:"insertPrompt",text:`Analise o contexto do editor atual.

`+se()});return}if(o==="newChat"){await this.persistSession(),this.session=this.newSession(),this.post({type:"clearThread"}),this.refreshMeta();return}if(o==="getHistory"){await this.openHistory();return}if(o==="exportSession"){await this.exportSession(t.id);return}if(o==="loadSession"){await this.persistSession();let s=A().find(r=>r.id===t.id);s&&(this.session=JSON.parse(JSON.stringify(s)),this.post({type:"clearThread"}),this.replaySession(),this.refreshMeta(),this.post({type:"action",ok:!0,text:"Sessao carregada: "+(s.title||s.id)}));return}if(o==="deleteSession"){let i=A().filter(s=>s.id!==t.id);await q(i),this.session&&this.session.id===t.id&&(this.session=this.newSession(),this.post({type:"clearThread"})),this.post({type:"history",sessions:i}),this.refreshMeta();return}if(o==="clearHistory"){await q([]),this.session=this.newSession(),this.post({type:"clearThread"}),this.post({type:"history",sessions:[]}),this.refreshMeta();return}this.post({type:"action",ok:!1,text:`Acao desconhecida: ${o}`})}catch(t){this.busy=!1,this.post({type:"busy",value:!1}),f(`ERRO no handler do webview: ${t&&t.message?t.message:String(t)}`),t&&t.stack&&f(t.stack),this.post({type:"message",role:"assistant",text:"Falha ao executar acao do painel: "+(t&&t.message?t.message:String(t))})}}),setTimeout(()=>this.refreshMeta(),50)}post(e){try{this.view&&this.view.webview.postMessage(e)}catch{}}async openHistory(){await this.persistSession();let e=A().filter(a=>a&&a.messages&&a.messages.length);this.post({type:"openHistory",sessions:e}),this.refreshMeta()}async exportSession(e){await this.persistSession();let a=A(),o=(e?a.find(s=>s.id===e):null)||this.session;if(!o||!o.messages||!o.messages.length){let s="Nao ha conversa com mensagens para exportar.";this.post({type:"action",ok:!1,text:s}),c.window.showInformationMessage(s);return}await c.env.clipboard.writeText(De(o));let i="Conversa exportada em Markdown para a area de transferencia.";this.post({type:"action",ok:!0,text:i}),c.window.showInformationMessage(i)}verifyCli(){P.show(!0),f(`Verificando Devin CLI pelo painel: ${w()}`),F.execFile(w(),["--version"],{cwd:E(),windowsHide:!0},(e,a,t)=>{if(e){let s=`Falha ao verificar Devin CLI: ${e.message}`;f(s),this.post({type:"message",role:"assistant",text:s}),this.post({type:"action",ok:!1,text:s});return}let i=`Devin CLI encontrado: ${(a||t||"ok").trim()}`;f(i),this.post({type:"message",role:"assistant",text:i}),this.post({type:"action",ok:!0,text:i})})}pushCurrentSelection(e){let a=c.window.activeTextEditor,t=gt(a);t&&this.post({type:"selectionAvailable",selection:t})}attachmentId(e){return e+"-"+Date.now().toString(36)+Math.random().toString(36).slice(2,7)}readFileItem(e,a){let t=u.statSync(e);if(t.size>ee)return{skipped:!0,reason:`Arquivo muito grande: ${l.basename(e)} (${t.size} bytes).`};let o=u.readFileSync(e,"utf8"),i=l.extname(e).slice(1);return{id:this.attachmentId("file"),file:e,base:l.basename(e),label:a||l.basename(e),type:"file",text:o,language:i,lines:o.split(`
`).length}}readFolderItem(e,a){let t=v(),o=a||l.basename(e)||"workspace",i=[],s=[e];for(;s.length&&i.length<te;){let r=s.pop(),d;try{d=u.readdirSync(r,{withFileTypes:!0})}catch{continue}for(let p of d){let h=l.join(r,p.name);if(p.isDirectory())!nt.has(p.name)&&!p.name.startsWith(".")&&s.push(h);else if(p.isFile())try{if(u.statSync(h).size>ee)continue;let k=u.readFileSync(h,"utf8"),T=t&&h.startsWith(t)?l.relative(t,h):l.join(o,l.relative(e,h));if(i.push({file:h,rel:T.replace(/\\/g,"/"),base:l.basename(h),text:k,language:l.extname(h).slice(1),lines:k.split(`
`).length}),i.length>=te)break}catch{}}}return{id:this.attachmentId("folder"),file:e,base:o,label:`${o} (${i.length})`,type:"folder",files:i,count:i.length,truncated:i.length>=te}}async chooseAttachSource(){let e=await c.window.showQuickPick([{label:"$(folder) Pastas",description:"Anexar pasta recursivamente como chip unico",value:"folders"},{label:"$(file) Arquivos abertos",description:"Anexar arquivos atualmente abertos no editor",value:"openFiles"}],{placeHolder:"Anexar contexto ao Devin"});if(!e)return;if(e.value==="folders"){let r=await c.window.showOpenDialog({canSelectMany:!0,canSelectFiles:!1,canSelectFolders:!0,defaultUri:v()?c.Uri.file(v()):void 0,openLabel:"Anexar pasta"});if(!r||!r.length)return;let d=[];for(let p of r)try{let h=this.readFolderItem(p.fsPath,l.basename(p.fsPath));h.files&&h.files.length&&d.push(h)}catch(h){this.post({type:"action",ok:!1,text:`Falha ao anexar pasta ${p.fsPath}: ${h.message}`})}d.length&&this.post({type:"attachItems",items:d}),this.post({type:"action",ok:!0,text:`Anexadas ${d.length} pasta(s).`});return}let a=c.workspace.textDocuments.filter(r=>r.uri&&r.uri.scheme==="file"&&!r.isUntitled);if(!a.length){this.post({type:"action",ok:!1,text:"Nenhum arquivo aberto para anexar."});return}let t=v()||"",o=a.map(r=>({label:"$(file) "+l.basename(r.uri.fsPath),description:t?l.dirname(l.relative(t,r.uri.fsPath)):l.dirname(r.uri.fsPath),detail:r.uri.fsPath,doc:r})),i=await c.window.showQuickPick(o,{canPickMany:!0,placeHolder:"Selecione arquivos abertos para anexar"});if(!i||!i.length)return;let s=[];for(let r of i){let d=r.doc,p=d.getText();if(Buffer.byteLength(p,"utf8")>ee){this.post({type:"action",ok:!1,text:`Arquivo muito grande: ${l.basename(d.uri.fsPath)}.`});continue}s.push({id:this.attachmentId("file"),file:d.uri.fsPath,base:l.basename(d.uri.fsPath),label:l.basename(d.uri.fsPath),type:"file",text:p,language:d.languageId||l.extname(d.uri.fsPath).slice(1),lines:p.split(`
...
</script></body></html>`}};async function bt(n){W=n,P=c.window.createOutputChannel("Devin Cli Chat"),n.subscriptions.push(P),f(`Extens\xE3o ativando \u2014 VS Code ${c.version}, extens\xE3o ${n.extension.packageJSON.version}`),f(`Plataforma: ${process.platform} ${process.arch}`),f(`Devin CLI path configurado: ${w()}`),f(`Workspace: ${v()||"nenhum"}`),await Ke(n),g=new ce(n),n.subscriptions.push(c.window.registerWebviewViewProvider("devinCliChat.chatView",g,{webviewOptions:{retainContextWhenHidden:!0}})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirPainel",async()=>c.commands.executeCommand("workbench.view.extension.devinCliChat"))),n.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirHistorico",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),setTimeout(()=>{g&&g.openHistory()},100)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.exportarSessaoAtual",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.exportSession()})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.novaSessao",()=>ie(""))),n.subscriptions.push(c.commands.registerCommand("devinCliChat.revisarDiff",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+re()+"\n```")})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.enviarSelecao",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send(`Analise o contexto do editor atual.

`+se())})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarModelo",vt)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.definirModeloManual",xe)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.atualizarModelos",async()=>{R(),g&&g.refreshMeta();let t=await Oe();if(t.length){let o=Array.from(new Set([...m().get("modelosDisponiveis")||[],...t]));await m().update("modelosDisponiveis",o,c.ConfigurationTarget.Workspace),R()}g&&g.refreshMeta(),c.window.showInformationMessage(`Modelos atualizados (${V().length} disponiveis).`)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarAgente",async()=>{let t=await c.window.showQuickPick(ge(),{placeHolder:"Selecione o agente Devin"});t&&await b("agenteAtual",t)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarSkills",xt)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarModo",async()=>{let t=await c.window.showQuickPick([{label:"Integrado (resposta no chat)",value:"resposta-integrada"},{label:"Terminal",value:"terminal"}],{placeHolder:"Selecione o modo de execucao"});t&&await b("modoExecucaoChat",t.value)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.limparHistorico",async()=>{await c.window.showWarningMessage("Limpar todo o historico de chats?",{modal:!0},"Limpar")==="Limpar"&&(await q([]),g&&g.post({type:"history",sessions:[]}))})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.verificarCli",()=>{P.show(!0),f(`Verificando Devin CLI: ${w()}`),F.execFile(w(),["--version"],{cwd:E(),windowsHide:!0},(t,o,i)=>{if(t)f(`verificarCli ERRO: code=${t.code} msg=${t.message}`),c.window.showErrorMessage(`Falha ao verificar Devin CLI: ${t.message}`);else{let s=(o||i||"ok").trim();f(`verificarCli OK: ${s}`),c.window.showInformationMessage(`Devin CLI encontrado: ${s}`)}})}));let e,a=()=>{e&&clearTimeout(e),e=setTimeout(()=>{g&&g.pushCurrentSelection(!0)},150)};n.subscriptions.push(c.window.onDidChangeTextEditorSelection(a)),n.subscriptions.push(c.window.onDidChangeActiveTextEditor(a)),n.subscriptions.push(c.workspace.onDidChangeConfiguration(t=>{t.affectsConfiguration(Ee)&&(R(),le(),g&&g.refreshMeta())})),le()}function yt(){for(let n of He())fe(n)}module.exports={activate:bt,deactivate:yt,_internal:{baseArgs:Q,fullPrompt:$,runIntegrated:je,modelsForUi:V,scanAgents:ge,scanSkills:ve,skillNameFromMarkdownFile:qe,importSkillMarkdownFile:We,loadHistory:A,saveHistory:q,sanitizeModel:N,sanitizePromptText:$e,isSafeModelId:Ie,cancelIntegratedRun:fe,automaticEditorContext:Ge,resolveWorkspacePathSafe:J,registerRunState:me,unregisterRunState:he,activeRunIds:He,createNonce:Le,validateWebviewMessage:Pe,expandSlashCommand:Be,exportSessionMarkdown:De,shouldApplyFirstInstallRightSidebar:Ue,applyFirstInstallRightSidebar:Ke}};
