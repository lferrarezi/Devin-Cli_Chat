"use strict";var d=require("vscode"),p=require("fs"),l=require("path"),w=require("os"),N=require("child_process"),st=require("crypto"),Pe="devinCliChat",rt=["auto","sonnet","opus","swe","gpt"],ie=["auto","adaptive","sonnet","opus","swe","gpt","codex"],ue="devinCliChat.chatHistory.v1",se="devinCliChat.firstInstallLayout.v1",lt=50,ne=1024*1024,ae=50,ct=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),g,L,V,B,U=new Map,H={at:0,values:void 0},j={at:0,values:void 0},R={at:0,values:void 0},O={at:0,values:void 0};function f(t){let e=new Date().toISOString();B&&B.appendLine(`[${e}] ${t}`)}function me(){return 1e4}function dt(){return Math.max(0,Number(m().get("cacheModelosMs")||18e5))}function q(){H={at:0,values:void 0},j={at:0,values:void 0},R={at:0,values:void 0},O={at:0,values:void 0}}function De(t){return/^[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}$/.test(String(t||"").trim())}function m(){return d.workspace.getConfiguration(Pe)}function v(){return d.workspace.workspaceFolders&&d.workspace.workspaceFolders[0]?d.workspace.workspaceFolders[0].uri.fsPath:void 0}function P(){return d.workspace.workspaceFolders&&d.workspace.workspaceFolders[0]?d.workspace.workspaceFolders[0].name:"sem pasta aberta"}function Fe(t){if(!t)return t;let e=String(t);return e==="~"?w.homedir():e.startsWith("~/")||e.startsWith("~\\")?l.join(w.homedir(),e.slice(2)):e}function x(t){let e=Fe(t);return e&&(l.isAbsolute(e)?e:l.join(v()||w.homedir(),e))}function he(t){try{return!!t&&p.existsSync(t)}catch{return!1}}function $e(){return st.randomBytes(18).toString("base64")}function E(t,e){if(typeof t!="string")return;let a=e||2e4;return t.length>a?t.slice(0,a):t}function Te(t){return typeof t=="boolean"?t:void 0}function pt(t){return typeof t=="string"&&/^[a-zA-Z0-9][a-zA-Z0-9._:-]{0,159}$/.test(t)}function Ne(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let e=E(t.type,40);if(new Set(["ready","cancelRun","verifyCli","requestSelection","attachMenu","attachFiles","pickWorkspaceFiles","manualModel","refreshModels","review","selection","insertSelection","newChat","getHistory","clearHistory","importAgentFile","importSkillFile","importToolFile"]).has(e))return{type:e};if(e==="clientError")return{type:e,text:E(t.text,2e3)||""};if(e==="send"){let n=E(t.text,2e5);if(n===void 0)return null;let o={type:e,text:n},i=E(t.displayText,2e5),s=Te(t.echo),r=Te(t.hasExplicitContext);return i!==void 0&&(o.displayText=i),s!==void 0&&(o.echo=s),r!==void 0&&(o.hasExplicitContext=r),o}if(e==="searchWorkspaceFiles")return{type:e,query:E(t.query||"",200)||""};if(e==="setModel"||e==="setAgent"||e==="toggleSkill"||e==="toggleTool"){let n=E(t.value,200);return n===void 0?null:{type:e,value:n}}if(e==="listWorkspace"||e==="attachFolder"||e==="attachWorkspacePath"){let n=E(t.path||"",2e3);return n===void 0?null:{type:e,path:n}}return(e==="loadSession"||e==="deleteSession"||e==="exportSession")&&pt(t.id)?{type:e,id:t.id}:null}function ze(t){let e=String(t||"").trim();if(!e.startsWith("/"))return null;let n=(e.slice(1).split(/\s+/).shift()||"").toLowerCase(),i=e.slice(n.length+2).trim()||"o contexto atual",r={review:"Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.",tests:`Proponha e implemente testes para ${i}. Priorize cobertura de comportamento, regressao e caminhos de erro.`,plan:`Crie um plano tecnico objetivo para ${i}. Agrupe por impacto, risco e ordem de execucao.`,explain:`Explique ${i} com foco em arquitetura, fluxo de dados e pontos de manutencao.`,security:`Revise ${i} com foco em riscos de seguranca, entrada nao confiavel, execucao de comandos e exposicao de dados.`,docs:`Gere documentacao pratica para ${i}, incluindo objetivo, uso, limites e exemplos.`,"commit-msg":"Gere uma mensagem de commit convencional para as mudancas atuais, com escopo claro e resumo curto."}[n];return r?{command:n,text:r,displayText:e}:null}function _(t){return String(t??"").replace(/\r?\n/g," ").trim()}function _e(t){let e=t||{},a=[];a.push("# "+(_(e.title)||"Sessao Devin")),a.push(""),a.push("- Workspace: "+(_(e.workspace)||P())),a.push("- Modelo: "+(_(e.model)||"auto")),a.push("- Agente: "+(_(e.agent)||"auto")),a.push("- Modo: "+(_(e.mode)||"resposta-integrada")),e.createdAt&&a.push("- Criada em: "+new Date(e.createdAt).toISOString()),e.updatedAt&&a.push("- Atualizada em: "+new Date(e.updatedAt).toISOString()),a.push("");let n=Array.isArray(e.messages)?e.messages:[];for(let o of n){let i=String(o&&o.role||"message").toLowerCase();a.push("## "+i.charAt(0).toUpperCase()+i.slice(1)),o&&o.ts&&a.push("_"+new Date(o.ts).toISOString()+"_"),a.push(""),a.push(String(o&&o.text||"").trim()),a.push("")}return a.join(`
`).trim()+`
`}function D(t){return`'${String(t).replace(/'/g,"'\\''")}'`}function He(t){return String(t??"").replace(/\u0000/g,"")}function z(t){let e=String(t||"").trim().toLowerCase();return!e||e==="default"||e==="padrao"||e==="padr\xE3o"?"auto":De(e)?e:"auto"}function je(t){return z(t)}function Ie(){return[...ie]}function ut(t){try{return he(t)?JSON.parse(p.readFileSync(t,"utf8")):void 0}catch{return}}function mt(){if(process.platform==="win32"){let t=process.env.APPDATA||l.join(w.homedir(),"AppData","Roaming");return l.join(t,"devin","config.json")}return l.join(w.homedir(),".config","devin","config.json")}function fe(){let t=ut(mt());return t&&t.agent?je(t.agent.model):void 0}function S(){let t=m().get("modeloAtual");return je(t??(fe()||"auto"))}function Re(){let t=m().get("modeloAtual");return z(t??(fe()||"auto"))}function Q(){return String(m().get("agenteAtual")||"auto")}function re(){return"resposta-integrada"}function T(){let t=m().get("skillsSelecionadas")||[];return Array.isArray(t)?t.map(String).filter(Boolean):[]}function F(){let t=m().get("toolsSelecionadas")||[];return Array.isArray(t)?t.map(String).filter(Boolean):[]}function k(){return String(m().get("caminhoDevin")||"devin")}function M(){return v()||w.homedir()}function Le(t){try{if(p.existsSync(t))return p.realpathSync.native?p.realpathSync.native(t):p.realpathSync(t)}catch{}return l.resolve(t)}function ht(t,e){let a=l.relative(t,e);return a===""||!!a&&!a.startsWith("..")&&!l.isAbsolute(a)}function Z(t){let e=v();if(!e)return null;let a=Le(e),n=String(t||"").replace(/\\/g,l.sep).trim(),o=l.isAbsolute(n)?l.resolve(n):l.resolve(a,n),i=Le(o);return ht(a,i)?i:null}function Oe(){return[Fe(m().get("gitBashPath")),process.env.GIT_BASH_PATH,"C:\\Program Files\\Git\\bin\\bash.exe","C:\\Program Files\\Git\\usr\\bin\\bash.exe","C:\\Program Files (x86)\\Git\\bin\\bash.exe",l.join(w.homedir(),"AppData","Local","Programs","Git","bin","bash.exe")].filter(Boolean).find(he)}function ft(){return process.platform==="win32"&&m().get("usarGitBashNoWindows",!0)?Oe():process.env.SHELL||void 0}function Y(){let t=[...(m().get("argumentosPadrao")||[]).map(String).filter(Boolean)],e=String(m().get("argumentoModelo")||"").trim(),a=Re();return e&&a&&a!=="auto"&&t.push(e,a),t}function $(t){let e=m().get("prefixoPromptPadrao")||"",a=Re()||S()||"auto",n=Q(),o=T(),i=F(),s=[`Workspace VS Code: ${P()}`,v()?`Diretorio raiz: ${v()}`:"Diretorio raiz: nao ha pasta aberta",`Modelo selecionado: ${a}`,`Agente selecionado: ${n}`,o.length?`Skills disponiveis: ${o.join(", ")}`:"",i.length?`Tools disponiveis: ${i.join(", ")}`:""].filter(Boolean).join(`
`),r=n!=="auto"?`Use o perfil/subagente Devin chamado "${n}" quando aplicavel. Se a CLI nao aceitar selecao direta de agente nesta chamada, trate este agente como persona operacional e siga as instrucoes do respectivo AGENT.md.`:"",c=o.length?`Invoque a skill via tool 'skill' quando aplicavel: ${o.map(h=>`"${h}"`).join(", ")}. Siga as instrucoes do respectivo SKILL.md.`:"",u=i.length?`Use as tools selecionadas quando aplicavel: ${i.map(h=>`"${h}"`).join(", ")}. Siga as instrucoes do respectivo TOOL.md.`:"";return He([e,s,r,c,u,t].filter(Boolean).join(`

`))}function gt(t){let e=D(k()),a=Y().map(D).join(" ");return t?[e,a,"-p","--",D($(t))].filter(Boolean).join(" "):[e,a].filter(Boolean).join(" ")}function vt(t){return t?String(t).split(/\r?\n/).filter(e=>!/were not migrated because they already exist/i.test(e)).filter(e=>!/migration.*already exist/i.test(e)).join(`
`).trim():""}function qe(t,e,a){let n=vt(e),o=[t||"",n||"",a&&a.message?a.message:""].join(`
`);if(/No active model set in cog manager/i.test(o))return["Modelo Devin nao configurado para esta execucao.","","A extensao tentou enviar o alias selecionado, mas o Devin CLI informou que nao ha modelo ativo no cog manager.","","Acoes recomendadas:",`1. Execute no terminal: devin model set ${S()||"auto"}`,"2. Se houver conflito de migracao de config, mantenha apenas o valor desejado em agent.model no config.json do Devin.","3. No chat, reabra o seletor de modelo e escolha um dos aliases validos: auto, sonnet, opus, swe, gpt."].join(`
`);let i=[];return t&&t.trim()&&i.push(t.trim()),n&&i.push(`STDERR:
${n}`),a&&i.push(`Falha ao executar Devin CLI: ${a.message}`),i.join(`

`)||"Sem saida do Devin CLI."}function xt(t){let e=ft(),a=d.window.createTerminal({name:m().get("nomeTerminal")||"Devin Cli Chat",cwd:M(),shellPath:e,shellArgs:process.platform==="win32"&&e?["--login","-i"]:void 0});a.show(!0),a.sendText(gt(t))}function J(t){return t||"__default__"}function ge(t,e){let a=J(t);return U.set(a,Object.assign({sessionId:a,cancelRequested:!1,startedAt:Date.now()},e||{})),U.get(a)}function W(t){return U.get(J(t))}function ve(t){U.delete(J(t))}function We(){return Array.from(U.keys())}function xe(t){let e=W(t);if(!e)return!1;e.cancelRequested=!0;let a=e.process;if(!a||a.killed)return!1;try{return a.kill(),!0}catch(n){return f(`cancelIntegratedRun erro: ${n&&n.message?n.message:String(n)}`),!1}}function Ge(t,e){return new Promise(a=>{let n=J(e&&e.sessionId),o=[...Y(),"-p","--",$(t)];f(`runIntegrated: session=${n} ${k()} ${o.slice(0,-1).join(" ")} -- [prompt ${$(t).length} chars]`),f(`  cwd: ${M()}`);let i=!1;function s(r){i||(i=!0,ve(n),a(r))}try{let r=N.execFile(k(),o,{cwd:M(),timeout:Number(m().get("timeoutChatMs")||3e5),maxBuffer:16777216,windowsHide:!0},(c,u,h)=>{let y=W(n);if(y&&y.cancelRequested){s("Execucao cancelada pelo usuario.");return}if(c&&f(`runIntegrated erro: code=${c.code} signal=${c.signal} killed=${c.killed} msg=${c.message}`),h&&h.trim()&&f(`runIntegrated stderr: ${h.slice(0,500)}`),u&&u.trim()&&f(`runIntegrated stdout: ${u.slice(0,200)}...`),c&&process.platform==="win32"){oe(t,c,{sessionId:n}).then(s);return}s(qe(u,h,c))});ge(n,{process:r,mode:"integrated"}),r.on("error",c=>{f(`runIntegrated child error: ${c.message}`);let u=W(n);if(u&&u.cancelRequested){s("Execucao cancelada pelo usuario.");return}process.platform==="win32"?oe(t,c,{sessionId:n}).then(s):s(`Falha ao iniciar Devin CLI: ${c.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)})}catch(r){f(`runIntegrated catch: ${r.message}`);let c=W(n);if(c&&c.cancelRequested){s("Execucao cancelada pelo usuario.");return}process.platform==="win32"?oe(t,r,{sessionId:n}).then(s):s(`Falha ao iniciar Devin CLI: ${r.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)}})}function oe(t,e,a){return new Promise(n=>{let o=J(a&&a.sessionId),i=Oe();if(!i){n(`Falha ao executar Devin CLI: ${e.message}

Git Bash nao foi encontrado. Configure devinCliChat.gitBashPath ou ajuste devinCliChat.caminhoDevin.`);return}let s=Y().map(D).join(" "),r=`${D(k())} ${s} -p -- ${D($(t))}`,c=N.exec(r,{cwd:M(),shell:i,timeout:Number(m().get("timeoutChatMs")||3e5),maxBuffer:1024*1024*16},(u,h,y)=>{let C=W(o);if(ve(o),C&&C.cancelRequested){n("Execucao cancelada pelo usuario.");return}let I=qe(h,y,u);n(I.replace("Falha ao executar Devin CLI:","Falha ao executar Devin CLI via Git Bash:"))});ge(o,{process:c,mode:"bash"})})}async function b(t,e){await m().update(t,e,d.ConfigurationTarget.Workspace),q(),de(),g&&g.refreshMeta()}function bt(){let t=m().get("modelosDisponiveis")||[];return Array.isArray(t)?t.map(String).map(e=>e.trim()).filter(Boolean):[]}function yt(){let t=m().get("arquivosCacheModelos")||[],e=Array.isArray(t)?t.map(x).filter(Boolean):[];if(process.platform==="win32"){let a=process.env.LOCALAPPDATA||l.join(w.homedir(),"AppData","Local");e.push(l.join(a,"Devin","CLI","team_settings.bin")),e.push(l.join(a,"Devin","CLI","model_configs.bin"))}else e.push(l.join(w.homedir(),".local","share","Devin","CLI","team_settings.bin")),e.push(l.join(w.homedir(),".local","share","Devin","CLI","model_configs.bin"));return Array.from(new Set(e))}function Ve(t){return rt.includes(String(t||"").trim().toLowerCase())}function wt(){let t=Number(m().get("limiteBytesCacheModelos")||5242880),e=[];for(let a of yt())try{if(!he(a))continue;let n=p.statSync(a);if(!n.isFile()||n.size>t)continue;let s=p.readFileSync(a).toString("utf8").match(/[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}/g)||[];for(let r of s)Ve(r)&&e.push(r)}catch{}return Array.from(new Set(e))}function Ue(){return new Promise(t=>{let e=String(m().get("comandoDescobertaModelos")||"").trim();if(!e){t([]);return}try{N.execFile(k(),e.split(/\s+/),{cwd:M(),timeout:Number(m().get("timeoutDescobertaModelosMs")||2500),windowsHide:!0},(a,n)=>{if(a||!n){t([]);return}try{let i=JSON.parse(n),s=Array.isArray(i)?i:i&&i.models||[];t(s.map(r=>typeof r=="string"?r:r&&(r.name||r.id)).filter(Boolean));return}catch{}let o=n.match(/[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}/g)||[];t(o.filter(Ve))})}catch{t([])}})}function K(){let t=dt(),e=Date.now();if(t>0&&H.values&&e-H.at<t)return H.values;let a=[S(),fe(),...bt(),...wt(),...Ie()].map(z).filter(Boolean),n=Array.from(new Set([...Ie(),...a]));return H={at:e,values:n},n}function be(){let t=Date.now();if(j.values&&t-j.at<me())return j.values;let e=[x(m().get("diretorioAgentesWorkspace")||".devin/agents"),x(m().get("diretorioAgentesGlobal")||"~/.config/devin/agents")],a=["auto"];for(let o of e)try{if(!o||!p.existsSync(o))continue;for(let i of p.readdirSync(o)){let s=l.join(o,i,"AGENT.md");p.existsSync(s)&&a.push(i)}}catch{}let n=Array.from(new Set(a));return j={at:t,values:n},n}function ye(){let t=Date.now();if(O.values&&t-O.at<me())return O.values;let e=[x(m().get("diretorioToolsWorkspace")||".devin/tools"),x(m().get("diretorioToolsGlobal")||"~/.config/devin/tools")],a=[];for(let o of e)try{if(!o||!p.existsSync(o))continue;for(let i of p.readdirSync(o)){let s=l.join(o,i,"TOOL.md");p.existsSync(s)&&a.push(i)}}catch{}let n=Array.from(new Set(a)).sort();return O={at:t,values:n},n}function we(){let t=Date.now();if(R.values&&t-R.at<me())return R.values;let e=[x(m().get("diretorioSkillsWorkspace")||".devin/skills"),x(m().get("diretorioSkillsGlobal")||"~/.config/devin/skills"),x(".claude/skills"),x("~/.claude/skills")],a=[];for(let o of e)try{if(!o||!p.existsSync(o))continue;for(let i of p.readdirSync(o)){let s=l.join(o,i,"SKILL.md");p.existsSync(s)&&a.push(i)}}catch{}let n=Array.from(new Set(a)).sort();return R={at:t,values:n},n}function Ke(t){return l.basename(String(t||""),l.extname(String(t||""))).normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9._-]+/g,"-").replace(/^[._-]+|[._-]+$/g,"").replace(/-{2,}/g,"-")||"skill"}function kt(){return x(m().get("diretorioSkillsWorkspace")||".devin/skills")}function Ct(){return x(m().get("diretorioAgentesWorkspace")||".devin/agents")}function St(){return x(m().get("diretorioToolsWorkspace")||".devin/tools")}function Mt(t,e){let a=l.join(t,e),n=2;for(;p.existsSync(a);)a=l.join(t,`${e}-${n}`),n++;return a}function Je(t){return Ce(t,kt(),"SKILL.md")}function Ze(t){return Ce(t,Ct(),"AGENT.md")}function ke(t){return Ce(t,St(),"TOOL.md")}function Ce(t,e,a){let n=String(t||"");if(!n||l.extname(n).toLowerCase()!==".md")throw new Error("Selecione um arquivo .md para importar.");if(!p.existsSync(n)||!p.statSync(n).isFile())throw new Error("Arquivo markdown nao encontrado: "+n);if(!e)throw new Error("Diretorio padrao nao resolvido.");let o=Ke(n),i=Mt(e,o),s=l.basename(i);p.mkdirSync(i,{recursive:!0});let r=l.join(i,a);return p.copyFileSync(n,r),q(),{name:s,file:r,dir:i}}function le(){let t=d.window.activeTextEditor;if(!t)return"Nenhum editor ativo.";let e=t.document,a=t.selection&&!t.selection.isEmpty?e.getText(t.selection):e.getText();return[`Arquivo: ${e.uri.fsPath}`,"Conteudo:","```",a.slice(0,6e4),"```"].join(`
`)}function Be(t){return t?Math.max(1,Math.ceil(String(t).length/4)):0}function Et(t){if(!t||!t.selection||t.selection.isEmpty)return null;let e=t.document,a=t.selection,n=e.getText(a);if(!n||!n.trim())return null;let o=e.uri.fsPath,i=l.basename(o),s=a.start.line+1,r=a.end.line+1;return{id:"sel-"+Date.now().toString(36),file:o,base:i,language:e.languageId,startLine:s,endLine:r,text:n,preview:n.split(`
`).slice(0,2).join(" ").slice(0,80),label:`${i}:${s}-${r}`}}function Qe(){try{if(m().get("usarContextoEditorAutomatico")===!1)return null;let e=String(m().get("modoContextoEditorAutomatico")||"selecao-ou-arquivo");if(e==="desativado")return null;let a=d.window.activeTextEditor;if(!a)return null;let n=a.document;if(!n||!n.uri||n.uri.scheme!=="file")return null;let o=n.uri.fsPath,i=l.basename(o),s=n.languageId||l.extname(o).slice(1)||"",r="```",c=a.selection,u=!!(c&&!c.isEmpty);if(e!=="somente-arquivo"&&u){let te=n.getText(c);if(!te||!te.trim())return null;let at=c.start.line+1,ot=c.end.line+1,Ae=`${i}:${at}-${ot}`,it=["","",`[Contexto automatico do editor: ${Ae}]`,r+s,te,r].join(`
`);return{label:Ae,promptBlock:it}}if(e==="somente-selecao")return null;let h=n.getText();if(!h||!h.trim())return null;let y=Number(m().get("limiteBytesContextoEditorAutomatico")),C=Number.isFinite(y)&&y>0?y:2e5,I=Buffer.from(h,"utf8"),ee=I.length>C,nt=ee?I.subarray(0,C).toString("utf8"):h,Me=ee?`${i} (truncado)`:i,Ee=["","",`[Contexto automatico do editor: ${Me}]`,r+s,nt,r];return ee&&Ee.push(`[NOTA: arquivo truncado em ${C} bytes para limitar o tamanho do contexto automatico.]`),{label:Me,promptBlock:Ee.join(`
`)}}catch{return null}}function ce(){try{return N.execFileSync("git",["diff","--no-ext-diff"],{cwd:M(),encoding:"utf8",maxBuffer:1024*1024*8,windowsHide:!0})}catch(t){return`Nao foi possivel obter git diff: ${t.message}`}}function de(){L||(L=d.window.createStatusBarItem(d.StatusBarAlignment.Right,90),L.command="devinCliChat.abrirPainel",L.show()),L.text=`Devin: ${S()} / ${Q()}`,L.tooltip=`Workspace: ${P()} | Modo: ${re()} | Skills: ${T().length}`}async function Se(){let t=await d.window.showInputBox({title:"Modelo Devin",prompt:"Aliases aceitos pelo Devin CLI nesta build: auto, sonnet, opus, swe, gpt.",value:S()==="auto"?"":S()});if(!t||!t.trim())return;let e=z(t);e!==String(t).trim().toLowerCase()&&d.window.showInformationMessage(`Modelo "${t.trim()}" nao e aceito por esta versao do Devin CLI. Usando "${e}".`),await b("modeloAtual",e)}async function At(){let t=await d.window.showQuickPick([...K(),"+ Informar modelo manual"],{placeHolder:"Selecione o modelo Devin"});if(t){if(t.startsWith("+"))return Se();await b("modeloAtual",t)}}async function Tt(){let t=we(),e="+ Importar arquivo .md como skill",a=new Set(T()),n=[{label:e,description:"Copia para o diretorio padrao de skills"},...t.map(s=>({label:s,picked:a.has(s)}))],o=await d.window.showQuickPick(n,{canPickMany:!0,placeHolder:t.length?"Selecione skills disponiveis para o Devin":"Importe um .md ou selecione skills disponiveis"});if(!o)return;let i=o.filter(s=>s.label!==e).map(s=>s.label);if(o.some(s=>s.label===e)){let s=await Ye({selectImported:!1});s&&i.push(s.name)}await b("skillsSelecionadas",Array.from(new Set(i)))}async function It(){let t=ye(),e="+ Importar arquivo .md como tool",a=new Set(F()),n=[{label:e,description:"Copia para o diretorio padrao de tools"},...t.map(s=>({label:s,picked:a.has(s)}))],o=await d.window.showQuickPick(n,{canPickMany:!0,placeHolder:t.length?"Selecione tools disponiveis para o Devin":"Importe um .md ou selecione tools disponiveis"});if(!o)return;let i=o.filter(s=>s.label!==e).map(s=>s.label);if(o.some(s=>s.label===e)){let s=await X({kind:"tool",importer:ke,configKey:"toolsSelecionadas",selectImported:!1});s&&i.push(s.name)}await b("toolsSelecionadas",Array.from(new Set(i)))}async function Ye(t){return X({kind:"skill",importer:Je,configKey:"skillsSelecionadas",selectImported:!t||t.selectImported!==!1})}async function Xe(t){return await X({kind:"agente",importer:Ze,configKey:"agenteAtual",singleValue:!0,selectImported:!t||t.selectImported!==!1})}async function Lt(t){return X({kind:"tool",importer:ke,configKey:"toolsSelecionadas",selectImported:!t||t.selectImported!==!1})}async function X(t){let e=await d.window.showOpenDialog({canSelectFiles:!0,canSelectFolders:!1,canSelectMany:!1,filters:{Markdown:["md"]},title:"Importar arquivo Markdown como "+t.kind+" Devin"});if(!e||!e.length)return null;try{let a=t.importer(e[0].fsPath);if(t.selectImported!==!1)if(t.singleValue)await b(t.configKey,a.name);else{let n=new Set(t.configKey==="toolsSelecionadas"?F():T());n.add(a.name),await b(t.configKey,Array.from(n))}return g&&g.refreshMeta(),d.window.showInformationMessage(`${t.kind} "${a.name}" importado para ${a.file}.`),a}catch(a){return d.window.showErrorMessage("Falha ao importar "+t.kind+": "+(a&&a.message?a.message:String(a))),null}}function A(){try{return V&&V.globalState.get(ue)||[]}catch{return[]}}async function G(t){try{V&&await V.globalState.update(ue,t.slice(0,lt))}catch{}}function et(t){try{if(!t||!t.globalState||t.globalState.get(se))return!1;let e=t.globalState.get(ue)||[];return!Array.isArray(e)||e.length===0}catch{return!1}}async function tt(t){if(!et(t))return!1;try{return await d.workspace.getConfiguration("workbench").update("sideBar.location","right",d.ConfigurationTarget.Global),await t.globalState.update(se,!0),f("Primeira instalacao: sideBar.location definido como right."),!0}catch(e){f("Falha ao posicionar sidebar a direita: "+(e&&e.message?e.message:String(e)));try{await t.globalState.update(se,!0)}catch{}return!1}}var pe=class{constructor(e){this.context=e,this.view=void 0,this.busy=!1,this.session=this.newSession()}newSession(){return{id:"sess-"+Date.now().toString(36)+"-"+Math.random().toString(36).slice(2,6),title:"Nova conversa",createdAt:Date.now(),updatedAt:Date.now(),workspace:P(),model:S(),agent:Q(),mode:re(),skills:T(),tools:F(),messages:[]}}async persistSession(){if(!this.session||!this.session.messages.length)return;let e=A(),a=e.findIndex(n=>n.id===this.session.id);if(this.session.updatedAt=Date.now(),!this.session.title||this.session.title==="Nova conversa"){let n=this.session.messages.find(o=>o.role==="user");n&&(this.session.title=String(n.text).slice(0,60).replace(/\s+/g," ").trim())}a>=0?e[a]=this.session:e.unshift(this.session),e.sort((n,o)=>(o.updatedAt||0)-(n.updatedAt||0)),await G(e)}resolveWebviewView(e){this.view=e,e.webview.options={enableScripts:!0,localResourceRoots:[this.context.extensionUri]},e.webview.html=this.html(e.webview),f("WebView resolvida e HTML injetado."),e.webview.onDidReceiveMessage(async a=>{try{let n=Ne(a);if(!n){f("Mensagem webview rejeitada por validacao.");return}let o=n.type;if(f(`Mensagem recebida do webview: type=${o}`),o==="ready"){this.refreshMeta(),this.replaySession(),this.pushCurrentSelection();return}if(o==="clientError"){f(`ERRO no cliente webview: ${n.text||"sem detalhes"}`),this.post({type:"message",role:"assistant",text:"Falha no painel: "+(n.text||"erro sem detalhes")});return}if(o==="cancelRun"){let i=xe(this.session&&this.session.id);this.post({type:"action",ok:i,text:i?"Cancelamento solicitado.":"Nenhuma execucao integrada ativa para cancelar."});return}if(o==="verifyCli"){this.verifyCli();return}if(o==="requestSelection"){this.pushCurrentSelection(!0);return}if(o==="attachMenu"){await this.chooseAttachSource();return}if(o==="attachFiles"){await this.attachFiles();return}if(o==="pickWorkspaceFiles"){await this.pickWorkspaceFiles();return}if(o==="listWorkspace"){this.listWorkspaceDir(n.path||"");return}if(o==="attachFolder"){await this.attachFolder(n.path||"");return}if(o==="attachWorkspacePath"){await this.attachWorkspacePath(n.path||"");return}if(o==="searchWorkspaceFiles"){await this.searchWorkspaceFiles(n.query||"");return}if(o==="send"){await this.send(n.text||"",{echoUser:n.echo!==!1,displayText:n.displayText||n.text||"",hasExplicitContext:!!n.hasExplicitContext});return}if(o==="setModel"){await b("modeloAtual",z(n.value||"auto"));return}if(o==="setAgent"){await b("agenteAtual",n.value||"auto");return}if(o==="importAgentFile"){let i=await Xe();i&&this.post({type:"action",ok:!0,text:"Agente importado: "+i.name});return}if(o==="importSkillFile"){let i=await Ye();i&&this.post({type:"action",ok:!0,text:"Skill importada: "+i.name});return}if(o==="importToolFile"){let i=await Lt();i&&this.post({type:"action",ok:!0,text:"Tool importada: "+i.name});return}if(o==="toggleSkill"){let i=new Set(T());n.value&&i.has(n.value)?i.delete(n.value):n.value&&i.add(n.value),await b("skillsSelecionadas",Array.from(i));return}if(o==="toggleTool"){let i=new Set(F());n.value&&i.has(n.value)?i.delete(n.value):n.value&&i.add(n.value),await b("toolsSelecionadas",Array.from(i));return}if(o==="manualModel"){await Se();return}if(o==="refreshModels"){this.refreshMeta();let i=await Ue();if(i.length){let s=Array.from(new Set([...m().get("modelosDisponiveis")||[],...i]));await m().update("modelosDisponiveis",s,d.ConfigurationTarget.Workspace)}this.refreshMeta(),this.post({type:"action",ok:!0,text:"Modelos atualizados ("+K().length+" disponiveis)."});return}if(o==="review"){await this.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+ce()+"\n```",{echoUser:!0});return}if(o==="selection"){await this.send(`Analise o contexto do editor atual.

`+le(),{echoUser:!0});return}if(o==="insertSelection"){this.post({type:"insertPrompt",text:`Analise o contexto do editor atual.

`+le()});return}if(o==="newChat"){await this.persistSession(),this.session=this.newSession(),this.post({type:"clearThread"}),this.refreshMeta();return}if(o==="getHistory"){await this.openHistory();return}if(o==="exportSession"){await this.exportSession(n.id);return}if(o==="loadSession"){await this.persistSession();let s=A().find(r=>r.id===n.id);s&&(this.session=JSON.parse(JSON.stringify(s)),this.post({type:"clearThread"}),this.replaySession(),this.refreshMeta(),this.post({type:"action",ok:!0,text:"Sessao carregada: "+(s.title||s.id)}));return}if(o==="deleteSession"){let i=A().filter(s=>s.id!==n.id);await G(i),this.session&&this.session.id===n.id&&(this.session=this.newSession(),this.post({type:"clearThread"})),this.post({type:"history",sessions:i}),this.refreshMeta();return}if(o==="clearHistory"){await G([]),this.session=this.newSession(),this.post({type:"clearThread"}),this.post({type:"history",sessions:[]}),this.refreshMeta();return}this.post({type:"action",ok:!1,text:`Acao desconhecida: ${o}`})}catch(n){this.busy=!1,this.post({type:"busy",value:!1}),f(`ERRO no handler do webview: ${n&&n.message?n.message:String(n)}`),n&&n.stack&&f(n.stack),this.post({type:"message",role:"assistant",text:"Falha ao executar acao do painel: "+(n&&n.message?n.message:String(n))})}}),setTimeout(()=>this.refreshMeta(),50)}post(e){try{this.view&&this.view.webview.postMessage(e)}catch{}}async openHistory(){await this.persistSession();let e=A().filter(a=>a&&a.messages&&a.messages.length);this.post({type:"openHistory",sessions:e}),this.refreshMeta()}async exportSession(e){await this.persistSession();let a=A(),o=(e?a.find(s=>s.id===e):null)||this.session;if(!o||!o.messages||!o.messages.length){let s="Nao ha conversa com mensagens para exportar.";this.post({type:"action",ok:!1,text:s}),d.window.showInformationMessage(s);return}await d.env.clipboard.writeText(_e(o));let i="Conversa exportada em Markdown para a area de transferencia.";this.post({type:"action",ok:!0,text:i}),d.window.showInformationMessage(i)}verifyCli(){B.show(!0),f(`Verificando Devin CLI pelo painel: ${k()}`),N.execFile(k(),["--version"],{cwd:M(),windowsHide:!0},(e,a,n)=>{if(e){let s=`Falha ao verificar Devin CLI: ${e.message}`;f(s),this.post({type:"message",role:"assistant",text:s}),this.post({type:"action",ok:!1,text:s});return}let i=`Devin CLI encontrado: ${(a||n||"ok").trim()}`;f(i),this.post({type:"message",role:"assistant",text:i}),this.post({type:"action",ok:!0,text:i})})}pushCurrentSelection(e){let a=d.window.activeTextEditor,n=Et(a);n&&this.post({type:"selectionAvailable",selection:n})}attachmentId(e){return e+"-"+Date.now().toString(36)+Math.random().toString(36).slice(2,7)}readFileItem(e,a){let n=p.statSync(e);if(n.size>ne)return{skipped:!0,reason:`Arquivo muito grande: ${l.basename(e)} (${n.size} bytes).`};let o=p.readFileSync(e,"utf8"),i=l.extname(e).slice(1);return{id:this.attachmentId("file"),file:e,base:l.basename(e),label:a||l.basename(e),type:"file",text:o,language:i,lines:o.split(`
`).length}}readFolderItem(e,a){let n=v(),o=a||l.basename(e)||"workspace",i=[],s=[e];for(;s.length&&i.length<ae;){let r=s.pop(),c;try{c=p.readdirSync(r,{withFileTypes:!0})}catch{continue}for(let u of c){let h=l.join(r,u.name);if(u.isDirectory())!ct.has(u.name)&&!u.name.startsWith(".")&&s.push(h);else if(u.isFile())try{if(p.statSync(h).size>ne)continue;let C=p.readFileSync(h,"utf8"),I=n&&h.startsWith(n)?l.relative(n,h):l.join(o,l.relative(e,h));if(i.push({file:h,rel:I.replace(/\\/g,"/"),base:l.basename(h),text:C,language:l.extname(h).slice(1),lines:C.split(`
`).length}),i.length>=ae)break}catch{}}}return{id:this.attachmentId("folder"),file:e,base:o,label:`${o} (${i.length})`,type:"folder",files:i,count:i.length,truncated:i.length>=ae}}async chooseAttachSource(){let e=await d.window.showQuickPick([{label:"$(folder) Pastas",description:"Anexar pasta recursivamente como chip unico",value:"folders"},{label:"$(file) Arquivos abertos",description:"Anexar arquivos atualmente abertos no editor",value:"openFiles"}],{placeHolder:"Anexar contexto ao Devin"});if(!e)return;if(e.value==="folders"){let r=await d.window.showOpenDialog({canSelectMany:!0,canSelectFiles:!1,canSelectFolders:!0,defaultUri:v()?d.Uri.file(v()):void 0,openLabel:"Anexar pasta"});if(!r||!r.length)return;let c=[];for(let u of r)try{let h=this.readFolderItem(u.fsPath,l.basename(u.fsPath));h.files&&h.files.length&&c.push(h)}catch(h){this.post({type:"action",ok:!1,text:`Falha ao anexar pasta ${u.fsPath}: ${h.message}`})}c.length&&this.post({type:"attachItems",items:c}),this.post({type:"action",ok:!0,text:`Anexadas ${c.length} pasta(s).`});return}let a=d.workspace.textDocuments.filter(r=>r.uri&&r.uri.scheme==="file"&&!r.isUntitled);if(!a.length){this.post({type:"action",ok:!1,text:"Nenhum arquivo aberto para anexar."});return}let n=v()||"",o=a.map(r=>({label:"$(file) "+l.basename(r.uri.fsPath),description:n?l.dirname(l.relative(n,r.uri.fsPath)):l.dirname(r.uri.fsPath),detail:r.uri.fsPath,doc:r})),i=await d.window.showQuickPick(o,{canPickMany:!0,placeHolder:"Selecione arquivos abertos para anexar"});if(!i||!i.length)return;let s=[];for(let r of i){let c=r.doc,u=c.getText();if(Buffer.byteLength(u,"utf8")>ne){this.post({type:"action",ok:!1,text:`Arquivo muito grande: ${l.basename(c.uri.fsPath)}.`});continue}s.push({id:this.attachmentId("file"),file:c.uri.fsPath,base:l.basename(c.uri.fsPath),label:l.basename(c.uri.fsPath),type:"file",text:u,language:c.languageId||l.extname(c.uri.fsPath).slice(1),lines:u.split(`
`).length})}s.length&&this.post({type:"attachItems",items:s})}async attachFiles(){try{let e=await d.window.showOpenDialog({canSelectMany:!0,canSelectFiles:!0,canSelectFolders:!1,defaultUri:v()?d.Uri.file(v()):void 0,openLabel:"Anexar ao chat"});if(!e||!e.length)return;let a=[];for(let n of e)try{let o=p.statSync(n.fsPath);if(o.size>1024*1024){a.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:n.fsPath,base:l.basename(n.fsPath),label:l.basename(n.fsPath),type:"file",text:`Arquivo ${n.fsPath} muito grande (${o.size} bytes) - nao anexado.`,language:"",tooBig:!0});continue}let i=p.readFileSync(n.fsPath,"utf8"),s=l.extname(n.fsPath).slice(1);a.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:n.fsPath,base:l.basename(n.fsPath),label:l.basename(n.fsPath),type:"file",text:i,language:s,lines:i.split(`
`).length})}catch(o){this.post({type:"action",ok:!1,text:`Falha ao ler ${n.fsPath}: ${o.message}`})}a.length&&this.post({type:"attachItems",items:a})}catch(e){this.post({type:"action",ok:!1,text:"Falha ao anexar: "+(e&&e.message?e.message:String(e))})}}async pickWorkspaceFiles(){try{let e=await d.workspace.findFiles("**/*","**/{node_modules,.git,dist,build,out,.venv,__pycache__}/**",5e3);if(!e.length){this.post({type:"action",ok:!1,text:"Nenhum arquivo encontrado."});return}let a=v()||"",n=e.map(s=>({label:l.relative(a,s.fsPath)||l.basename(s.fsPath),description:"",uri:s})),o=await d.window.showQuickPick(n,{placeHolder:"Selecione arquivos do workspace para anexar",canPickMany:!0,matchOnDescription:!0});if(!o||!o.length)return;let i=[];for(let s of o)try{if(p.statSync(s.uri.fsPath).size>1024*1024)continue;let c=p.readFileSync(s.uri.fsPath,"utf8"),u=l.extname(s.uri.fsPath).slice(1);i.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:s.uri.fsPath,base:l.basename(s.uri.fsPath),label:l.basename(s.uri.fsPath),type:"file",text:c,language:u})}catch{}i.length&&this.post({type:"attachItems",items:i})}catch(e){this.post({type:"action",ok:!1,text:"Falha: "+(e&&e.message?e.message:String(e))})}}listWorkspaceDir(e){try{let a=v();if(!a){this.post({type:"workspaceList",path:e||"",entries:[],error:"Sem workspace aberto."});return}let n=Z(e||"");if(!n){this.post({type:"workspaceList",path:"",entries:[],error:"Diretorio fora do workspace."});return}if(!p.existsSync(n)||!p.statSync(n).isDirectory()){this.post({type:"workspaceList",path:"",entries:[],error:"Diretorio invalido."});return}let o=l.relative(a,n).replace(/\\/g,"/"),i=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),s=p.readdirSync(n,{withFileTypes:!0}).filter(r=>!r.name.startsWith(".")||[".cognition",".devin",".claude",".cursor",".vscode"].includes(r.name)).filter(r=>!(r.isDirectory()&&i.has(r.name))).map(r=>{let c=0;try{r.isFile()&&(c=p.statSync(l.join(n,r.name)).size)}catch{}return{name:r.name,isDir:r.isDirectory(),size:c}}).sort((r,c)=>c.isDir-r.isDir||r.name.localeCompare(c.name));this.post({type:"workspaceList",path:o,entries:s})}catch(a){this.post({type:"workspaceList",path:"",entries:[],error:a.message})}}async attachWorkspacePath(e){if(!v())return;let n=Z(e||"");if(!n){this.post({type:"action",ok:!1,text:"Caminho fora do workspace."});return}if(!p.existsSync(n)){this.post({type:"action",ok:!1,text:"Caminho invalido."});return}if(p.statSync(n).isDirectory()){await this.attachFolder(e);return}try{let o=p.statSync(n);if(o.size>1024*1024){this.post({type:"action",ok:!1,text:`Arquivo muito grande: ${l.basename(n)} (${o.size} bytes).`});return}let i=p.readFileSync(n,"utf8"),s=l.extname(n).slice(1);this.post({type:"attachItems",items:[{id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:n,base:l.basename(n),label:l.basename(n),type:"file",text:i,language:s}]})}catch(o){this.post({type:"action",ok:!1,text:"Falha: "+o.message})}}async searchWorkspaceFiles(e){try{let a=v();if(!a){this.post({type:"workspaceFileSuggestions",query:e,files:[]});return}let n=String(e||"").toLowerCase(),i=(await d.workspace.findFiles("**/*","**/{node_modules,.git,dist,build,out,.venv,__pycache__,.next,.nuxt,.cache,target,.idea}/**",1e3)).map(s=>{let r=l.relative(a,s.fsPath).replace(/\\/g,"/");return{label:r,path:r,base:l.basename(s.fsPath)}}).filter(s=>!n||s.label.toLowerCase().includes(n)||s.base.toLowerCase().includes(n)).slice(0,20);this.post({type:"workspaceFileSuggestions",query:e,files:i})}catch(a){this.post({type:"workspaceFileSuggestions",query:e,files:[],error:a&&a.message?a.message:String(a)})}}async attachFolder(e){let a=v();if(!a)return;let n=Z(e||"");if(!n){this.post({type:"action",ok:!1,text:"Pasta fora do workspace."});return}let o=l.relative(a,n).replace(/\\/g,"/");if(!p.existsSync(n)||!p.statSync(n).isDirectory()){this.post({type:"action",ok:!1,text:"Pasta invalida."});return}let i=this.readFolderItem(n,o?l.basename(n):P());i.files&&i.files.length&&this.post({type:"attachItems",items:[i]}),this.post({type:"action",ok:!0,text:`Pasta anexada como chip unico: ${i.label}.`})}replaySession(){if(!(!this.session||!this.session.messages.length))for(let e of this.session.messages)this.post({type:"message",role:e.role,text:e.text,replay:!0})}refreshMeta(){let e={type:"meta",models:ie,model:S(),agents:["auto"],agent:Q(),skills:[],selectedSkills:T(),selectedTools:F(),mode:re(),workspace:P(),sessionId:this.session&&this.session.id,sessionTitle:this.session&&this.session.title,modelLocked:!1,hasMessages:!!(this.session&&this.session.messages&&this.session.messages.length),tokensTotal:this.session&&this.session.tokens||0,tokensIn:this.session&&this.session.tokensIn||0,tokensOut:this.session&&this.session.tokensOut||0,modelStatus:"modelo: auto"};try{e.models=K()}catch{e.models=ie}try{e.agents=be()}catch{e.agents=["auto"]}try{e.skills=we()}catch{e.skills=[]}try{e.tools=ye()}catch{e.tools=[]}try{e.recentSessions=A().slice(0,3).map(a=>({id:a.id,title:a.title||"Sem titulo",updatedAt:a.updatedAt,messages:(a.messages||[]).length,model:a.model||"auto"}))}catch{e.recentSessions=[]}try{e.modelStatus=`${e.models.length} modelos | ${e.skills.length} skills | ${e.tools.length} tools`}catch{}this.post(e)}async send(e,a){let n=String(e||"").trim();if(!n)return;let o=String(a&&a.displayText?a.displayText:n).trim(),i=ze(n);i&&(n=i.text,i.command==="review"&&(n=n+"\n\n```diff\n"+ce()+"\n```"),o=i.displayText||o);let s=null;if(!a||!a.hasExplicitContext){let c=Qe();c&&c.promptBlock&&(n=n+c.promptBlock,o=o+`

[Contexto automatico: `+c.label+"]",s=c.label)}if(this.busy){this.post({type:"message",role:"assistant",text:"Ja existe uma execucao em andamento. A concorrencia permanece controlada no backend."});return}this.busy=!0;let r=Be($(n));this.session.tokensIn=(this.session.tokensIn||0)+r,this.session.tokens=(this.session.tokens||0)+r,(!a||a.echoUser!==!1)&&this.post({type:"message",role:"user",text:o}),this.session.messages.push({role:"user",text:o,fullText:n,ts:Date.now(),tokens:r}),this.post({type:"busy",value:!0}),s&&this.post({type:"ctxHint",text:"\u{1F4C4} Contexto automatico: "+s}),this.post({type:"action",ok:!0,text:"Enviando para o Devin CLI..."}),this.refreshMeta();try{f(`send: modo=resposta-integrada prompt=${n.length} chars`);let c=await Ge(n,{sessionId:this.session.id});f(`send: resposta recebida (${c?c.length:0} chars)`);let u=Be(c);this.session.tokensOut=(this.session.tokensOut||0)+u,this.session.tokens=(this.session.tokens||0)+u,this.post({type:"message",role:"assistant",text:c}),this.session.messages.push({role:"assistant",text:c,ts:Date.now(),tokens:u})}catch(c){f(`send ERRO: ${c&&c.message?c.message:String(c)}`);let u="Falha ao enviar para o Devin CLI: "+(c&&c.message?c.message:String(c));this.post({type:"message",role:"assistant",text:u}),this.session.messages.push({role:"assistant",text:u,ts:Date.now()})}finally{this.busy=!1,this.post({type:"busy",value:!1}),await this.persistSession(),this.refreshMeta()}}html(e){let a=$e(),n={history:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M8 4.5V8l2.4 1.6"/></svg>',plus:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M8 3v10M3 8h10"/></svg>',refresh:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M13 8a5 5 0 1 1-1.5-3.55"/><path d="M13 3v3h-3"/></svg>',terminal:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="12" height="10" rx="1.5"/><path d="M5 7l2 1.5L5 10M8.5 10.5h3"/></svg>',lock:'<svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="7" width="9" height="6.5" rx="1"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2"/></svg>',paperclip:'<svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M11.5 6.5L6.8 11.2a2 2 0 0 1-2.8-2.8l5.4-5.4a3 3 0 0 1 4.2 4.2l-5.4 5.4a4 4 0 0 1-5.7-5.7L7.5 2.5"/></svg>',attach:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M11.5 6.5L6.8 11.2a2 2 0 0 1-2.8-2.8l5.4-5.4a3 3 0 0 1 4.2 4.2l-5.4 5.4a4 4 0 0 1-5.7-5.7L7.5 2.5"/></svg>',file:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3 1.5h6.5L13 5v9.5H3z"/><path d="M9.5 1.5V5H13"/></svg>',folder:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4.5a1 1 0 0 1 1-1h3l1.5 1.5h5.5a1 1 0 0 1 1 1V12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1z"/></svg>',close:'<svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M4 4l8 8M12 4l-8 8"/></svg>',send:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><path d="M2 13.5L14 8 2 2.5 2 7l8 1-8 1z"/></svg>',brain:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M5.5 3a2 2 0 0 0-2 2 2 2 0 0 0-1 3.5 2 2 0 0 0 1.5 3 2 2 0 0 0 3.5 0V3.5A1.5 1.5 0 0 0 5.5 3z"/><path d="M10.5 3a2 2 0 0 1 2 2 2 2 0 0 1 1 3.5 2 2 0 0 1-1.5 3 2 2 0 0 1-3.5 0V3.5A1.5 1.5 0 0 1 10.5 3z"/></svg>',bot:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5.5" width="10" height="7" rx="1.5"/><path d="M8 3v2.5M5.5 8.5h.01M10.5 8.5h.01M2 9.5v1.5M14 9.5v1.5"/></svg>',mode:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M2 5.5h12M2 8h8M2 10.5h10"/></svg>',sparkle:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><path d="M8 2l1.2 3.4L12.5 6.5 9.2 7.6 8 11l-1.2-3.4L3.5 6.5 6.8 5.4z"/></svg>',wrench:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.45" stroke-linecap="round" stroke-linejoin="round"><path d="M10.8 2.2a3.2 3.2 0 0 0-3.7 4.1L2.6 10.8a1.7 1.7 0 0 0 2.4 2.4l4.5-4.5a3.2 3.2 0 0 0 4.1-3.7l-2.2 2.2-2.1-.5-.5-2.1z"/></svg>',caret:'<svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor"><path d="M5 3l6 5-6 5z"/></svg>'},o=[{label:"auto",value:"auto"},{label:"sonnet",value:"sonnet"},{label:"opus",value:"opus"},{label:"swe",value:"swe"},{label:"gpt",value:"gpt"}];return`<!doctype html><html lang="pt-BR"><head><meta charset="UTF-8"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src ${e.cspSource} data:; style-src 'unsafe-inline' ${e.cspSource}; script-src 'nonce-${a}';"><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>
...
</script></body></html>`}};async function Bt(t){V=t,B=d.window.createOutputChannel("Devin Cli Chat"),t.subscriptions.push(B),f(`Extens\xE3o ativando \u2014 VS Code ${d.version}, extens\xE3o ${t.extension.packageJSON.version}`),f(`Plataforma: ${process.platform} ${process.arch}`),f(`Devin CLI path configurado: ${k()}`),f(`Workspace: ${v()||"nenhum"}`),await tt(t),g=new pe(t),t.subscriptions.push(d.window.registerWebviewViewProvider("devinCliChat.chatView",g,{webviewOptions:{retainContextWhenHidden:!0}})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.abrirPainel",async()=>d.commands.executeCommand("workbench.view.extension.devinCliChat"))),t.subscriptions.push(d.commands.registerCommand("devinCliChat.abrirHistorico",async()=>{await d.commands.executeCommand("workbench.view.extension.devinCliChat"),setTimeout(()=>{g&&g.openHistory()},100)})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.exportarSessaoAtual",async()=>{await d.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.exportSession()})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.novaSessao",()=>xt(""))),t.subscriptions.push(d.commands.registerCommand("devinCliChat.revisarDiff",async()=>{await d.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+ce()+"\n```")})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.enviarSelecao",async()=>{await d.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send(`Analise o contexto do editor atual.

`+le())})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.selecionarModelo",At)),t.subscriptions.push(d.commands.registerCommand("devinCliChat.definirModeloManual",Se)),t.subscriptions.push(d.commands.registerCommand("devinCliChat.atualizarModelos",async()=>{q(),g&&g.refreshMeta();let n=await Ue();if(n.length){let o=Array.from(new Set([...m().get("modelosDisponiveis")||[],...n]));await m().update("modelosDisponiveis",o,d.ConfigurationTarget.Workspace),q()}g&&g.refreshMeta(),d.window.showInformationMessage(`Modelos atualizados (${K().length} disponiveis).`)})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.selecionarAgente",async()=>{let n="+ Importar arquivo .md como agente",o=await d.window.showQuickPick([n,...be()],{placeHolder:"Selecione o agente Devin"});if(o){if(o===n){await Xe();return}await b("agenteAtual",o)}})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.selecionarSkills",Tt)),t.subscriptions.push(d.commands.registerCommand("devinCliChat.selecionarTools",It)),t.subscriptions.push(d.commands.registerCommand("devinCliChat.limparHistorico",async()=>{await d.window.showWarningMessage("Limpar todo o historico de chats?",{modal:!0},"Limpar")==="Limpar"&&(await G([]),g&&g.post({type:"history",sessions:[]}))})),t.subscriptions.push(d.commands.registerCommand("devinCliChat.verificarCli",()=>{B.show(!0),f(`Verificando Devin CLI: ${k()}`),N.execFile(k(),["--version"],{cwd:M(),windowsHide:!0},(n,o,i)=>{if(n)f(`verificarCli ERRO: code=${n.code} msg=${n.message}`),d.window.showErrorMessage(`Falha ao verificar Devin CLI: ${n.message}`);else{let s=(o||i||"ok").trim();f(`verificarCli OK: ${s}`),d.window.showInformationMessage(`Devin CLI encontrado: ${s}`)}})}));let e,a=()=>{e&&clearTimeout(e),e=setTimeout(()=>{g&&g.pushCurrentSelection(!0)},150)};t.subscriptions.push(d.window.onDidChangeTextEditorSelection(a)),t.subscriptions.push(d.window.onDidChangeActiveTextEditor(a)),t.subscriptions.push(d.workspace.onDidChangeConfiguration(n=>{n.affectsConfiguration(Pe)&&(q(),de(),g&&g.refreshMeta())})),de()}function Pt(){for(let t of We())xe(t)}module.exports={activate:Bt,deactivate:Pt,_internal:{baseArgs:Y,fullPrompt:$,runIntegrated:Ge,modelsForUi:K,scanAgents:be,scanSkills:we,scanTools:ye,skillNameFromMarkdownFile:Ke,importSkillMarkdownFile:Je,importAgentMarkdownFile:Ze,importToolMarkdownFile:ke,loadHistory:A,saveHistory:G,sanitizeModel:z,sanitizePromptText:He,isSafeModelId:De,cancelIntegratedRun:xe,automaticEditorContext:Qe,resolveWorkspacePathSafe:Z,registerRunState:ge,unregisterRunState:ve,activeRunIds:We,createNonce:$e,validateWebviewMessage:Ne,expandSlashCommand:ze,exportSessionMarkdown:_e,shouldApplyFirstInstallRightSidebar:et,applyFirstInstallRightSidebar:tt}};
