...
<footer class="composerWrap">
  ...
  <div class="composer">
    ...
    <div class="composerBar">
      ...
      <button type="button" class="chipBtn" data-action="openToolsMenu" id="toolsBtn" title="Tools">${n.terminal}<span class="chipText">Tools <span id="toolsCount">0</span></span></button>
