"use strict";var c=require("vscode"),u=require("fs"),l=require("path"),y=require("os"),F=require("child_process"),Ye=require("crypto"),Ee="devinCliChat",Xe=["auto","sonnet","opus","swe","gpt"],ae=["auto","adaptive","sonnet","opus","swe","gpt","codex"],de="devinCliChat.chatHistory.v1",oe="devinCliChat.firstInstallLayout.v1",et=50,ee=1024*1024,te=50,tt=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),g,L,W,P,G=new Map,_={at:0,values:void 0},H={at:0,values:void 0},j={at:0,values:void 0};function f(n){let e=new Date().toISOString();P&&P.appendLine(`[${e}] ${n}`)}function Ae(){return 1e4}function nt(){return Math.max(0,Number(m().get("cacheModelosMs")||18e5))}function R(){_={at:0,values:void 0},H={at:0,values:void 0},j={at:0,values:void 0}}function Ie(n){return/^[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}$/.test(String(n||"").trim())}function m(){return c.workspace.getConfiguration(Ee)}function v(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].uri.fsPath:void 0}function B(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].name:"sem pasta aberta"}function Te(n){if(!n)return n;let e=String(n);return e==="~"?y.homedir():e.startsWith("~/")||e.startsWith("~\\")?l.join(y.homedir(),e.slice(2)):e}function C(n){let e=Te(n);return e&&(l.isAbsolute(e)?e:l.join(v()||y.homedir(),e))}function pe(n){try{return!!n&&u.existsSync(n)}catch{return!1}}function Le(){return Ye.randomBytes(18).toString("base64")}function E(n,e){if(typeof n!="string")return;let a=e||2e4;return n.length>a?n.slice(0,a):n}function ke(n){return typeof n=="boolean"?n:void 0}function at(n){return typeof n=="string"&&/^[a-zA-Z0-9][a-zA-Z0-9._:-]{0,159}$/.test(n)}function Pe(n){if(!n||typeof n!="object"||Array.isArray(n))return null;let e=E(n.type,40);if(new Set(["ready","cancelRun","verifyCli","requestSelection","attachMenu","attachFiles","pickWorkspaceFiles","manualModel","refreshModels","review","selection","insertSelection","newChat","getHistory","clearHistory","importSkillFile"]).has(e))return{type:e};if(e==="clientError")return{type:e,text:E(n.text,2e3)||""};if(e==="send"){let t=E(n.text,2e5);if(t===void 0)return null;let o={type:e,text:t},i=E(n.displayText,2e5),s=ke(n.echo),r=ke(n.hasExplicitContext);return i!==void 0&&(o.displayText=i),s!==void 0&&(o.echo=s),r!==void 0&&(o.hasExplicitContext=r),o}if(e==="terminal"){let t=E(n.text,2e5);return t===void 0?null:{type:e,text:t}}if(e==="setModel"||e==="setMode"||e==="setAgent"||e==="toggleSkill"){let t=E(n.value,200);return t===void 0?null:{type:e,value:t}}if(e==="listWorkspace"||e==="attachFolder"||e==="attachWorkspacePath"){let t=E(n.path||"",2e3);return t===void 0?null:{type:e,path:t}}return(e==="loadSession"||e==="deleteSession"||e==="exportSession")&&at(n.id)?{type:e,id:n.id}:null}function Be(n){let e=String(n||"").trim();if(!e.startsWith("/"))return null;let t=(e.slice(1).split(/\s+/).shift()||"").toLowerCase(),i=e.slice(t.length+2).trim()||"o contexto atual",r={review:"Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.",tests:`Proponha e implemente testes para ${i}. Priorize cobertura de comportamento, regressao e caminhos de erro.`,plan:`Crie um plano tecnico objetivo para ${i}. Agrupe por impacto, risco e ordem de execucao.`,explain:`Explique ${i} com foco em arquitetura, fluxo de dados e pontos de manutencao.`,security:`Revise ${i} com foco em riscos de seguranca, entrada nao confiavel, execucao de comandos e exposicao de dados.`,docs:`Gere documentacao pratica para ${i}, incluindo objetivo, uso, limites e exemplos.`,"commit-msg":"Gere uma mensagem de commit convencional para as mudancas atuais, com escopo claro e resumo curto."}[t];return r?{command:t,text:r,displayText:e}:null}function z(n){return String(n??"").replace(/\r?\n/g," ").trim()}function De(n){let e=n||{},a=[];a.push("# "+(z(e.title)||"Sessao Devin")),a.push(""),a.push("- Workspace: "+(z(e.workspace)||B())),a.push("- Modelo: "+(z(e.model)||"auto")),a.push("- Agente: "+(z(e.agent)||"auto")),a.push("- Modo: "+(z(e.mode)||"resposta-integrada")),e.createdAt&&a.push("- Criada em: "+new Date(e.createdAt).toISOString()),e.updatedAt&&a.push("- Atualizada em: "+new Date(e.updatedAt).toISOString()),a.push("");let t=Array.isArray(e.messages)?e.messages:[];for(let o of t){let i=String(o&&o.role||"message").toLowerCase();a.push("## "+i.charAt(0).toUpperCase()+i.slice(1)),o&&o.ts&&a.push("_"+new Date(o.ts).toISOString()+"_"),a.push(""),a.push(String(o&&o.text||"").trim()),a.push("")}return a.join(`
`).trim()+`
`}function D(n){return`'${String(n).replace(/'/g,"'\\''")}'`}function N(n){let e=String(n||"").trim().toLowerCase();return!e||e==="default"||e==="padrao"||e==="padr\xE3o"?"auto":Ie(e)?e:"auto"}function $e(n){return N(n)}function Ce(){return[...ae]}function ot(n){try{return pe(n)?JSON.parse(u.readFileSync(n,"utf8")):void 0}catch{return}}function it(){if(process.platform==="win32"){let n=process.env.APPDATA||l.join(y.homedir(),"AppData","Roaming");return l.join(n,"devin","config.json")}return l.join(y.homedir(),".config","devin","config.json")}function ue(){let n=ot(it());return n&&n.agent?$e(n.agent.model):void 0}function S(){let n=m().get("modeloAtual");return $e(n??(ue()||"auto"))}function Fe(){let n=m().get("modeloAtual");return N(n??(ue()||"auto"))}function Z(){return String(m().get("agenteAtual")||"auto")}function K(){return String(m().get("modoExecucaoChat")||"resposta-integrada")}function I(){let n=m().get("skillsSelecionadas")||[];return Array.isArray(n)?n.map(String).filter(Boolean):[]}function w(){return String(m().get("caminhoDevin")||"devin")}function M(){return v()||y.homedir()}function Se(n){try{if(u.existsSync(n))return u.realpathSync.native?u.realpathSync.native(n):u.realpathSync(n)}catch{}return l.resolve(n)}function st(n,e){let a=l.relative(n,e);return a===""||!!a&&!a.startsWith("..")&&!l.isAbsolute(a)}function J(n){let e=v();if(!e)return null;let a=Se(e),t=String(n||"").replace(/\\/g,l.sep).trim(),o=l.isAbsolute(t)?l.resolve(t):l.resolve(a,t),i=Se(o);return st(a,i)?i:null}function Ne(){return[Te(m().get("gitBashPath")),process.env.GIT_BASH_PATH,"C:\\Program Files\\Git\\bin\\bash.exe","C:\\Program Files\\Git\\usr\\bin\\bash.exe","C:\\Program Files (x86)\\Git\\bin\\bash.exe",l.join(y.homedir(),"AppData","Local","Programs","Git","bin","bash.exe")].filter(Boolean).find(pe)}function rt(){return process.platform==="win32"&&m().get("usarGitBashNoWindows",!0)?Ne():process.env.SHELL||void 0}function Q(){let n=[...(m().get("argumentosPadrao")||[]).map(String).filter(Boolean)],e=String(m().get("argumentoModelo")||"").trim(),a=Fe();return e&&a&&a!=="auto"&&n.push(e,a),n}function $(n){let e=m().get("prefixoPromptPadrao")||"",a=Fe()||S()||"auto",t=Z(),o=I(),i=[`Workspace VS Code: ${B()}`,v()?`Diretorio raiz: ${v()}`:"Diretorio raiz: nao ha pasta aberta",`Modelo selecionado: ${a}`,`Agente selecionado: ${t}`,o.length?`Skills disponiveis: ${o.join(", ")}`:""].filter(Boolean).join(`
`),s=t!=="auto"?`Use o perfil/subagente Devin chamado "${t}" quando aplicavel. Se a CLI nao aceitar selecao direta de agente nesta chamada, trate este agente como persona operacional e siga as instrucoes do respectivo AGENT.md.`:"",r=o.length?`Invoque a skill via tool 'skill' quando aplicavel: ${o.map(d=>`"${d}"`).join(", ")}. Siga as instrucoes do respectivo SKILL.md.`:"";return[e,i,s,r,n].filter(Boolean).join(`

`)}function lt(n){let e=D(w()),a=Q().map(D).join(" ");return n?[e,a,"-p","--",D($(n))].filter(Boolean).join(" "):[e,a].filter(Boolean).join(" ")}function ct(n){return n?String(n).split(/\r?\n/).filter(e=>!/were not migrated because they already exist/i.test(e)).filter(e=>!/migration.*already exist/i.test(e)).join(`
`).trim():""}function ze(n,e,a){let t=ct(e),o=[n||"",t||"",a&&a.message?a.message:""].join(`
...
`)||"Sem saida do Devin CLI."}function ie(n){let e=rt(),a=c.window.createTerminal({name:m().get("nomeTerminal")||"Devin Cli Chat",cwd:M(),shellPath:e,shellArgs:process.platform==="win32"&&e?["--login","-i"]:void 0});a.show(!0),a.sendText(lt(n))}function U(n){return n||"__default__"}function me(n,e){let a=U(n);return G.set(a,Object.assign({sessionId:a,cancelRequested:!1,startedAt:Date.now()},e||{})),G.get(a)}function O(n){return G.get(U(n))}function he(n){G.delete(U(n))}function _e(){return Array.from(G.keys())}function fe(n){let e=O(n);if(!e)return!1;e.cancelRequested=!0;let a=e.process;if(!a||a.killed)return!1;try{return a.kill(),!0}catch(t){return f(`cancelIntegratedRun erro: ${t&&t.message?t.message:String(t)}`),!1}}function He(n,e){return new Promise(a=>{let t=U(e&&e.sessionId),o=[...Q(),"-p","--",$(n)];f(`runIntegrated: session=${t} ${w()} ${o.slice(0,-1).join(" ")} -- [prompt ${$(n).length} chars]`),f(`  cwd: ${M()}`);let i=!1;function s(r){i||(i=!0,he(t),a(r))}try{let r=F.execFile(w(),o,{cwd:M(),timeout:Number(m().get("timeoutChatMs")||3e5),maxBuffer:16777216,windowsHide:!0},(d,p,h)=>{let x=O(t);if(x&&x.cancelRequested){s("Execucao cancelada pelo usuario.");return}if(d&&f(`runIntegrated erro: code=${d.code} signal=${d.signal} killed=${d.killed} msg=${d.message}`),h&&h.trim()&&f(`runIntegrated stderr: ${h.slice(0,500)}`),p&&p.trim()&&f(`runIntegrated stdout: ${p.slice(0,200)}...`),d&&process.platform==="win32"){ne(n,d,{sessionId:t}).then(s);return}s(ze(p,h,d))});me(t,{process:r,mode:"integrated"}),r.on("error",d=>{f(`runIntegrated child error: ${d.message}`);let p=O(t);if(p&&p.cancelRequested){s("Execucao cancelada pelo usuario.");return}process.platform==="win32"?ne(n,d,{sessionId:t}).then(s):s(`Falha ao iniciar Devin CLI: ${d.message}
...
</script></body></html>`}};async function xt(n){W=n,P=c.window.createOutputChannel("Devin Cli Chat"),n.subscriptions.push(P),f(`Extens\xE3o ativando \u2014 VS Code ${c.version}, extens\xE3o ${n.extension.packageJSON.version}`),f(`Plataforma: ${process.platform} ${process.arch}`),f(`Devin CLI path configurado: ${w()}`),f(`Workspace: ${v()||"nenhum"}`),await Ue(n),g=new ce(n),n.subscriptions.push(c.window.registerWebviewViewProvider("devinCliChat.chatView",g,{webviewOptions:{retainContextWhenHidden:!0}})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirPainel",async()=>c.commands.executeCommand("workbench.view.extension.devinCliChat"))),n.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirHistorico",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),setTimeout(()=>{g&&g.openHistory()},100)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.exportarSessaoAtual",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.exportSession()})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.novaSessao",()=>ie(""))),n.subscriptions.push(c.commands.registerCommand("devinCliChat.revisarDiff",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+re()+"\n```")})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.enviarSelecao",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send(`Analise o contexto do editor atual.

`+se())})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarModelo",gt)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.definirModeloManual",xe)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.atualizarModelos",async()=>{R(),g&&g.refreshMeta();let t=await Re();if(t.length){let o=Array.from(new Set([...m().get("modelosDisponiveis")||[],...t]));await m().update("modelosDisponiveis",o,c.ConfigurationTarget.Workspace),R()}g&&g.refreshMeta(),c.window.showInformationMessage(`Modelos atualizados (${V().length} disponiveis).`)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarAgente",async()=>{let t=await c.window.showQuickPick(ge(),{placeHolder:"Selecione o agente Devin"});t&&await b("agenteAtual",t)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarSkills",vt)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarModo",async()=>{let t=await c.window.showQuickPick([{label:"Integrado (resposta no chat)",value:"resposta-integrada"},{label:"Terminal",value:"terminal"}],{placeHolder:"Selecione o modo de execucao"});t&&await b("modoExecucaoChat",t.value)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.limparHistorico",async()=>{await c.window.showWarningMessage("Limpar todo o historico de chats?",{modal:!0},"Limpar")==="Limpar"&&(await q([]),g&&g.post({type:"history",sessions:[]}))})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.verificarCli",()=>{P.show(!0),f(`Verificando Devin CLI: ${w()}`),F.execFile(w(),["--version"],{cwd:M(),windowsHide:!0},(t,o,i)=>{if(t)f(`verificarCli ERRO: code=${t.code} msg=${t.message}`),c.window.showErrorMessage(`Falha ao verificar Devin CLI: ${t.message}`);else{let s=(o||i||"ok").trim();f(`verificarCli OK: ${s}`),c.window.showInformationMessage(`Devin CLI encontrado: ${s}`)}})}));let e,a=()=>{e&&clearTimeout(e),e=setTimeout(()=>{g&&g.pushCurrentSelection(!0)},150)};n.subscriptions.push(c.window.onDidChangeTextEditorSelection(a)),n.subscriptions.push(c.window.onDidChangeActiveTextEditor(a)),n.subscriptions.push(c.workspace.onDidChangeConfiguration(t=>{t.affectsConfiguration(Ee)&&(R(),le(),g&&g.refreshMeta())})),le()}function bt(){for(let n of _e())fe(n)}module.exports={activate:xt,deactivate:bt,_internal:{baseArgs:Q,fullPrompt:$,runIntegrated:He,modelsForUi:V,scanAgents:ge,scanSkills:ve,skillNameFromMarkdownFile:Oe,importSkillMarkdownFile:qe,loadHistory:A,saveHistory:q,sanitizeModel:N,isSafeModelId:Ie,cancelIntegratedRun:fe,automaticEditorContext:We,resolveWorkspacePathSafe:J,registerRunState:me,unregisterRunState:he,activeRunIds:_e,createNonce:Le,validateWebviewMessage:Pe,expandSlashCommand:Be,exportSessionMarkdown:De,shouldApplyFirstInstallRightSidebar:Ve,applyFirstInstallRightSidebar:Ue}};
