"use strict";var c=require("vscode"),m=require("fs"),d=require("path"),C=require("os"),F=require("child_process"),gt=require("crypto"),je="devinCliChat",de=["auto","sonnet","opus","codex"],He=["low","medium","high"],xe="devinCliChat.chatHistory.v1",ue="devinCliChat.firstInstallLayout.v1",vt=50,re=1024*1024,le=50,xt=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),g,$,Q,N,J=new Map,W={at:0,values:void 0},k={at:0,values:void 0,flag:void 0},G={at:0,values:void 0},V={at:0,values:void 0},U={at:0,values:void 0};function f(t){let e=new Date().toISOString();N&&N.appendLine(`[${e}] ${t}`)}function be(){return 1e4}function Re(){let t=u().get("cacheModelosMs");return Math.max(0,Number(t??18e5))}function M(){W={at:0,values:void 0},k={at:0,values:void 0,flag:void 0},G={at:0,values:void 0},V={at:0,values:void 0},U={at:0,values:void 0}}function ye(t){return/^[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}$/.test(String(t||"").trim())}function we(t){return/^[a-zA-Z][a-zA-Z0-9._-]{1,40}$/.test(String(t||"").trim())}function u(){return c.workspace.getConfiguration(je)}function v(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].uri.fsPath:void 0}function z(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].name:"sem pasta aberta"}function qe(t){if(!t)return t;let e=String(t);return e==="~"?C.homedir():e.startsWith("~/")||e.startsWith("~\\")?d.join(C.homedir(),e.slice(2)):e}function y(t){let e=qe(t);return e&&(d.isAbsolute(e)?e:d.join(v()||C.homedir(),e))}function ke(t){try{return!!t&&m.existsSync(t)}catch{return!1}}function Oe(){return gt.randomBytes(18).toString("base64")}function I(t,e){if(typeof t!="string")return;let o=e||2e4;return t.length>o?t.slice(0,o):t}function Ne(t){return typeof t=="boolean"?t:void 0}function bt(t){return typeof t=="string"&&/^[a-zA-Z0-9][a-zA-Z0-9._:-]{0,159}$/.test(t)}function We(t){if(!t||typeof t!="object"||Array.isArray(t))return null;let e=I(t.type,40);if(new Set(["ready","cancelRun","verifyCli","requestSelection","attachMenu","attachFiles","pickWorkspaceFiles","manualModel","refreshModels","review","selection","insertSelection","newChat","getHistory","clearHistory","importAgentFile","importSkillFile","importToolFile"]).has(e))return{type:e};if(e==="clientError")return{type:e,text:I(t.text,2e3)||""};if(e==="send"){let n=I(t.text,2e5);if(n===void 0)return null;let a={type:e,text:n},s=I(t.displayText,2e5),i=Ne(t.echo),l=Ne(t.hasExplicitContext);return s!==void 0&&(a.displayText=s),i!==void 0&&(a.echo=i),l!==void 0&&(a.hasExplicitContext=l),a}if(e==="searchWorkspaceFiles")return{type:e,query:I(t.query||"",200)||""};if(e==="setModel"||e==="setEffort"||e==="setAgent"||e==="toggleSkill"||e==="toggleTool"){let n=I(t.value,200);return n===void 0?null:{type:e,value:n}}if(e==="listWorkspace"||e==="attachFolder"||e==="attachWorkspacePath"){let n=I(t.path||"",2e3);return n===void 0?null:{type:e,path:n}}return(e==="loadSession"||e==="deleteSession"||e==="exportSession")&&bt(t.id)?{type:e,id:t.id}:null}function Ge(t){let e=String(t||"").trim();if(!e.startsWith("/"))return null;let n=(e.slice(1).split(/\s+/).shift()||"").toLowerCase(),s=e.slice(n.length+2).trim()||"o contexto atual",l={review:"Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.",tests:`Proponha e implemente testes para ${s}. Priorize cobertura de comportamento, regressao e caminhos de erro.`,plan:`Crie um plano tecnico objetivo para ${s}. Agrupe por impacto, risco e ordem de execucao.`,explain:`Explique ${s} com foco em arquitetura, fluxo de dados e pontos de manutencao.`,security:`Revise ${s} com foco em riscos de seguranca, entrada nao confiavel, execucao de comandos e exposicao de dados.`,docs:`Gere documentacao pratica para ${s}, incluindo objetivo, uso, limites e exemplos.`,"commit-msg":"Gere uma mensagem de commit convencional para as mudancas atuais, com escopo claro e resumo curto."}[n];return l?{command:n,text:l,displayText:e}:null}function O(t){return String(t??"").replace(/\r?\n/g," ").trim()}function Ve(t){let e=t||{},o=[];o.push("# "+(O(e.title)||"Sessao Devin")),o.push(""),o.push("- Workspace: "+(O(e.workspace)||z())),o.push("- Modelo: "+(O(e.model)||"auto")),o.push("- Agente: "+(O(e.agent)||"auto")),o.push("- Modo: "+(O(e.mode)||"resposta-integrada")),e.createdAt&&o.push("- Criada em: "+new Date(e.createdAt).toISOString()),e.updatedAt&&o.push("- Atualizada em: "+new Date(e.updatedAt).toISOString()),o.push("");let n=Array.isArray(e.messages)?e.messages:[];for(let a of n){let s=String(a&&a.role||"message").toLowerCase();o.push("## "+s.charAt(0).toUpperCase()+s.slice(1)),a&&a.ts&&o.push("_"+new Date(a.ts).toISOString()+"_"),o.push(""),o.push(String(a&&a.text||"").trim()),o.push("")}return o.join(`
`).trim()+`
`}function _(t){return`'${String(t).replace(/'/g,"'\\''")}'`}function Ue(t){return String(t??"").replace(/\u0000/g,"")}function A(t){let e=String(t||"").trim().toLowerCase();return!e||e==="default"||e==="padrao"||e==="padr\xE3o"?"auto":ye(e)?e:"auto"}function R(t){let e=String(t||"").trim().toLowerCase();return!e||e==="default"||e==="padrao"||e==="padr\xE3o"?"auto":we(e)?e:"auto"}function Ke(t){return A(t)}function yt(){return[...de]}function wt(t){try{return ke(t)?JSON.parse(m.readFileSync(t,"utf8")):void 0}catch{return}}function kt(){if(process.platform==="win32"){let t=process.env.APPDATA||d.join(C.homedir(),"AppData","Roaming");return d.join(t,"devin","config.json")}return d.join(C.homedir(),".config","devin","config.json")}function Ce(){let t=wt(kt());return t&&t.agent?Ke(t.agent.model):void 0}function E(){let t=u().get("modeloAtual");return Ke(t??(Ce()||"auto"))}function Ze(){let t=u().get("modeloAtual");return A(t??(Ce()||"auto"))}function B(){return R(u().get("effortAtual")||"auto")}function ee(){return String(u().get("agenteAtual")||"auto")}function pe(){return"resposta-integrada"}function P(){let t=u().get("skillsSelecionadas")||[];return Array.isArray(t)?t.map(String).filter(Boolean):[]}function j(){let t=u().get("toolsSelecionadas")||[];return Array.isArray(t)?t.map(String).filter(Boolean):[]}function w(){return String(u().get("caminhoDevin")||"devin")}function T(){return v()||C.homedir()}function ze(t){try{if(m.existsSync(t))return m.realpathSync.native?m.realpathSync.native(t):m.realpathSync(t)}catch{}return d.resolve(t)}function Ct(t,e){let o=d.relative(t,e);return o===""||!!o&&!o.startsWith("..")&&!d.isAbsolute(o)}function X(t){let e=v();if(!e)return null;let o=ze(e),n=String(t||"").replace(/\\/g,d.sep).trim(),a=d.isAbsolute(n)?d.resolve(n):d.resolve(o,n),s=ze(a);return Ct(o,s)?s:null}function Qe(){return[qe(u().get("gitBashPath")),process.env.GIT_BASH_PATH,"C:\\Program Files\\Git\\bin\\bash.exe","C:\\Program Files\\Git\\usr\\bin\\bash.exe","C:\\Program Files (x86)\\Git\\bin\\bash.exe",d.join(C.homedir(),"AppData","Local","Programs","Git","bin","bash.exe")].filter(Boolean).find(ke)}function St(){return process.platform==="win32"&&u().get("usarGitBashNoWindows",!0)?Qe():process.env.SHELL||void 0}function oe(){let t=[...(u().get("argumentosPadrao")||[]).map(String).filter(Boolean)],e=String(u().get("argumentoModelo")||"").trim(),o=Ze();e&&o&&o!=="auto"&&t.push(e,o);let n=B(),a=ot();return a&&n&&n!=="auto"&&t.push(a,n),t}function q(t){let e=u().get("prefixoPromptPadrao")||"",o=Ze()||E()||"auto",n=B(),a=ee(),s=P(),i=j(),l=[`Workspace VS Code: ${z()}`,v()?`Diretorio raiz: ${v()}`:"Diretorio raiz: nao ha pasta aberta",`Modelo selecionado: ${o}`,n!=="auto"?`Effort selecionado: ${n}`:"",`Agente selecionado: ${a}`,s.length?`Skills disponiveis: ${s.join(", ")}`:"",i.length?`Tools disponiveis: ${i.join(", ")}`:""].filter(Boolean).join(`
`),r=a!=="auto"?`Use o perfil/subagente Devin chamado "${a}" quando aplicavel. Se a CLI nao aceitar selecao direta de agente nesta chamada, trate este agente como persona operacional e siga as instrucoes do respectivo AGENT.md.`:"",p=s.length?`Invoque a skill via tool 'skill' quando aplicavel: ${s.map(x=>`"${x}"`).join(", ")}. Siga as instrucoes do respectivo SKILL.md.`:"",h=i.length?`Use as tools selecionadas quando aplicavel: ${i.map(x=>`"${x}"`).join(", ")}. Siga as instrucoes do respectivo TOOL.md.`:"";return Ue([e,l,r,p,h,t].filter(Boolean).join(`

`))}function Mt(t){let e=_(w()),o=oe().map(_).join(" ");return t?[e,o,"-p","--",_(q(t))].filter(Boolean).join(" "):[e,o].filter(Boolean).join(" ")}function Et(t){return t?String(t).split(/\r?\n/).filter(e=>!/were not migrated because they already exist/i.test(e)).filter(e=>!/migration.*already exist/i.test(e)).join(`
`).trim():""}function Je(t,e,o){let n=Et(e),a=[t||"",n||"",o&&o.message?o.message:""].join(`
`);if(/No active model set in cog manager/i.test(a))return["Modelo Devin nao configurado para esta execucao.","","A extensao tentou enviar o alias selecionado, mas o Devin CLI informou que nao ha modelo ativo no cog manager.","","Acoes recomendadas:",`1. Execute no terminal: devin model set ${E()||"auto"}`,"2. Se houver conflito de migracao de config, mantenha apenas o valor desejado em agent.model no config.json do Devin.","3. No chat, reabra o seletor de modelo e escolha um dos aliases validos: auto, sonnet, opus, swe, gpt."].join(`
`);let s=[];return t&&t.trim()&&s.push(t.trim()),n&&s.push(`STDERR:
${n}`),o&&s.push(`Falha ao executar Devin CLI: ${o.message}`),s.join(`

`)||"Sem saida do Devin CLI."}function At(t){let e=St(),o=c.window.createTerminal({name:u().get("nomeTerminal")||"Devin Cli Chat",cwd:T(),shellPath:e,shellArgs:process.platform==="win32"&&e?["--login","-i"]:void 0});o.show(!0),o.sendText(Mt(t))}function Y(t){return t||"__default__"}function Se(t,e){let o=Y(t);return J.set(o,Object.assign({sessionId:o,cancelRequested:!1,startedAt:Date.now()},e||{})),J.get(o)}function K(t){return J.get(Y(t))}function Me(t){J.delete(Y(t))}function Ye(){return Array.from(J.keys())}function Ee(t){let e=K(t);if(!e)return!1;e.cancelRequested=!0;let o=e.process;if(!o||o.killed)return!1;try{return o.kill(),!0}catch(n){return f(`cancelIntegratedRun erro: ${n&&n.message?n.message:String(n)}`),!1}}function Xe(t,e){return new Promise(o=>{let n=Y(e&&e.sessionId),a=[...oe(),"-p","--",q(t)];f(`runIntegrated: session=${n} ${w()} ${a.slice(0,-1).join(" ")} -- [prompt ${q(t).length} chars]`),f(`  cwd: ${T()}`);let s=!1;function i(l){s||(s=!0,Me(n),o(l))}try{let l=F.execFile(w(),a,{cwd:T(),timeout:Number(u().get("timeoutChatMs")||3e5),maxBuffer:16777216,windowsHide:!0},(r,p,h)=>{let x=K(n);if(x&&x.cancelRequested){i("Execucao cancelada pelo usuario.");return}if(r&&f(`runIntegrated erro: code=${r.code} signal=${r.signal} killed=${r.killed} msg=${r.message}`),h&&h.trim()&&f(`runIntegrated stderr: ${h.slice(0,500)}`),p&&p.trim()&&f(`runIntegrated stdout: ${p.slice(0,200)}...`),r&&process.platform==="win32"){ce(t,r,{sessionId:n}).then(i);return}i(Je(p,h,r))});Se(n,{process:l,mode:"integrated"}),l.on("error",r=>{f(`runIntegrated child error: ${r.message}`);let p=K(n);if(p&&p.cancelRequested){i("Execucao cancelada pelo usuario.");return}process.platform==="win32"?ce(t,r,{sessionId:n}).then(i):i(`Falha ao iniciar Devin CLI: ${r.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)})}catch(l){f(`runIntegrated catch: ${l.message}`);let r=K(n);if(r&&r.cancelRequested){i("Execucao cancelada pelo usuario.");return}process.platform==="win32"?ce(t,l,{sessionId:n}).then(i):i(`Falha ao iniciar Devin CLI: ${l.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)}})}function ce(t,e,o){return new Promise(n=>{let a=Y(o&&o.sessionId),s=Qe();if(!s){n(`Falha ao executar Devin CLI: ${e.message}

Git Bash nao foi encontrado. Configure devinCliChat.gitBashPath ou ajuste devinCliChat.caminhoDevin.`);return}let i=oe().map(_).join(" "),l=`${_(w())} ${i} -p -- ${_(q(t))}`,r=F.exec(l,{cwd:T(),shell:s,timeout:Number(u().get("timeoutChatMs")||3e5),maxBuffer:1024*1024*16},(p,h,x)=>{let S=K(a);if(Me(a),S&&S.cancelRequested){n("Execucao cancelada pelo usuario.");return}let D=Je(h,x,p);n(D.replace("Falha ao executar Devin CLI:","Falha ao executar Devin CLI via Git Bash:"))});Se(a,{process:r,mode:"bash"})})}async function b(t,e){await u().update(t,e,c.ConfigurationTarget.Workspace),M(),ge(),g&&g.refreshMeta()}function Tt(){let t=u().get("modelosDisponiveis")||[];return Array.isArray(t)?t.map(String).map(e=>e.trim()).filter(Boolean):[]}function It(){let t=u().get("arquivosCacheModelos")||[],e=Array.isArray(t)?t.map(y).filter(Boolean):[];if(process.platform==="win32"){let o=process.env.LOCALAPPDATA||d.join(C.homedir(),"AppData","Local");e.push(d.join(o,"Devin","CLI","team_settings.bin")),e.push(d.join(o,"Devin","CLI","model_configs.bin"))}else e.push(d.join(C.homedir(),".local","share","Devin","CLI","team_settings.bin")),e.push(d.join(C.homedir(),".local","share","Devin","CLI","model_configs.bin"));return Array.from(new Set(e))}function me(t){let e=String(t||"").trim().toLowerCase();return!ye(e)||["model","models","use","eg","env","devin_model","default"].includes(e)?!1:/^(auto|sonnet|opus|codex|gpt|claude|o[0-9]|gpt-|claude-|.*[._-].*)/.test(e)}function et(t){let e=[],o=String(t||""),n=o.match(/"([^"]{2,80})"/g)||[];for(let s of n){let i=s.slice(1,-1).trim();me(i)&&e.push(i)}let a=o.match(/[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}/g)||[];for(let s of a)me(s)&&e.push(s);return Array.from(new Set(e.map(A))).filter(Boolean)}function Lt(){let t=u().get("effortsDisponiveis")||[];return Array.isArray(t)?t.map(String).map(e=>e.trim()).filter(Boolean):[]}function Bt(t){let e=String(t||"").trim().toLowerCase();return!we(e)||["effort","reasoning","level","value","default"].includes(e)?!1:He.includes(e)||/^(minimal|none|low|medium|high|xhigh|max|auto)$/.test(e)}function tt(t){let e=String(t||""),o=e.match(/--(?:reasoning[-_]?)?effort\b|--effort\b/i);if(!o)return{flag:"",values:[]};let n=o[0].toLowerCase().replace("_","-"),a=[],s=e.slice(Math.max(0,o.index-250),Math.min(e.length,o.index+700)),i=s.match(/(?:possible values?|values?|op(?:ç|c)(?:ões|oes)?|choices?)\s*[:=]\s*([^\]\)\n.]+)/i);if(i){let r=i[1].match(/[a-zA-Z][a-zA-Z0-9._-]{1,40}/g)||[];a.push(...r)}let l=s.match(/"([^"]{2,40})"|'([^']{2,40})'|`([^`]{2,40})`/g)||[];for(let r of l)a.push(r.slice(1,-1));return a.length||a.push(...He),{flag:n,values:Array.from(new Set(a.map(R).filter(r=>r&&r!=="auto"&&Bt(r))))}}function nt(){return new Promise(t=>{try{F.execFile(w(),["--help"],{cwd:T(),timeout:Number(u().get("timeoutDescobertaModelosMs")||2500),windowsHide:!0},(e,o,n)=>{let a=[o||"",n||""].join(`
`);if(e&&!a.trim()){t({flag:"",values:[]});return}t(tt(a))})}catch{t({flag:"",values:[]})}})}function ot(){let t=String(u().get("argumentoEffort")||"").trim();return t||k.flag||""}function te(){let t=Re(),e=Date.now();if(t>0&&k.values&&e-k.at<t)return k.values;let o=B(),n=Lt().map(R).filter(r=>r&&r!=="auto"),a=(k.values||[]).filter(r=>r!=="auto"),i=!!ot()||n.length?["auto",o,...n,...a]:[],l=Array.from(new Set(i.map(R).filter(Boolean)));return k={...k,at:e,values:l},l}function Pt(){let t=Number(u().get("limiteBytesCacheModelos")||5242880),e=[];for(let o of It())try{if(!ke(o))continue;let n=m.statSync(o);if(!n.isFile()||n.size>t)continue;let s=m.readFileSync(o).toString("utf8");e.push(...et(s))}catch{}return Array.from(new Set(e))}function ne(){return new Promise(t=>{let e=String(u().get("comandoDescobertaModelos")||"").trim(),o=e?e.split(/\s+/):["--help"];try{F.execFile(w(),o,{cwd:T(),timeout:Number(u().get("timeoutDescobertaModelosMs")||2500),windowsHide:!0},(n,a,s)=>{let i=[a||"",s||""].join(`
`);if(n&&!i.trim()){t([]);return}try{let l=JSON.parse(i),r=Array.isArray(l)?l:l&&l.models||[];t(r.map(p=>typeof p=="string"?p:p&&(p.name||p.id)).filter(me).map(A));return}catch{}t(et(i))})}catch{t([])}})}function H(){let t=Re(),e=Date.now();if(t>0&&W.values&&e-W.at<t)return W.values;let o=E(),n=[Ce(),...Tt(),...Pt()].map(A).filter(Boolean).filter(i=>i!=="auto"),a=n.length?["auto",o,...n]:["auto",o,...yt()],s=Array.from(new Set(a.map(A).filter(Boolean)));return W={at:e,values:s},s}function Ae(){let t=Date.now();if(G.values&&t-G.at<be())return G.values;let e=[y(u().get("diretorioAgentesWorkspace")||".devin/agents"),y(u().get("diretorioAgentesGlobal")||"~/.config/devin/agents")],o=["auto"];for(let a of e)try{if(!a||!m.existsSync(a))continue;for(let s of m.readdirSync(a)){let i=d.join(a,s,"AGENT.md");m.existsSync(i)&&o.push(s)}}catch{}let n=Array.from(new Set(o));return G={at:t,values:n},n}function Te(){let t=Date.now();if(U.values&&t-U.at<be())return U.values;let e=[y(u().get("diretorioToolsWorkspace")||".devin/tools"),y(u().get("diretorioToolsGlobal")||"~/.config/devin/tools")],o=[];for(let a of e)try{if(!a||!m.existsSync(a))continue;for(let s of m.readdirSync(a)){let i=d.join(a,s,"TOOL.md");m.existsSync(i)&&o.push(s)}}catch{}let n=Array.from(new Set(o)).sort();return U={at:t,values:n},n}function Ie(){let t=Date.now();if(V.values&&t-V.at<be())return V.values;let e=[y(u().get("diretorioSkillsWorkspace")||".devin/skills"),y(u().get("diretorioSkillsGlobal")||"~/.config/devin/skills"),y(".claude/skills"),y("~/.claude/skills")],o=[];for(let a of e)try{if(!a||!m.existsSync(a))continue;for(let s of m.readdirSync(a)){let i=d.join(a,s,"SKILL.md");m.existsSync(i)&&o.push(s)}}catch{}let n=Array.from(new Set(o)).sort();return V={at:t,values:n},n}function at(t){return d.basename(String(t||""),d.extname(String(t||""))).normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9._-]+/g,"-").replace(/^[._-]+|[._-]+$/g,"").replace(/-{2,}/g,"-")||"skill"}function Ft(){return y(u().get("diretorioSkillsWorkspace")||".devin/skills")}function Dt(){return y(u().get("diretorioAgentesWorkspace")||".devin/agents")}function $t(){return y(u().get("diretorioToolsWorkspace")||".devin/tools")}function Nt(t,e){let o=d.join(t,e),n=2;for(;m.existsSync(o);)o=d.join(t,`${e}-${n}`),n++;return o}function st(t){return Be(t,Ft(),"SKILL.md")}function it(t){return Be(t,Dt(),"AGENT.md")}function Le(t){return Be(t,$t(),"TOOL.md")}function Be(t,e,o){let n=String(t||"");if(!n||d.extname(n).toLowerCase()!==".md")throw new Error("Selecione um arquivo .md para importar.");if(!m.existsSync(n)||!m.statSync(n).isFile())throw new Error("Arquivo markdown nao encontrado: "+n);if(!e)throw new Error("Diretorio padrao nao resolvido.");let a=at(n),s=Nt(e,a),i=d.basename(s);m.mkdirSync(s,{recursive:!0});let l=d.join(s,o);return m.copyFileSync(n,l),M(),{name:i,file:l,dir:s}}function fe(){let t=c.window.activeTextEditor;if(!t)return"Nenhum editor ativo.";let e=t.document,o=t.selection&&!t.selection.isEmpty?e.getText(t.selection):e.getText();return[`Arquivo: ${e.uri.fsPath}`,"Conteudo:","```",o.slice(0,6e4),"```"].join(`
`)}function _e(t){return t?Math.max(1,Math.ceil(String(t).length/4)):0}function zt(t){if(!t||!t.selection||t.selection.isEmpty)return null;let e=t.document,o=t.selection,n=e.getText(o);if(!n||!n.trim())return null;let a=e.uri.fsPath,s=d.basename(a),i=o.start.line+1,l=o.end.line+1;return{id:"sel-"+Date.now().toString(36),file:a,base:s,language:e.languageId,startLine:i,endLine:l,text:n,preview:n.split(`
`).slice(0,2).join(" ").slice(0,80),label:`${s}:${i}-${l}`}}function rt(){try{if(u().get("usarContextoEditorAutomatico")===!1)return null;let e=String(u().get("modoContextoEditorAutomatico")||"selecao-ou-arquivo");if(e==="desativado")return null;let o=c.window.activeTextEditor;if(!o)return null;let n=o.document;if(!n||!n.uri||n.uri.scheme!=="file")return null;let a=n.uri.fsPath,s=d.basename(a),i=n.languageId||d.extname(a).slice(1)||"",l="```",r=o.selection,p=!!(r&&!r.isEmpty);if(e!=="somente-arquivo"&&p){let ie=n.getText(r);if(!ie||!ie.trim())return null;let mt=r.start.line+1,ft=r.end.line+1,$e=`${s}:${mt}-${ft}`,ht=["","",`[Contexto automatico do editor: ${$e}]`,l+i,ie,l].join(`
`);return{label:$e,promptBlock:ht}}if(e==="somente-selecao")return null;let h=n.getText();if(!h||!h.trim())return null;let x=Number(u().get("limiteBytesContextoEditorAutomatico")),S=Number.isFinite(x)&&x>0?x:2e5,D=Buffer.from(h,"utf8"),se=D.length>S,pt=se?D.subarray(0,S).toString("utf8"):h,Fe=se?`${s} (truncado)`:s,De=["","",`[Contexto automatico do editor: ${Fe}]`,l+i,pt,l];return se&&De.push(`[NOTA: arquivo truncado em ${S} bytes para limitar o tamanho do contexto automatico.]`),{label:Fe,promptBlock:De.join(`
`)}}catch{return null}}function he(){try{return F.execFileSync("git",["diff","--no-ext-diff"],{cwd:T(),encoding:"utf8",maxBuffer:1024*1024*8,windowsHide:!0})}catch(t){return`Nao foi possivel obter git diff: ${t.message}`}}function ge(){$||($=c.window.createStatusBarItem(c.StatusBarAlignment.Right,90),$.command="devinCliChat.abrirPainel",$.show());let t=B();$.text=`Devin: ${E()}${t!=="auto"?" / "+t:""} / ${ee()}`,$.tooltip=`Workspace: ${z()} | Modo: ${pe()} | Effort: ${t} | Skills: ${P().length}`}async function Pe(){let t=await c.window.showInputBox({title:"Modelo Devin",prompt:"Informe um modelo aceito pelo seu Devin CLI, por exemplo claude-sonnet-4, claude-opus-4.6, opus ou codex.",value:E()==="auto"?"":E()});if(!t||!t.trim())return;let e=A(t);e!==String(t).trim().toLowerCase()&&c.window.showInformationMessage(`Modelo "${t.trim()}" foi normalizado para "${e}".`),await b("modeloAtual",e)}async function _t(){M();let t=await ne();if(t.length){let o=Array.from(new Set([...u().get("modelosDisponiveis")||[],...t]));await u().update("modelosDisponiveis",o,c.ConfigurationTarget.Workspace),M()}let e=await c.window.showQuickPick([...H(),"+ Informar modelo manual"],{placeHolder:"Selecione o modelo Devin"});if(e){if(e.startsWith("+"))return Pe();await b("modeloAtual",e)}}async function jt(){M();let t=await nt();if(t&&t.flag&&(k={at:Date.now(),values:["auto",...t.values],flag:t.flag},t.values&&t.values.length)){let n=Array.from(new Set([...u().get("effortsDisponiveis")||[],...t.values]));await u().update("effortsDisponiveis",n,c.ConfigurationTarget.Workspace)}let e=te();if(!e.length){c.window.showInformationMessage("Este Devin CLI nao exp\xF5e selecao de Effort na ajuda local.");return}let o=await c.window.showQuickPick(e,{placeHolder:"Selecione o Effort do Devin"});o&&await b("effortAtual",o)}async function Ht(){let t=Ie(),e="+ Importar arquivo .md como skill",o=new Set(P()),n=[{label:e,description:"Copia para o diretorio padrao de skills"},...t.map(i=>({label:i,picked:o.has(i)}))],a=await c.window.showQuickPick(n,{canPickMany:!0,placeHolder:t.length?"Selecione skills disponiveis para o Devin":"Importe um .md ou selecione skills disponiveis"});if(!a)return;let s=a.filter(i=>i.label!==e).map(i=>i.label);if(a.some(i=>i.label===e)){let i=await lt({selectImported:!1});i&&s.push(i.name)}await b("skillsSelecionadas",Array.from(new Set(s)))}async function Rt(){let t=Te(),e="+ Importar arquivo .md como tool",o=new Set(j()),n=[{label:e,description:"Copia para o diretorio padrao de tools"},...t.map(i=>({label:i,picked:o.has(i)}))],a=await c.window.showQuickPick(n,{canPickMany:!0,placeHolder:t.length?"Selecione tools disponiveis para o Devin":"Importe um .md ou selecione tools disponiveis"});if(!a)return;let s=a.filter(i=>i.label!==e).map(i=>i.label);if(a.some(i=>i.label===e)){let i=await ae({kind:"tool",importer:Le,configKey:"toolsSelecionadas",selectImported:!1});i&&s.push(i.name)}await b("toolsSelecionadas",Array.from(new Set(s)))}async function lt(t){return ae({kind:"skill",importer:st,configKey:"skillsSelecionadas",selectImported:!t||t.selectImported!==!1})}async function ct(t){return await ae({kind:"agente",importer:it,configKey:"agenteAtual",singleValue:!0,selectImported:!t||t.selectImported!==!1})}async function qt(t){return ae({kind:"tool",importer:Le,configKey:"toolsSelecionadas",selectImported:!t||t.selectImported!==!1})}async function ae(t){let e=await c.window.showOpenDialog({canSelectFiles:!0,canSelectFolders:!1,canSelectMany:!1,filters:{Markdown:["md"]},title:"Importar arquivo Markdown como "+t.kind+" Devin"});if(!e||!e.length)return null;try{let o=t.importer(e[0].fsPath);if(t.selectImported!==!1)if(t.singleValue)await b(t.configKey,o.name);else{let n=new Set(t.configKey==="toolsSelecionadas"?j():P());n.add(o.name),await b(t.configKey,Array.from(n))}return g&&g.refreshMeta(),c.window.showInformationMessage(`${t.kind} "${o.name}" importado para ${o.file}.`),o}catch(o){return c.window.showErrorMessage("Falha ao importar "+t.kind+": "+(o&&o.message?o.message:String(o))),null}}function L(){try{return Q&&Q.globalState.get(xe)||[]}catch{return[]}}async function Z(t){try{Q&&await Q.globalState.update(xe,t.slice(0,vt))}catch{}}function dt(t){try{if(!t||!t.globalState||t.globalState.get(ue))return!1;let e=t.globalState.get(xe)||[];return!Array.isArray(e)||e.length===0}catch{return!1}}async function ut(t){if(!dt(t))return!1;try{return await c.workspace.getConfiguration("workbench").update("sideBar.location","right",c.ConfigurationTarget.Global),await t.globalState.update(ue,!0),f("Primeira instalacao: sideBar.location definido como right."),!0}catch(e){f("Falha ao posicionar sidebar a direita: "+(e&&e.message?e.message:String(e)));try{await t.globalState.update(ue,!0)}catch{}return!1}}var ve=class{constructor(e){this.context=e,this.view=void 0,this.busy=!1,this.session=this.newSession()}newSession(){return{id:"sess-"+Date.now().toString(36)+"-"+Math.random().toString(36).slice(2,6),title:"Nova conversa",createdAt:Date.now(),updatedAt:Date.now(),workspace:z(),model:E(),effort:B(),agent:ee(),mode:pe(),skills:P(),tools:j(),messages:[]}}async persistSession(){if(!this.session||!this.session.messages.length)return;let e=L(),o=e.findIndex(n=>n.id===this.session.id);if(this.session.updatedAt=Date.now(),!this.session.title||this.session.title==="Nova conversa"){let n=this.session.messages.find(a=>a.role==="user");n&&(this.session.title=String(n.text).slice(0,60).replace(/\s+/g," ").trim())}o>=0?e[o]=this.session:e.unshift(this.session),e.sort((n,a)=>(a.updatedAt||0)-(n.updatedAt||0)),await Z(e)}resolveWebviewView(e){this.view=e,e.webview.options={enableScripts:!0,localResourceRoots:[this.context.extensionUri]},e.webview.html=this.html(e.webview),f("WebView resolvida e HTML injetado."),e.webview.onDidReceiveMessage(async o=>{try{let n=We(o);if(!n){f("Mensagem webview rejeitada por validacao.");return}let a=n.type;if(f(`Mensagem recebida do webview: type=${a}`),a==="ready"){this.refreshMeta(),this.replaySession(),this.pushCurrentSelection();return}if(a==="clientError"){f(`ERRO no cliente webview: ${n.text||"sem detalhes"}`),this.post({type:"message",role:"assistant",text:"Falha no painel: "+(n.text||"erro sem detalhes")});return}if(a==="cancelRun"){let s=Ee(this.session&&this.session.id);this.post({type:"action",ok:s,text:s?"Cancelamento solicitado.":"Nenhuma execucao integrada ativa para cancelar."});return}if(a==="verifyCli"){this.verifyCli();return}if(a==="requestSelection"){this.pushCurrentSelection(!0);return}if(a==="attachMenu"){await this.chooseAttachSource();return}if(a==="attachFiles"){await this.attachFiles();return}if(a==="pickWorkspaceFiles"){await this.pickWorkspaceFiles();return}if(a==="listWorkspace"){this.listWorkspaceDir(n.path||"");return}if(a==="attachFolder"){await this.attachFolder(n.path||"");return}if(a==="attachWorkspacePath"){await this.attachWorkspacePath(n.path||"");return}if(a==="searchWorkspaceFiles"){await this.searchWorkspaceFiles(n.query||"");return}if(a==="send"){await this.send(n.text||"",{echoUser:n.echo!==!1,displayText:n.displayText||n.text||"",hasExplicitContext:!!n.hasExplicitContext});return}if(a==="setModel"){await b("modeloAtual",A(n.value||"auto"));return}if(a==="setEffort"){await b("effortAtual",R(n.value||"auto"));return}if(a==="setAgent"){await b("agenteAtual",n.value||"auto");return}if(a==="importAgentFile"){let s=await ct();s&&this.post({type:"action",ok:!0,text:"Agente importado: "+s.name});return}if(a==="importSkillFile"){let s=await lt();s&&this.post({type:"action",ok:!0,text:"Skill importada: "+s.name});return}if(a==="importToolFile"){let s=await qt();s&&this.post({type:"action",ok:!0,text:"Tool importada: "+s.name});return}if(a==="toggleSkill"){let s=new Set(P());n.value&&s.has(n.value)?s.delete(n.value):n.value&&s.add(n.value),await b("skillsSelecionadas",Array.from(s));return}if(a==="toggleTool"){let s=new Set(j());n.value&&s.has(n.value)?s.delete(n.value):n.value&&s.add(n.value),await b("toolsSelecionadas",Array.from(s));return}if(a==="manualModel"){await Pe();return}if(a==="refreshModels"){this.refreshMeta();let s=await ne();if(s.length){let i=Array.from(new Set([...u().get("modelosDisponiveis")||[],...s]));await u().update("modelosDisponiveis",i,c.ConfigurationTarget.Workspace)}this.refreshMeta(),this.post({type:"action",ok:!0,text:"Modelos atualizados ("+H().length+" disponiveis)."});return}if(a==="review"){await this.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+he()+"\n```",{echoUser:!0});return}if(a==="selection"){await this.send(`Analise o contexto do editor atual.

`+fe(),{echoUser:!0});return}if(a==="insertSelection"){this.post({type:"insertPrompt",text:`Analise o contexto do editor atual.

`+fe()});return}if(a==="newChat"){await this.persistSession(),this.session=this.newSession(),this.post({type:"clearThread"}),this.refreshMeta();return}if(a==="getHistory"){await this.openHistory();return}if(a==="exportSession"){await this.exportSession(n.id);return}if(a==="loadSession"){await this.persistSession();let i=L().find(l=>l.id===n.id);i&&(this.session=JSON.parse(JSON.stringify(i)),this.post({type:"clearThread"}),this.replaySession(),this.refreshMeta(),this.post({type:"action",ok:!0,text:"Sessao carregada: "+(i.title||i.id)}));return}if(a==="deleteSession"){let s=L().filter(i=>i.id!==n.id);await Z(s),this.session&&this.session.id===n.id&&(this.session=this.newSession(),this.post({type:"clearThread"})),this.post({type:"history",sessions:s}),this.refreshMeta();return}if(a==="clearHistory"){await Z([]),this.session=this.newSession(),this.post({type:"clearThread"}),this.post({type:"history",sessions:[]}),this.refreshMeta();return}this.post({type:"action",ok:!1,text:`Acao desconhecida: ${a}`})}catch(n){this.busy=!1,this.post({type:"busy",value:!1}),f(`ERRO no handler do webview: ${n&&n.message?n.message:String(n)}`),n&&n.stack&&f(n.stack),this.post({type:"message",role:"assistant",text:"Falha ao executar acao do painel: "+(n&&n.message?n.message:String(n))})}}),setTimeout(()=>this.refreshMeta(),50)}post(e){try{this.view&&this.view.webview.postMessage(e)}catch{}}async openHistory(){await this.persistSession();let e=L().filter(o=>o&&o.messages&&o.messages.length);this.post({type:"openHistory",sessions:e}),this.refreshMeta()}async exportSession(e){await this.persistSession();let o=L(),a=(e?o.find(i=>i.id===e):null)||this.session;if(!a||!a.messages||!a.messages.length){let i="Nao ha conversa com mensagens para exportar.";this.post({type:"action",ok:!1,text:i}),c.window.showInformationMessage(i);return}await c.env.clipboard.writeText(Ve(a));let s="Conversa exportada em Markdown para a area de transferencia.";this.post({type:"action",ok:!0,text:s}),c.window.showInformationMessage(s)}verifyCli(){N.show(!0),f(`Verificando Devin CLI pelo painel: ${w()}`),F.execFile(w(),["--version"],{cwd:T(),windowsHide:!0},(e,o,n)=>{if(e){let i=`Falha ao verificar Devin CLI: ${e.message}`;f(i),this.post({type:"message",role:"assistant",text:i}),this.post({type:"action",ok:!1,text:i});return}let s=`Devin CLI encontrado: ${(o||n||"ok").trim()}`;f(s),this.post({type:"message",role:"assistant",text:s}),this.post({type:"action",ok:!0,text:s})})}pushCurrentSelection(e){let o=c.window.activeTextEditor,n=zt(o);n&&this.post({type:"selectionAvailable",selection:n})}attachmentId(e){return e+"-"+Date.now().toString(36)+Math.random().toString(36).slice(2,7)}readFileItem(e,o){let n=m.statSync(e);if(n.size>re)return{skipped:!0,reason:`Arquivo muito grande: ${d.basename(e)} (${n.size} bytes).`};let a=m.readFileSync(e,"utf8"),s=d.extname(e).slice(1);return{id:this.attachmentId("file"),file:e,base:d.basename(e),label:o||d.basename(e),type:"file",text:a,language:s,lines:a.split(`
`).length}}readFolderItem(e,o){let n=v(),a=o||d.basename(e)||"workspace",s=[],i=[e];for(;i.length&&s.length<le;){let l=i.pop(),r;try{r=m.readdirSync(l,{withFileTypes:!0})}catch{continue}for(let p of r){let h=d.join(l,p.name);if(p.isDirectory())!xt.has(p.name)&&!p.name.startsWith(".")&&i.push(h);else if(p.isFile())try{if(m.statSync(h).size>re)continue;let S=m.readFileSync(h,"utf8"),D=n&&h.startsWith(n)?d.relative(n,h):d.join(a,d.relative(e,h));if(s.push({file:h,rel:D.replace(/\\/g,"/"),base:d.basename(h),text:S,language:d.extname(h).slice(1),lines:S.split(`
`).length}),s.length>=le)break}catch{}}}return{id:this.attachmentId("folder"),file:e,base:a,label:`${a} (${s.length})`,type:"folder",files:s,count:s.length,truncated:s.length>=le}}async chooseAttachSource(){let e=await c.window.showQuickPick([{label:"$(folder) Pastas",description:"Anexar pasta recursivamente como chip unico",value:"folders"},{label:"$(file) Arquivos abertos",description:"Anexar arquivos atualmente abertos no editor",value:"openFiles"}],{placeHolder:"Anexar contexto ao Devin"});if(!e)return;if(e.value==="folders"){let l=await c.window.showOpenDialog({canSelectMany:!0,canSelectFiles:!1,canSelectFolders:!0,defaultUri:v()?c.Uri.file(v()):void 0,openLabel:"Anexar pasta"});if(!l||!l.length)return;let r=[];for(let p of l)try{let h=this.readFolderItem(p.fsPath,d.basename(p.fsPath));h.files&&h.files.length&&r.push(h)}catch(h){this.post({type:"action",ok:!1,text:`Falha ao anexar pasta ${p.fsPath}: ${h.message}`})}r.length&&this.post({type:"attachItems",items:r}),this.post({type:"action",ok:!0,text:`Anexadas ${r.length} pasta(s).`});return}let o=c.workspace.textDocuments.filter(l=>l.uri&&l.uri.scheme==="file"&&!l.isUntitled);if(!o.length){this.post({type:"action",ok:!1,text:"Nenhum arquivo aberto para anexar."});return}let n=v()||"",a=o.map(l=>({label:"$(file) "+d.basename(l.uri.fsPath),description:n?d.dirname(d.relative(n,l.uri.fsPath)):d.dirname(l.uri.fsPath),detail:l.uri.fsPath,doc:l})),s=await c.window.showQuickPick(a,{canPickMany:!0,placeHolder:"Selecione arquivos abertos para anexar"});if(!s||!s.length)return;let i=[];for(let l of s){let r=l.doc,p=r.getText();if(Buffer.byteLength(p,"utf8")>re){this.post({type:"action",ok:!1,text:`Arquivo muito grande: ${d.basename(r.uri.fsPath)}.`});continue}i.push({id:this.attachmentId("file"),file:r.uri.fsPath,base:d.basename(r.uri.fsPath),label:d.basename(r.uri.fsPath),type:"file",text:p,language:r.languageId||d.extname(r.uri.fsPath).slice(1),lines:p.split(`
`).length})}i.length&&this.post({type:"attachItems",items:i})}async attachFiles(){try{let e=await c.window.showOpenDialog({canSelectMany:!0,canSelectFiles:!0,canSelectFolders:!1,defaultUri:v()?c.Uri.file(v()):void 0,openLabel:"Anexar ao chat"});if(!e||!e.length)return;let o=[];for(let n of e)try{let a=m.statSync(n.fsPath);if(a.size>1024*1024){o.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:n.fsPath,base:d.basename(n.fsPath),label:d.basename(n.fsPath),type:"file",text:`Arquivo ${n.fsPath} muito grande (${a.size} bytes) - nao anexado.`,language:"",tooBig:!0});continue}let s=m.readFileSync(n.fsPath,"utf8"),i=d.extname(n.fsPath).slice(1);o.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:n.fsPath,base:d.basename(n.fsPath),label:d.basename(n.fsPath),type:"file",text:s,language:i,lines:s.split(`
`).length})}catch(a){this.post({type:"action",ok:!1,text:`Falha ao ler ${n.fsPath}: ${a.message}`})}o.length&&this.post({type:"attachItems",items:o})}catch(e){this.post({type:"action",ok:!1,text:"Falha ao anexar: "+(e&&e.message?e.message:String(e))})}}async pickWorkspaceFiles(){try{let e=await c.workspace.findFiles("**/*","**/{node_modules,.git,dist,build,out,.venv,__pycache__}/**",5e3);if(!e.length){this.post({type:"action",ok:!1,text:"Nenhum arquivo encontrado."});return}let o=v()||"",n=e.map(i=>({label:d.relative(o,i.fsPath)||d.basename(i.fsPath),description:"",uri:i})),a=await c.window.showQuickPick(n,{placeHolder:"Selecione arquivos do workspace para anexar",canPickMany:!0,matchOnDescription:!0});if(!a||!a.length)return;let s=[];for(let i of a)try{if(m.statSync(i.uri.fsPath).size>1024*1024)continue;let r=m.readFileSync(i.uri.fsPath,"utf8"),p=d.extname(i.uri.fsPath).slice(1);s.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:i.uri.fsPath,base:d.basename(i.uri.fsPath),label:d.basename(i.uri.fsPath),type:"file",text:r,language:p})}catch{}s.length&&this.post({type:"attachItems",items:s})}catch(e){this.post({type:"action",ok:!1,text:"Falha: "+(e&&e.message?e.message:String(e))})}}listWorkspaceDir(e){try{let o=v();if(!o){this.post({type:"workspaceList",path:e||"",entries:[],error:"Sem workspace aberto."});return}let n=X(e||"");if(!n){this.post({type:"workspaceList",path:"",entries:[],error:"Diretorio fora do workspace."});return}if(!m.existsSync(n)||!m.statSync(n).isDirectory()){this.post({type:"workspaceList",path:"",entries:[],error:"Diretorio invalido."});return}let a=d.relative(o,n).replace(/\\/g,"/"),s=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),i=m.readdirSync(n,{withFileTypes:!0}).filter(l=>!l.name.startsWith(".")||[".cognition",".devin",".claude",".cursor",".vscode"].includes(l.name)).filter(l=>!(l.isDirectory()&&s.has(l.name))).map(l=>{let r=0;try{l.isFile()&&(r=m.statSync(d.join(n,l.name)).size)}catch{}return{name:l.name,isDir:l.isDirectory(),size:r}}).sort((l,r)=>r.isDir-l.isDir||l.name.localeCompare(r.name));this.post({type:"workspaceList",path:a,entries:i})}catch(o){this.post({type:"workspaceList",path:"",entries:[],error:o.message})}}async attachWorkspacePath(e){if(!v())return;let n=X(e||"");if(!n){this.post({type:"action",ok:!1,text:"Caminho fora do workspace."});return}if(!m.existsSync(n)){this.post({type:"action",ok:!1,text:"Caminho invalido."});return}if(m.statSync(n).isDirectory()){await this.attachFolder(e);return}try{let a=m.statSync(n);if(a.size>1024*1024){this.post({type:"action",ok:!1,text:`Arquivo muito grande: ${d.basename(n)} (${a.size} bytes).`});return}let s=m.readFileSync(n,"utf8"),i=d.extname(n).slice(1);this.post({type:"attachItems",items:[{id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:n,base:d.basename(n),label:d.basename(n),type:"file",text:s,language:i}]})}catch(a){this.post({type:"action",ok:!1,text:"Falha: "+a.message})}}async searchWorkspaceFiles(e){try{let o=v();if(!o){this.post({type:"workspaceFileSuggestions",query:e,files:[]});return}let n=String(e||"").toLowerCase(),s=(await c.workspace.findFiles("**/*","**/{node_modules,.git,dist,build,out,.venv,__pycache__,.next,.nuxt,.cache,target,.idea}/**",1e3)).map(i=>{let l=d.relative(o,i.fsPath).replace(/\\/g,"/");return{label:l,path:l,base:d.basename(i.fsPath)}}).filter(i=>!n||i.label.toLowerCase().includes(n)||i.base.toLowerCase().includes(n)).slice(0,20);this.post({type:"workspaceFileSuggestions",query:e,files:s})}catch(o){this.post({type:"workspaceFileSuggestions",query:e,files:[],error:o&&o.message?o.message:String(o)})}}async attachFolder(e){let o=v();if(!o)return;let n=X(e||"");if(!n){this.post({type:"action",ok:!1,text:"Pasta fora do workspace."});return}let a=d.relative(o,n).replace(/\\/g,"/");if(!m.existsSync(n)||!m.statSync(n).isDirectory()){this.post({type:"action",ok:!1,text:"Pasta invalida."});return}let s=this.readFolderItem(n,a?d.basename(n):z());s.files&&s.files.length&&this.post({type:"attachItems",items:[s]}),this.post({type:"action",ok:!0,text:`Pasta anexada como chip unico: ${s.label}.`})}replaySession(){if(!(!this.session||!this.session.messages.length))for(let e of this.session.messages)this.post({type:"message",role:e.role,text:e.text,replay:!0})}refreshMeta(){let e={type:"meta",models:de,model:E(),efforts:[],effort:B(),agents:["auto"],agent:ee(),skills:[],selectedSkills:P(),selectedTools:j(),mode:pe(),workspace:z(),sessionId:this.session&&this.session.id,sessionTitle:this.session&&this.session.title,modelLocked:!1,hasMessages:!!(this.session&&this.session.messages&&this.session.messages.length),tokensTotal:this.session&&this.session.tokens||0,tokensIn:this.session&&this.session.tokensIn||0,tokensOut:this.session&&this.session.tokensOut||0,modelStatus:"modelo: auto"};try{e.models=H()}catch{e.models=de}try{e.efforts=te()}catch{e.efforts=[]}try{e.agents=Ae()}catch{e.agents=["auto"]}try{e.skills=Ie()}catch{e.skills=[]}try{e.tools=Te()}catch{e.tools=[]}try{e.recentSessions=L().slice(0,3).map(o=>({id:o.id,title:o.title||"Sem titulo",updatedAt:o.updatedAt,messages:(o.messages||[]).length,model:o.model||"auto"}))}catch{e.recentSessions=[]}try{e.modelStatus=`${e.models.length} modelos | ${e.efforts.length?e.efforts.length+" efforts | ":""}${e.skills.length} skills | ${e.tools.length} tools`}catch{}this.post(e),this.refreshModelsFromCliInBackground(),this.refreshEffortsFromCliInBackground()}refreshModelsFromCliInBackground(){u().get("descobrirModelosAutomaticamente",!0)&&(this.refreshingModels||(this.refreshingModels=!0,ne().then(async e=>{if(e&&e.length){let o=Array.from(new Set([...u().get("modelosDisponiveis")||[],...e]));await u().update("modelosDisponiveis",o,c.ConfigurationTarget.Workspace),M();let n=H();this.post({type:"meta",models:n,model:E(),modelStatus:`${n.length} modelos do Devin CLI`})}}).catch(e=>{f("Falha ao descobrir modelos em background: "+(e&&e.message?e.message:String(e)))}).finally(()=>{this.refreshingModels=!1})))}refreshEffortsFromCliInBackground(){u().get("descobrirModelosAutomaticamente",!0)&&(this.refreshingEfforts||(this.refreshingEfforts=!0,nt().then(async e=>{if(e&&e.flag){if(k={at:Date.now(),values:["auto",...e.values],flag:e.flag},e.values&&e.values.length){let o=Array.from(new Set([...u().get("effortsDisponiveis")||[],...e.values]));await u().update("effortsDisponiveis",o,c.ConfigurationTarget.Workspace)}this.post({type:"meta",efforts:te(),effort:B()})}}).catch(e=>{f("Falha ao descobrir efforts em background: "+(e&&e.message?e.message:String(e)))}).finally(()=>{this.refreshingEfforts=!1})))}async send(e,o){let n=String(e||"").trim();if(!n)return;let a=String(o&&o.displayText?o.displayText:n).trim(),s=Ge(n);s&&(n=s.text,s.command==="review"&&(n=n+"\n\n```diff\n"+he()+"\n```"),a=s.displayText||a);let i=null;if(!o||!o.hasExplicitContext){let r=rt();r&&r.promptBlock&&(n=n+r.promptBlock,a=a+`

[Contexto automatico: `+r.label+"]",i=r.label)}if(this.busy){this.post({type:"message",role:"assistant",text:"Ja existe uma execucao em andamento. A concorrencia permanece controlada no backend."});return}this.busy=!0;let l=_e(q(n));this.session.tokensIn=(this.session.tokensIn||0)+l,this.session.tokens=(this.session.tokens||0)+l,(!o||o.echoUser!==!1)&&this.post({type:"message",role:"user",text:a}),this.session.messages.push({role:"user",text:a,fullText:n,ts:Date.now(),tokens:l}),this.post({type:"busy",value:!0}),i&&this.post({type:"ctxHint",text:"\u{1F4C4} Contexto automatico: "+i}),this.post({type:"action",ok:!0,text:"Enviando para o Devin CLI..."}),this.refreshMeta();try{f(`send: modo=resposta-integrada prompt=${n.length} chars`);let r=await Xe(n,{sessionId:this.session.id});f(`send: resposta recebida (${r?r.length:0} chars)`);let p=_e(r);this.session.tokensOut=(this.session.tokensOut||0)+p,this.session.tokens=(this.session.tokens||0)+p,this.post({type:"message",role:"assistant",text:r}),this.session.messages.push({role:"assistant",text:r,ts:Date.now(),tokens:p})}catch(r){f(`send ERRO: ${r&&r.message?r.message:String(r)}`);let p="Falha ao enviar para o Devin CLI: "+(r&&r.message?r.message:String(r));this.post({type:"message",role:"assistant",text:p}),this.session.messages.push({role:"assistant",text:p,ts:Date.now()})}finally{this.busy=!1,this.post({type:"busy",value:!1}),await this.persistSession(),this.refreshMeta()}}html(e){let o=Oe(),n={history:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M8 4.5V8l2.4 1.6"/></svg>',plus:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M8 3v10M3 8h10"/></svg>',refresh:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M13 8a5 5 0 1 1-1.5-3.55"/><path d="M13 3v3h-3"/></svg>',terminal:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="12" height="10" rx="1.5"/><path d="M5 7l2 1.5L5 10M8.5 10.5h3"/></svg>',lock:'<svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="7" width="9" height="6.5" rx="1"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2"/></svg>',paperclip:'<svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M11.5 6.5L6.8 11.2a2 2 0 0 1-2.8-2.8l5.4-5.4a3 3 0 0 1 4.2 4.2l-5.4 5.4a4 4 0 0 1-5.7-5.7L7.5 2.5"/></svg>',attach:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M11.5 6.5L6.8 11.2a2 2 0 0 1-2.8-2.8l5.4-5.4a3 3 0 0 1 4.2 4.2l-5.4 5.4a4 4 0 0 1-5.7-5.7L7.5 2.5"/></svg>',file:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3 1.5h6.5L13 5v9.5H3z"/><path d="M9.5 1.5V5H13"/></svg>',folder:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4.5a1 1 0 0 1 1-1h3l1.5 1.5h5.5a1 1 0 0 1 1 1V12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1z"/></svg>',close:'<svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M4 4l8 8M12 4l-8 8"/></svg>',send:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><path d="M2 13.5L14 8 2 2.5 2 7l8 1-8 1z"/></svg>',brain:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M5.5 3a2 2 0 0 0-2 2 2 2 0 0 0-1 3.5 2 2 0 0 0 1.5 3 2 2 0 0 0 3.5 0V3.5A1.5 1.5 0 0 0 5.5 3z"/><path d="M10.5 3a2 2 0 0 1 2 2 2 2 0 0 1 1 3.5 2 2 0 0 1-1.5 3 2 2 0 0 1-3.5 0V3.5A1.5 1.5 0 0 1 10.5 3z"/></svg>',gauge:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11a5.5 5.5 0 1 1 10 0"/><path d="M8 8l3-3"/><path d="M5 12h6"/></svg>',bot:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5.5" width="10" height="7" rx="1.5"/><path d="M8 3v2.5M5.5 8.5h.01M10.5 8.5h.01M2 9.5v1.5M14 9.5v1.5"/></svg>',mode:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M2 5.5h12M2 8h8M2 10.5h10"/></svg>',sparkle:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><path d="M8 2l1.2 3.4L12.5 6.5 9.2 7.6 8 11l-1.2-3.4L3.5 6.5 6.8 5.4z"/></svg>',wrench:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.45" stroke-linecap="round" stroke-linejoin="round"><path d="M10.8 2.2a3.2 3.2 0 0 0-3.7 4.1L2.6 10.8a1.7 1.7 0 0 0 2.4 2.4l4.5-4.5a3.2 3.2 0 0 0 4.1-3.7l-2.2 2.2-2.1-.5-.5-2.1z"/></svg>',caret:'<svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor"><path d="M5 3l6 5-6 5z"/></svg>'};return`<!doctype html><html lang="pt-BR"><head><meta charset="UTF-8"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src ${e.cspSource} data:; style-src 'unsafe-inline' ${e.cspSource}; script-src 'nonce-${o}';"><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>
...
</script></body></html>`}};async function Ot(t){Q=t,N=c.window.createOutputChannel("Devin Cli Chat"),t.subscriptions.push(N),f(`Extens\xE3o ativando \u2014 VS Code ${c.version}, extens\xE3o ${t.extension.packageJSON.version}`),f(`Plataforma: ${process.platform} ${process.arch}`),f(`Devin CLI path configurado: ${w()}`),f(`Workspace: ${v()||"nenhum"}`),await ut(t),g=new ve(t),t.subscriptions.push(c.window.registerWebviewViewProvider("devinCliChat.chatView",g,{webviewOptions:{retainContextWhenHidden:!0}})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirPainel",async()=>c.commands.executeCommand("workbench.view.extension.devinCliChat"))),t.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirHistorico",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),setTimeout(()=>{g&&g.openHistory()},100)})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.exportarSessaoAtual",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.exportSession()})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.novaSessao",()=>At(""))),t.subscriptions.push(c.commands.registerCommand("devinCliChat.revisarDiff",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+he()+"\n```")})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.enviarSelecao",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),g&&await g.send(`Analise o contexto do editor atual.

`+fe())})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarModelo",_t)),t.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarEffort",jt)),t.subscriptions.push(c.commands.registerCommand("devinCliChat.definirModeloManual",Pe)),t.subscriptions.push(c.commands.registerCommand("devinCliChat.atualizarModelos",async()=>{M(),g&&g.refreshMeta();let n=await ne();if(n.length){let a=Array.from(new Set([...u().get("modelosDisponiveis")||[],...n]));await u().update("modelosDisponiveis",a,c.ConfigurationTarget.Workspace),M()}g&&g.refreshMeta(),c.window.showInformationMessage(`Modelos atualizados (${H().length} disponiveis).`)})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarAgente",async()=>{let n="+ Importar arquivo .md como agente",a=await c.window.showQuickPick([n,...Ae()],{placeHolder:"Selecione o agente Devin"});if(a){if(a===n){await ct();return}await b("agenteAtual",a)}})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarSkills",Ht)),t.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarTools",Rt)),t.subscriptions.push(c.commands.registerCommand("devinCliChat.limparHistorico",async()=>{await c.window.showWarningMessage("Limpar todo o historico de chats?",{modal:!0},"Limpar")==="Limpar"&&(await Z([]),g&&g.post({type:"history",sessions:[]}))})),t.subscriptions.push(c.commands.registerCommand("devinCliChat.verificarCli",()=>{N.show(!0),f(`Verificando Devin CLI: ${w()}`),F.execFile(w(),["--version"],{cwd:T(),windowsHide:!0},(n,a,s)=>{if(n)f(`verificarCli ERRO: code=${n.code} msg=${n.message}`),c.window.showErrorMessage(`Falha ao verificar Devin CLI: ${n.message}`);else{let i=(a||s||"ok").trim();f(`verificarCli OK: ${i}`),c.window.showInformationMessage(`Devin CLI encontrado: ${i}`)}})}));let e,o=()=>{e&&clearTimeout(e),e=setTimeout(()=>{g&&g.pushCurrentSelection(!0)},150)};t.subscriptions.push(c.window.onDidChangeTextEditorSelection(o)),t.subscriptions.push(c.window.onDidChangeActiveTextEditor(o)),t.subscriptions.push(c.workspace.onDidChangeConfiguration(n=>{n.affectsConfiguration(je)&&(M(),ge(),g&&g.refreshMeta())})),ge()}function Wt(){for(let t of Ye())Ee(t)}module.exports={activate:Ot,deactivate:Wt,_internal:{baseArgs:oe,fullPrompt:q,runIntegrated:Xe,modelsForUi:H,effortsForUi:te,parseEffortSpecFromText:tt,scanAgents:Ae,scanSkills:Ie,scanTools:Te,skillNameFromMarkdownFile:at,importSkillMarkdownFile:st,importAgentMarkdownFile:it,importToolMarkdownFile:Le,loadHistory:L,saveHistory:Z,sanitizeModel:A,sanitizeEffort:R,sanitizePromptText:Ue,isSafeModelId:ye,isSafeEffortId:we,cancelIntegratedRun:Ee,automaticEditorContext:rt,resolveWorkspacePathSafe:X,registerRunState:Se,unregisterRunState:Me,activeRunIds:Ye,createNonce:Oe,validateWebviewMessage:We,expandSlashCommand:Ge,exportSessionMarkdown:Ve,shouldApplyFirstInstallRightSidebar:dt,applyFirstInstallRightSidebar:ut}};
