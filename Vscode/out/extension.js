"use strict";var c=require("vscode"),u=require("fs"),l=require("path"),b=require("os"),D=require("child_process"),ye="devinCliChat",_e=["auto","sonnet","opus","swe","gpt"],te=["auto","adaptive","sonnet","opus","swe","gpt","codex"],we="devinCliChat.chatHistory.v1",je=50,X=1024*1024,Y=50,Re=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),v,A,R,T,O=new Map,N={at:0,values:void 0},F={at:0,values:void 0},z={at:0,values:void 0};function f(n){let t=new Date().toISOString();T&&T.appendLine(`[${t}] ${n}`)}function ke(){return 1e4}function Oe(){return Math.max(0,Number(m().get("cacheModelosMs")||18e5))}function G(){N={at:0,values:void 0},F={at:0,values:void 0},z={at:0,values:void 0}}function Ce(n){return/^[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}$/.test(String(n||"").trim())}function m(){return c.workspace.getConfiguration(ye)}function g(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].uri.fsPath:void 0}function H(){return c.workspace.workspaceFolders&&c.workspace.workspaceFolders[0]?c.workspace.workspaceFolders[0].name:"sem pasta aberta"}function Se(n){if(!n)return n;let t=String(n);return t==="~"?b.homedir():t.startsWith("~/")||t.startsWith("~\\")?l.join(b.homedir(),t.slice(2)):t}function M(n){let t=Se(n);return t&&(l.isAbsolute(t)?t:l.join(g()||b.homedir(),t))}function se(n){try{return!!n&&u.existsSync(n)}catch{return!1}}function L(n){return`'${String(n).replace(/'/g,"'\\''")}'`}function $(n){let t=String(n||"").trim().toLowerCase();return!t||t==="default"||t==="padrao"||t==="padr\xE3o"?"auto":Ce(t)?t:"auto"}function Me(n){return $(n)}function ge(){return[...te]}function We(n){try{return se(n)?JSON.parse(u.readFileSync(n,"utf8")):void 0}catch{return}}function qe(){if(process.platform==="win32"){let n=process.env.APPDATA||l.join(b.homedir(),"AppData","Roaming");return l.join(n,"devin","config.json")}return l.join(b.homedir(),".config","devin","config.json")}function re(){let n=We(qe());return n&&n.agent?Me(n.agent.model):void 0}function C(){let n=m().get("modeloAtual");return Me(n??(re()||"auto"))}function Ee(){let n=m().get("modeloAtual");return $(n??(re()||"auto"))}function J(){return String(m().get("agenteAtual")||"auto")}function V(){return String(m().get("modoExecucaoChat")||"resposta-integrada")}function P(){let n=m().get("skillsSelecionadas")||[];return Array.isArray(n)?n.map(String).filter(Boolean):[]}function y(){return String(m().get("caminhoDevin")||"devin")}function S(){return g()||b.homedir()}function xe(n){try{if(u.existsSync(n))return u.realpathSync.native?u.realpathSync.native(n):u.realpathSync(n)}catch{}return l.resolve(n)}function Ge(n,t){let a=l.relative(n,t);return a===""||!!a&&!a.startsWith("..")&&!l.isAbsolute(a)}function U(n){let t=g();if(!t)return null;let a=xe(t),e=String(n||"").replace(/\\/g,l.sep).trim(),o=l.isAbsolute(e)?l.resolve(e):l.resolve(a,e),i=xe(o);return Ge(a,i)?i:null}function Ae(){return[Se(m().get("gitBashPath")),process.env.GIT_BASH_PATH,"C:\\Program Files\\Git\\bin\\bash.exe","C:\\Program Files\\Git\\usr\\bin\\bash.exe","C:\\Program Files (x86)\\Git\\bin\\bash.exe",l.join(b.homedir(),"AppData","Local","Programs","Git","bin","bash.exe")].filter(Boolean).find(se)}function Ve(){return process.platform==="win32"&&m().get("usarGitBashNoWindows",!0)?Ae():process.env.SHELL||void 0}function K(){let n=[...(m().get("argumentosPadrao")||[]).map(String).filter(Boolean)],t=String(m().get("argumentoModelo")||"").trim(),a=Ee();return t&&a&&a!=="auto"&&n.push(t,a),n}function B(n){let t=m().get("prefixoPromptPadrao")||"",a=Ee()||C()||"auto",e=J(),o=P(),i=[`Workspace VS Code: ${H()}`,g()?`Diretorio raiz: ${g()}`:"Diretorio raiz: nao ha pasta aberta",`Modelo selecionado: ${a}`,`Agente selecionado: ${e}`,o.length?`Skills disponiveis: ${o.join(", ")}`:""].filter(Boolean).join(`
`),r=e!=="auto"?`Use o perfil/subagente Devin chamado "${e}" quando aplicavel. Se a CLI nao aceitar selecao direta de agente nesta chamada, trate este agente como persona operacional e siga as instrucoes do respectivo AGENT.md.`:"",s=o.length?`Invoque a skill via tool 'skill' quando aplicavel: ${o.map(d=>`"${d}"`).join(", ")}. Siga as instrucoes do respectivo SKILL.md.`:"";return[t,i,r,s,n].filter(Boolean).join(`

`)}function Ue(n){let t=L(y()),a=K().map(L).join(" ");return n?[t,a,"-p","--",L(B(n))].filter(Boolean).join(" "):[t,a].filter(Boolean).join(" ")}function Je(n){return n?String(n).split(/\r?\n/).filter(t=>!/were not migrated because they already exist/i.test(t)).filter(t=>!/migration.*already exist/i.test(t)).join(`
`).trim():""}function Ie(n,t,a){let e=Je(t),o=[n||"",e||"",a&&a.message?a.message:""].join(`
...
`)||"Sem saida do Devin CLI."}function ne(n){let t=Ve(),a=c.window.createTerminal({name:m().get("nomeTerminal")||"Devin Cli Chat",cwd:S(),shellPath:t,shellArgs:process.platform==="win32"&&t?["--login","-i"]:void 0});a.show(!0),a.sendText(Ue(n))}function q(n){return n||"__default__"}function le(n,t){let a=q(n);return O.set(a,Object.assign({sessionId:a,cancelRequested:!1,startedAt:Date.now()},t||{})),O.get(a)}function _(n){return O.get(q(n))}function ce(n){O.delete(q(n))}function Te(){return Array.from(O.keys())}function de(n){let t=_(n);if(!t)return!1;t.cancelRequested=!0;let a=t.process;if(!a||a.killed)return!1;try{return a.kill(),!0}catch(e){return f(`cancelIntegratedRun erro: ${e&&e.message?e.message:String(e)}`),!1}}function Le(n,t){return new Promise(a=>{let e=q(t&&t.sessionId),o=[...K(),"-p","--",B(n)];f(`runIntegrated: session=${e} ${y()} ${o.slice(0,-1).join(" ")} -- [prompt ${B(n).length} chars]`),f(`  cwd: ${S()}`);let i=!1;function r(s){i||(i=!0,ce(e),a(s))}try{let s=D.execFile(y(),o,{cwd:S(),timeout:Number(m().get("timeoutChatMs")||3e5),maxBuffer:16777216,windowsHide:!0},(d,p,h)=>{let x=_(e);if(x&&x.cancelRequested){r("Execucao cancelada pelo usuario.");return}if(d&&f(`runIntegrated erro: code=${d.code} signal=${d.signal} killed=${d.killed} msg=${d.message}`),h&&h.trim()&&f(`runIntegrated stderr: ${h.slice(0,500)}`),p&&p.trim()&&f(`runIntegrated stdout: ${p.slice(0,200)}...`),d&&process.platform==="win32"){ee(n,d,{sessionId:e}).then(r);return}r(Ie(p,h,d))});le(e,{process:s,mode:"integrated"}),s.on("error",d=>{f(`runIntegrated child error: ${d.message}`);let p=_(e);if(p&&p.cancelRequested){r("Execucao cancelada pelo usuario.");return}process.platform==="win32"?ee(n,d,{sessionId:e}).then(r):r(`Falha ao iniciar Devin CLI: ${d.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)})}catch(s){f(`runIntegrated catch: ${s.message}`);let d=_(e);if(d&&d.cancelRequested){r("Execucao cancelada pelo usuario.");return}process.platform==="win32"?ee(n,s,{sessionId:e}).then(r):r(`Falha ao iniciar Devin CLI: ${s.message}

Valide o caminho em devinCliChat.caminhoDevin e execute "Devin Cli Chat: Verificar Devin CLI".`)}})}function ee(n,t,a){return new Promise(e=>{let o=q(a&&a.sessionId),i=Ae();if(!i){e(`Falha ao executar Devin CLI: ${t.message}

Git Bash nao foi encontrado. Configure devinCliChat.gitBashPath ou ajuste devinCliChat.caminhoDevin.`);return}let r=K().map(L).join(" "),s=`${L(y())} ${r} -p -- ${L(B(n))}`,d=D.exec(s,{cwd:S(),shell:i,timeout:Number(m().get("timeoutChatMs")||3e5),maxBuffer:1024*1024*16},(p,h,x)=>{let w=_(o);if(ce(o),w&&w.cancelRequested){e("Execucao cancelada pelo usuario.");return}let E=Ie(h,x,p);e(E.replace("Falha ao executar Devin CLI:","Falha ao executar Devin CLI via Git Bash:"))});le(o,{process:d,mode:"bash"})})}async function k(n,t){await m().update(n,t,c.ConfigurationTarget.Workspace),G(),oe(),v&&v.refreshMeta()}function Ke(){let n=m().get("modelosDisponiveis")||[];return Array.isArray(n)?n.map(String).map(t=>t.trim()).filter(Boolean):[]}function Qe(){let n=m().get("arquivosCacheModelos")||[],t=Array.isArray(n)?n.map(M).filter(Boolean):[];if(process.platform==="win32"){let a=process.env.LOCALAPPDATA||l.join(b.homedir(),"AppData","Local");t.push(l.join(a,"Devin","CLI","team_settings.bin")),t.push(l.join(a,"Devin","CLI","model_configs.bin"))}else t.push(l.join(b.homedir(),".local","share","Devin","CLI","team_settings.bin")),t.push(l.join(b.homedir(),".local","share","Devin","CLI","model_configs.bin"));return Array.from(new Set(t))}function Pe(n){return _e.includes(String(n||"").trim().toLowerCase())}function Ze(){let n=Number(m().get("limiteBytesCacheModelos")||5242880),t=[];for(let a of Qe())try{if(!se(a))continue;let e=u.statSync(a);if(!e.isFile()||e.size>n)continue;let r=u.readFileSync(a).toString("utf8").match(/[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}/g)||[];for(let s of r)Pe(s)&&t.push(s)}catch{}return Array.from(new Set(t))}function Be(){return new Promise(n=>{let t=String(m().get("comandoDescobertaModelos")||"").trim();if(!t){n([]);return}try{D.execFile(y(),t.split(/\s+/),{cwd:S(),timeout:Number(m().get("timeoutDescobertaModelosMs")||2500),windowsHide:!0},(a,e)=>{if(a||!e){n([]);return}try{let i=JSON.parse(e),r=Array.isArray(i)?i:i&&i.models||[];n(r.map(s=>typeof s=="string"?s:s&&(s.name||s.id)).filter(Boolean));return}catch{}let o=e.match(/[a-zA-Z0-9][a-zA-Z0-9._-]{1,80}/g)||[];n(o.filter(Pe))})}catch{n([])}})}function W(){let n=Oe(),t=Date.now();if(n>0&&N.values&&t-N.at<n)return N.values;let a=[C(),re(),...Ke(),...Ze(),...ge()].map($).filter(Boolean),e=Array.from(new Set([...ge(),...a]));return N={at:t,values:e},e}function pe(){let n=Date.now();if(F.values&&n-F.at<ke())return F.values;let t=[M(m().get("diretorioAgentesWorkspace")||".devin/agents"),M(m().get("diretorioAgentesGlobal")||"~/.config/devin/agents")],a=["auto"];for(let o of t)try{if(!o||!u.existsSync(o))continue;for(let i of u.readdirSync(o)){let r=l.join(o,i,"AGENT.md");u.existsSync(r)&&a.push(i)}}catch{}let e=Array.from(new Set(a));return F={at:n,values:e},e}function ue(){let n=Date.now();if(z.values&&n-z.at<ke())return z.values;let t=[M(m().get("diretorioSkillsWorkspace")||".devin/skills"),M(m().get("diretorioSkillsGlobal")||"~/.config/devin/skills"),M(".claude/skills"),M("~/.claude/skills")],a=[];for(let o of t)try{if(!o||!u.existsSync(o))continue;for(let i of u.readdirSync(o)){let r=l.join(o,i,"SKILL.md");u.existsSync(r)&&a.push(i)}}catch{}let e=Array.from(new Set(a)).sort();return z={at:n,values:e},e}function ae(){let n=c.window.activeTextEditor;if(!n)return"Nenhum editor ativo.";let t=n.document,a=n.selection&&!n.selection.isEmpty?t.getText(n.selection):t.getText();return[`Arquivo: ${t.uri.fsPath}`,"Conteudo:","```",a.slice(0,6e4),"```"].join(`
`)}function be(n){return n?Math.max(1,Math.ceil(String(n).length/4)):0}function Xe(n){if(!n||!n.selection||n.selection.isEmpty)return null;let t=n.document,a=n.selection,e=t.getText(a);if(!e||!e.trim())return null;let o=t.uri.fsPath,i=l.basename(o),r=a.start.line+1,s=a.end.line+1;return{id:"sel-"+Date.now().toString(36),file:o,base:i,language:t.languageId,startLine:r,endLine:s,text:e,preview:e.split(`
`).slice(0,2).join(" ").slice(0,80),label:`${i}:${r}-${s}`}}function De(){try{if(m().get("usarContextoEditorAutomatico")===!1)return null;let t=String(m().get("modoContextoEditorAutomatico")||"selecao-ou-arquivo");if(t==="desativado")return null;let a=c.window.activeTextEditor;if(!a)return null;let e=a.document;if(!e||!e.uri||e.uri.scheme!=="file")return null;let o=e.uri.fsPath,i=l.basename(o),r=e.languageId||l.extname(o).slice(1)||"",s="```",d=a.selection,p=!!(d&&!d.isEmpty);if(t!=="somente-arquivo"&&p){let Z=e.getText(d);if(!Z||!Z.trim())return null;let Fe=d.start.line+1,ze=d.end.line+1,ve=`${i}:${Fe}-${ze}`,He=["","",`[Contexto automatico do editor: ${ve}]`,s+r,Z,s].join(`
`);return{label:ve,promptBlock:He}}if(t==="somente-selecao")return null;let h=e.getText();if(!h||!h.trim())return null;let x=Number(m().get("limiteBytesContextoEditorAutomatico")),w=Number.isFinite(x)&&x>0?x:2e5,E=Buffer.from(h,"utf8"),Q=E.length>w,Ne=Q?E.subarray(0,w).toString("utf8"):h,he=Q?`${i} (truncado)`:i,fe=["","",`[Contexto automatico do editor: ${he}]`,s+r,Ne,s];return Q&&fe.push(`[NOTA: arquivo truncado em ${w} bytes para limitar o tamanho do contexto automatico.]`),{label:he,promptBlock:fe.join(`
`)}}catch{return null}}function $e(){try{return D.execFileSync("git",["diff","--no-ext-diff"],{cwd:S(),encoding:"utf8",maxBuffer:1024*1024*8,windowsHide:!0})}catch(n){return`Nao foi possivel obter git diff: ${n.message}`}}function oe(){A||(A=c.window.createStatusBarItem(c.StatusBarAlignment.Right,90),A.command="devinCliChat.abrirPainel",A.show()),A.text=`Devin: ${C()} / ${J()}`,A.tooltip=`Workspace: ${H()} | Modo: ${V()} | Skills: ${P().length}`}async function me(){let n=await c.window.showInputBox({title:"Modelo Devin",prompt:"Aliases aceitos pelo Devin CLI nesta build: auto, sonnet, opus, swe, gpt.",value:C()==="auto"?"":C()});if(!n||!n.trim())return;let t=$(n);t!==String(n).trim().toLowerCase()&&c.window.showInformationMessage(`Modelo "${n.trim()}" nao e aceito por esta versao do Devin CLI. Usando "${t}".`),await k("modeloAtual",t)}async function Ye(){let n=await c.window.showQuickPick([...W(),"+ Informar modelo manual"],{placeHolder:"Selecione o modelo Devin"});if(n){if(n.startsWith("+"))return me();await k("modeloAtual",n)}}async function et(){let n=ue();if(!n.length){c.window.showInformationMessage("Nenhuma skill encontrada em .devin/skills ou ~/.config/devin/skills.");return}let t=new Set(P()),a=n.map(o=>({label:o,picked:t.has(o)})),e=await c.window.showQuickPick(a,{canPickMany:!0,placeHolder:"Selecione skills disponiveis para o Devin"});e&&await k("skillsSelecionadas",e.map(o=>o.label))}function I(){try{return R&&R.globalState.get(we)||[]}catch{return[]}}async function j(n){try{R&&await R.globalState.update(we,n.slice(0,je))}catch{}}var ie=class{constructor(t){this.context=t,this.view=void 0,this.busy=!1,this.session=this.newSession()}newSession(){return{id:"sess-"+Date.now().toString(36)+"-"+Math.random().toString(36).slice(2,6),title:"Nova conversa",createdAt:Date.now(),updatedAt:Date.now(),workspace:H(),model:C(),agent:J(),mode:V(),skills:P(),messages:[]}}async persistSession(){if(!this.session||!this.session.messages.length)return;let t=I(),a=t.findIndex(e=>e.id===this.session.id);if(this.session.updatedAt=Date.now(),!this.session.title||this.session.title==="Nova conversa"){let e=this.session.messages.find(o=>o.role==="user");e&&(this.session.title=String(e.text).slice(0,60).replace(/\s+/g," ").trim())}a>=0?t[a]=this.session:t.unshift(this.session),t.sort((e,o)=>(o.updatedAt||0)-(e.updatedAt||0)),await j(t)}resolveWebviewView(t){this.view=t,t.webview.options={enableScripts:!0,localResourceRoots:[this.context.extensionUri]},t.webview.html=this.html(t.webview),f("WebView resolvida e HTML injetado."),t.webview.onDidReceiveMessage(async a=>{try{let e=a&&a.type;if(f(`Mensagem recebida do webview: type=${e}`),e==="ready"){this.refreshMeta(),this.replaySession(),this.pushCurrentSelection();return}if(e==="clientError"){f(`ERRO no cliente webview: ${a.text||"sem detalhes"}`),this.post({type:"message",role:"assistant",text:"Falha no painel: "+(a.text||"erro sem detalhes")});return}if(e==="cancelRun"){let o=de(this.session&&this.session.id);this.post({type:"action",ok:o,text:o?"Cancelamento solicitado.":"Nenhuma execucao integrada ativa para cancelar."});return}if(e==="verifyCli"){this.verifyCli();return}if(e==="requestSelection"){this.pushCurrentSelection(!0);return}if(e==="attachMenu"){await this.chooseAttachSource();return}if(e==="attachFiles"){await this.attachFiles();return}if(e==="pickWorkspaceFiles"){await this.pickWorkspaceFiles();return}if(e==="listWorkspace"){this.listWorkspaceDir(a.path||"");return}if(e==="attachFolder"){await this.attachFolder(a.path||"");return}if(e==="attachWorkspacePath"){await this.attachWorkspacePath(a.path||"");return}if(e==="send"){await this.send(a.text||"",{echoUser:a.echo!==!1,displayText:a.displayText||a.text||"",hasExplicitContext:!!a.hasExplicitContext});return}if(e==="terminal"){ne(a.text||""),this.post({type:"action",ok:!0,text:"Terminal aberto."});return}if(e==="setModel"){await k("modeloAtual",$(a.value||"auto"));return}if(e==="setMode"){await k("modoExecucaoChat",a.value||"resposta-integrada");return}if(e==="setAgent"){await k("agenteAtual",a.value||"auto");return}if(e==="toggleSkill"){let o=new Set(P());a.value&&o.has(a.value)?o.delete(a.value):a.value&&o.add(a.value),await k("skillsSelecionadas",Array.from(o));return}if(e==="manualModel"){await me();return}if(e==="refreshModels"){this.refreshMeta();let o=await Be();if(o.length){let i=Array.from(new Set([...m().get("modelosDisponiveis")||[],...o]));await m().update("modelosDisponiveis",i,c.ConfigurationTarget.Workspace)}this.refreshMeta(),this.post({type:"action",ok:!0,text:"Modelos atualizados ("+W().length+" disponiveis)."});return}if(e==="review"){await this.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+$e()+"\n```",{echoUser:!0});return}if(e==="selection"){await this.send(`Analise o contexto do editor atual.

`+ae(),{echoUser:!0});return}if(e==="insertSelection"){this.post({type:"insertPrompt",text:`Analise o contexto do editor atual.

`+ae()});return}if(e==="newChat"){await this.persistSession(),this.session=this.newSession(),this.post({type:"clearThread"}),this.refreshMeta();return}if(e==="getHistory"){await this.openHistory();return}if(e==="loadSession"){await this.persistSession();let i=I().find(r=>r.id===a.id);i&&(this.session=JSON.parse(JSON.stringify(i)),this.post({type:"clearThread"}),this.replaySession(),this.refreshMeta(),this.post({type:"action",ok:!0,text:"Sessao carregada: "+(i.title||i.id)}));return}if(e==="deleteSession"){let o=I().filter(i=>i.id!==a.id);await j(o),this.session&&this.session.id===a.id&&(this.session=this.newSession(),this.post({type:"clearThread"})),this.post({type:"history",sessions:o}),this.refreshMeta();return}if(e==="clearHistory"){await j([]),this.session=this.newSession(),this.post({type:"clearThread"}),this.post({type:"history",sessions:[]}),this.refreshMeta();return}this.post({type:"action",ok:!1,text:`Acao desconhecida: ${e}`})}catch(e){this.busy=!1,this.post({type:"busy",value:!1}),f(`ERRO no handler do webview: ${e&&e.message?e.message:String(e)}`),e&&e.stack&&f(e.stack),this.post({type:"message",role:"assistant",text:"Falha ao executar acao do painel: "+(e&&e.message?e.message:String(e))})}}),setTimeout(()=>this.refreshMeta(),50)}post(t){try{this.view&&this.view.webview.postMessage(t)}catch{}}async openHistory(){await this.persistSession();let t=I().filter(a=>a&&a.messages&&a.messages.length);this.post({type:"openHistory",sessions:t}),this.refreshMeta()}verifyCli(){T.show(!0),f(`Verificando Devin CLI pelo painel: ${y()}`),D.execFile(y(),["--version"],{cwd:S(),windowsHide:!0},(t,a,e)=>{if(t){let r=`Falha ao verificar Devin CLI: ${t.message}`;f(r),this.post({type:"message",role:"assistant",text:r}),this.post({type:"action",ok:!1,text:r});return}let i=`Devin CLI encontrado: ${(a||e||"ok").trim()}`;f(i),this.post({type:"message",role:"assistant",text:i}),this.post({type:"action",ok:!0,text:i})})}pushCurrentSelection(t){let a=c.window.activeTextEditor,e=Xe(a);e&&this.post({type:"selectionAvailable",selection:e})}attachmentId(t){return t+"-"+Date.now().toString(36)+Math.random().toString(36).slice(2,7)}readFileItem(t,a){let e=u.statSync(t);if(e.size>X)return{skipped:!0,reason:`Arquivo muito grande: ${l.basename(t)} (${e.size} bytes).`};let o=u.readFileSync(t,"utf8"),i=l.extname(t).slice(1);return{id:this.attachmentId("file"),file:t,base:l.basename(t),label:a||l.basename(t),type:"file",text:o,language:i,lines:o.split(`
`).length}}readFolderItem(t,a){let e=g(),o=a||l.basename(t)||"workspace",i=[],r=[t];for(;r.length&&i.length<Y;){let s=r.pop(),d;try{d=u.readdirSync(s,{withFileTypes:!0})}catch{continue}for(let p of d){let h=l.join(s,p.name);if(p.isDirectory())!Re.has(p.name)&&!p.name.startsWith(".")&&r.push(h);else if(p.isFile())try{if(u.statSync(h).size>X)continue;let w=u.readFileSync(h,"utf8"),E=e&&h.startsWith(e)?l.relative(e,h):l.join(o,l.relative(t,h));if(i.push({file:h,rel:E.replace(/\\/g,"/"),base:l.basename(h),text:w,language:l.extname(h).slice(1),lines:w.split(`
`).length}),i.length>=Y)break}catch{}}}return{id:this.attachmentId("folder"),file:t,base:o,label:`${o} (${i.length})`,type:"folder",files:i,count:i.length,truncated:i.length>=Y}}async chooseAttachSource(){let t=await c.window.showQuickPick([{label:"$(folder) Pastas",description:"Anexar pasta recursivamente como chip unico",value:"folders"},{label:"$(file) Arquivos abertos",description:"Anexar arquivos atualmente abertos no editor",value:"openFiles"}],{placeHolder:"Anexar contexto ao Devin"});if(!t)return;if(t.value==="folders"){let s=await c.window.showOpenDialog({canSelectMany:!0,canSelectFiles:!1,canSelectFolders:!0,defaultUri:g()?c.Uri.file(g()):void 0,openLabel:"Anexar pasta"});if(!s||!s.length)return;let d=[];for(let p of s)try{let h=this.readFolderItem(p.fsPath,l.basename(p.fsPath));h.files&&h.files.length&&d.push(h)}catch(h){this.post({type:"action",ok:!1,text:`Falha ao anexar pasta ${p.fsPath}: ${h.message}`})}d.length&&this.post({type:"attachItems",items:d}),this.post({type:"action",ok:!0,text:`Anexadas ${d.length} pasta(s).`});return}let a=c.workspace.textDocuments.filter(s=>s.uri&&s.uri.scheme==="file"&&!s.isUntitled);if(!a.length){this.post({type:"action",ok:!1,text:"Nenhum arquivo aberto para anexar."});return}let e=g()||"",o=a.map(s=>({label:"$(file) "+l.basename(s.uri.fsPath),description:e?l.dirname(l.relative(e,s.uri.fsPath)):l.dirname(s.uri.fsPath),detail:s.uri.fsPath,doc:s})),i=await c.window.showQuickPick(o,{canPickMany:!0,placeHolder:"Selecione arquivos abertos para anexar"});if(!i||!i.length)return;let r=[];for(let s of i){let d=s.doc,p=d.getText();if(Buffer.byteLength(p,"utf8")>X){this.post({type:"action",ok:!1,text:`Arquivo muito grande: ${l.basename(d.uri.fsPath)}.`});continue}r.push({id:this.attachmentId("file"),file:d.uri.fsPath,base:l.basename(d.uri.fsPath),label:l.basename(d.uri.fsPath),type:"file",text:p,language:d.languageId||l.extname(d.uri.fsPath).slice(1),lines:p.split(`
`).length})}r.length&&this.post({type:"attachItems",items:r})}async attachFiles(){try{let t=await c.window.showOpenDialog({canSelectMany:!0,canSelectFiles:!0,canSelectFolders:!1,defaultUri:g()?c.Uri.file(g()):void 0,openLabel:"Anexar ao chat"});if(!t||!t.length)return;let a=[];for(let e of t)try{let o=u.statSync(e.fsPath);if(o.size>1024*1024){a.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:e.fsPath,base:l.basename(e.fsPath),label:l.basename(e.fsPath),type:"file",text:`Arquivo ${e.fsPath} muito grande (${o.size} bytes) - nao anexado.`,language:"",tooBig:!0});continue}let i=u.readFileSync(e.fsPath,"utf8"),r=l.extname(e.fsPath).slice(1);a.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:e.fsPath,base:l.basename(e.fsPath),label:l.basename(e.fsPath),type:"file",text:i,language:r,lines:i.split(`
`).length})}catch(o){this.post({type:"action",ok:!1,text:`Falha ao ler ${e.fsPath}: ${o.message}`})}a.length&&this.post({type:"attachItems",items:a})}catch(t){this.post({type:"action",ok:!1,text:"Falha ao anexar: "+(t&&t.message?t.message:String(t))})}}async pickWorkspaceFiles(){try{let t=await c.workspace.findFiles("**/*","**/{node_modules,.git,dist,build,out,.venv,__pycache__}/**",5e3);if(!t.length){this.post({type:"action",ok:!1,text:"Nenhum arquivo encontrado."});return}let a=g()||"",e=t.map(r=>({label:l.relative(a,r.fsPath)||l.basename(r.fsPath),description:"",uri:r})),o=await c.window.showQuickPick(e,{placeHolder:"Selecione arquivos do workspace para anexar",canPickMany:!0,matchOnDescription:!0});if(!o||!o.length)return;let i=[];for(let r of o)try{if(u.statSync(r.uri.fsPath).size>1024*1024)continue;let d=u.readFileSync(r.uri.fsPath,"utf8"),p=l.extname(r.uri.fsPath).slice(1);i.push({id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:r.uri.fsPath,base:l.basename(r.uri.fsPath),label:l.basename(r.uri.fsPath),type:"file",text:d,language:p})}catch{}i.length&&this.post({type:"attachItems",items:i})}catch(t){this.post({type:"action",ok:!1,text:"Falha: "+(t&&t.message?t.message:String(t))})}}listWorkspaceDir(t){try{let a=g();if(!a){this.post({type:"workspaceList",path:t||"",entries:[],error:"Sem workspace aberto."});return}let e=U(t||"");if(!e){this.post({type:"workspaceList",path:"",entries:[],error:"Diretorio fora do workspace."});return}if(!u.existsSync(e)||!u.statSync(e).isDirectory()){this.post({type:"workspaceList",path:"",entries:[],error:"Diretorio invalido."});return}let o=l.relative(a,e).replace(/\\/g,"/"),i=new Set(["node_modules",".git","dist","build","out",".venv","__pycache__",".next",".nuxt",".cache","target",".idea"]),r=u.readdirSync(e,{withFileTypes:!0}).filter(s=>!s.name.startsWith(".")||[".cognition",".devin",".claude",".cursor",".vscode"].includes(s.name)).filter(s=>!(s.isDirectory()&&i.has(s.name))).map(s=>{let d=0;try{s.isFile()&&(d=u.statSync(l.join(e,s.name)).size)}catch{}return{name:s.name,isDir:s.isDirectory(),size:d}}).sort((s,d)=>d.isDir-s.isDir||s.name.localeCompare(d.name));this.post({type:"workspaceList",path:o,entries:r})}catch(a){this.post({type:"workspaceList",path:"",entries:[],error:a.message})}}async attachWorkspacePath(t){if(!g())return;let e=U(t||"");if(!e){this.post({type:"action",ok:!1,text:"Caminho fora do workspace."});return}if(!u.existsSync(e)){this.post({type:"action",ok:!1,text:"Caminho invalido."});return}if(u.statSync(e).isDirectory()){await this.attachFolder(t);return}try{let o=u.statSync(e);if(o.size>1024*1024){this.post({type:"action",ok:!1,text:`Arquivo muito grande: ${l.basename(e)} (${o.size} bytes).`});return}let i=u.readFileSync(e,"utf8"),r=l.extname(e).slice(1);this.post({type:"attachItems",items:[{id:"file-"+Date.now().toString(36)+Math.random().toString(36).slice(2,5),file:e,base:l.basename(e),label:l.basename(e),type:"file",text:i,language:r}]})}catch(o){this.post({type:"action",ok:!1,text:"Falha: "+o.message})}}async attachFolder(t){let a=g();if(!a)return;let e=U(t||"");if(!e){this.post({type:"action",ok:!1,text:"Pasta fora do workspace."});return}let o=l.relative(a,e).replace(/\\/g,"/");if(!u.existsSync(e)||!u.statSync(e).isDirectory()){this.post({type:"action",ok:!1,text:"Pasta invalida."});return}let i=this.readFolderItem(e,o?l.basename(e):H());i.files&&i.files.length&&this.post({type:"attachItems",items:[i]}),this.post({type:"action",ok:!0,text:`Pasta anexada como chip unico: ${i.label}.`})}replaySession(){if(!(!this.session||!this.session.messages.length))for(let t of this.session.messages)this.post({type:"message",role:t.role,text:t.text,replay:!0})}refreshMeta(){let t={type:"meta",models:te,model:C(),agents:["auto"],agent:J(),skills:[],selectedSkills:P(),mode:V(),workspace:H(),sessionId:this.session&&this.session.id,sessionTitle:this.session&&this.session.title,modelLocked:!1,hasMessages:!!(this.session&&this.session.messages&&this.session.messages.length),tokensTotal:this.session&&this.session.tokens||0,tokensIn:this.session&&this.session.tokensIn||0,tokensOut:this.session&&this.session.tokensOut||0,modelStatus:"modelo: auto"};try{t.models=W()}catch{t.models=te}try{t.agents=pe()}catch{t.agents=["auto"]}try{t.skills=ue()}catch{t.skills=[]}try{t.recentSessions=I().slice(0,3).map(a=>({id:a.id,title:a.title||"Sem titulo",updatedAt:a.updatedAt,messages:(a.messages||[]).length,model:a.model||"auto"}))}catch{t.recentSessions=[]}try{t.modelStatus=`${t.models.length} modelos | ${t.skills.length} skills`}catch{}this.post(t)}async send(t,a){let e=String(t||"").trim();if(!e)return;let o=String(a&&a.displayText?a.displayText:e).trim(),i=null;if(!a||!a.hasExplicitContext){let s=De();s&&s.promptBlock&&(e=e+s.promptBlock,o=o+`

[Contexto automatico: `+s.label+"]",i=s.label)}if(this.busy){this.post({type:"message",role:"assistant",text:"Ja existe uma execucao em andamento. A concorrencia permanece controlada no backend."});return}this.busy=!0;let r=be(B(e));this.session.tokensIn=(this.session.tokensIn||0)+r,this.session.tokens=(this.session.tokens||0)+r,(!a||a.echoUser!==!1)&&this.post({type:"message",role:"user",text:o}),this.session.messages.push({role:"user",text:o,fullText:e,ts:Date.now(),tokens:r}),this.post({type:"busy",value:!0}),i&&this.post({type:"ctxHint",text:"\u{1F4C4} Contexto automatico: "+i}),this.post({type:"action",ok:!0,text:"Enviando para o Devin CLI..."}),this.refreshMeta();try{let s=V();if(f(`send: modo=${s} prompt=${e.length} chars`),s==="terminal"){ne(e);let h="Sessao aberta no terminal integrado, ja posicionada na pasta aberta no VS Code.";this.post({type:"message",role:"assistant",text:h}),this.session.messages.push({role:"assistant",text:h,ts:Date.now()});return}let d=await Le(e,{sessionId:this.session.id});f(`send: resposta recebida (${d?d.length:0} chars)`);let p=be(d);this.session.tokensOut=(this.session.tokensOut||0)+p,this.session.tokens=(this.session.tokens||0)+p,this.post({type:"message",role:"assistant",text:d}),this.session.messages.push({role:"assistant",text:d,ts:Date.now(),tokens:p})}catch(s){f(`send ERRO: ${s&&s.message?s.message:String(s)}`);let d="Falha ao enviar para o Devin CLI: "+(s&&s.message?s.message:String(s));this.post({type:"message",role:"assistant",text:d}),this.session.messages.push({role:"assistant",text:d,ts:Date.now()})}finally{this.busy=!1,this.post({type:"busy",value:!1}),await this.persistSession(),this.refreshMeta()}}html(t){let a=Date.now().toString(36),e={history:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M8 4.5V8l2.4 1.6"/></svg>',plus:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"><path d="M8 3v10M3 8h10"/></svg>',refresh:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M13 8a5 5 0 1 1-1.5-3.55"/><path d="M13 3v3h-3"/></svg>',terminal:'<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="12" height="10" rx="1.5"/><path d="M5 7l2 1.5L5 10M8.5 10.5h3"/></svg>',lock:'<svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="7" width="9" height="6.5" rx="1"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2"/></svg>',paperclip:'<svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M11.5 6.5L6.8 11.2a2 2 0 0 1-2.8-2.8l5.4-5.4a3 3 0 0 1 4.2 4.2l-5.4 5.4a4 4 0 0 1-5.7-5.7L7.5 2.5"/></svg>',attach:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M11.5 6.5L6.8 11.2a2 2 0 0 1-2.8-2.8l5.4-5.4a3 3 0 0 1 4.2 4.2l-5.4 5.4a4 4 0 0 1-5.7-5.7L7.5 2.5"/></svg>',file:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M3 1.5h6.5L13 5v9.5H3z"/><path d="M9.5 1.5V5H13"/></svg>',folder:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4.5a1 1 0 0 1 1-1h3l1.5 1.5h5.5a1 1 0 0 1 1 1V12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1z"/></svg>',close:'<svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M4 4l8 8M12 4l-8 8"/></svg>',send:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><path d="M2 13.5L14 8 2 2.5 2 7l8 1-8 1z"/></svg>',brain:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M5.5 3a2 2 0 0 0-2 2 2 2 0 0 0-1 3.5 2 2 0 0 0 1.5 3 2 2 0 0 0 3.5 0V3.5A1.5 1.5 0 0 0 5.5 3z"/><path d="M10.5 3a2 2 0 0 1 2 2 2 2 0 0 1 1 3.5 2 2 0 0 1-1.5 3 2 2 0 0 1-3.5 0V3.5A1.5 1.5 0 0 1 10.5 3z"/></svg>',bot:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5.5" width="10" height="7" rx="1.5"/><path d="M8 3v2.5M5.5 8.5h.01M10.5 8.5h.01M2 9.5v1.5M14 9.5v1.5"/></svg>',mode:'<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><path d="M2 5.5h12M2 8h8M2 10.5h10"/></svg>',sparkle:'<svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><path d="M8 2l1.2 3.4L12.5 6.5 9.2 7.6 8 11l-1.2-3.4L3.5 6.5 6.8 5.4z"/></svg>',caret:'<svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor"><path d="M5 3l6 5-6 5z"/></svg>'},o=[{label:"auto",value:"auto"},{label:"sonnet",value:"sonnet"},{label:"opus",value:"opus"},{label:"swe",value:"swe"},{label:"gpt",value:"gpt"}];return`<!doctype html><html lang="pt-BR"><head><meta charset="UTF-8"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src ${t.cspSource} data:; style-src 'unsafe-inline' ${t.cspSource}; script-src 'nonce-${a}';"><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>
...
</script></body></html>`}};async function tt(n){R=n,T=c.window.createOutputChannel("Devin Cli Chat"),n.subscriptions.push(T),f(`Extens\xE3o ativando \u2014 VS Code ${c.version}, extens\xE3o ${n.extension.packageJSON.version}`),f(`Plataforma: ${process.platform} ${process.arch}`),f(`Devin CLI path configurado: ${y()}`),f(`Workspace: ${g()||"nenhum"}`),v=new ie(n),n.subscriptions.push(c.window.registerWebviewViewProvider("devinCliChat.chatView",v,{webviewOptions:{retainContextWhenHidden:!0}})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirPainel",async()=>c.commands.executeCommand("workbench.view.extension.devinCliChat"))),n.subscriptions.push(c.commands.registerCommand("devinCliChat.abrirHistorico",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),setTimeout(()=>{v&&v.openHistory()},100)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.novaSessao",()=>ne(""))),n.subscriptions.push(c.commands.registerCommand("devinCliChat.revisarDiff",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),v&&await v.send("Revise o git diff atual com foco em bugs, seguranca, testes, impacto produtivo e rollback.\n\n```diff\n"+$e()+"\n```")})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.enviarSelecao",async()=>{await c.commands.executeCommand("workbench.view.extension.devinCliChat"),v&&await v.send(`Analise o contexto do editor atual.

`+ae())})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarModelo",Ye)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.definirModeloManual",me)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.atualizarModelos",async()=>{G(),v&&v.refreshMeta();let e=await Be();if(e.length){let o=Array.from(new Set([...m().get("modelosDisponiveis")||[],...e]));await m().update("modelosDisponiveis",o,c.ConfigurationTarget.Workspace),G()}v&&v.refreshMeta(),c.window.showInformationMessage(`Modelos atualizados (${W().length} disponiveis).`)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarAgente",async()=>{let e=await c.window.showQuickPick(pe(),{placeHolder:"Selecione o agente Devin"});e&&await k("agenteAtual",e)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarSkills",et)),n.subscriptions.push(c.commands.registerCommand("devinCliChat.selecionarModo",async()=>{let e=await c.window.showQuickPick([{label:"Integrado (resposta no chat)",value:"resposta-integrada"},{label:"Terminal",value:"terminal"}],{placeHolder:"Selecione o modo de execucao"});e&&await k("modoExecucaoChat",e.value)})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.limparHistorico",async()=>{await c.window.showWarningMessage("Limpar todo o historico de chats?",{modal:!0},"Limpar")==="Limpar"&&(await j([]),v&&v.post({type:"history",sessions:[]}))})),n.subscriptions.push(c.commands.registerCommand("devinCliChat.verificarCli",()=>{T.show(!0),f(`Verificando Devin CLI: ${y()}`),D.execFile(y(),["--version"],{cwd:S(),windowsHide:!0},(e,o,i)=>{if(e)f(`verificarCli ERRO: code=${e.code} msg=${e.message}`),c.window.showErrorMessage(`Falha ao verificar Devin CLI: ${e.message}`);else{let r=(o||i||"ok").trim();f(`verificarCli OK: ${r}`),c.window.showInformationMessage(`Devin CLI encontrado: ${r}`)}})}));let t,a=()=>{t&&clearTimeout(t),t=setTimeout(()=>{v&&v.pushCurrentSelection(!0)},150)};n.subscriptions.push(c.window.onDidChangeTextEditorSelection(a)),n.subscriptions.push(c.window.onDidChangeActiveTextEditor(a)),n.subscriptions.push(c.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration(ye)&&(G(),oe(),v&&v.refreshMeta())})),oe()}function nt(){for(let n of Te())de(n)}module.exports={activate:tt,deactivate:nt,_internal:{baseArgs:K,fullPrompt:B,runIntegrated:Le,modelsForUi:W,scanAgents:pe,scanSkills:ue,loadHistory:I,saveHistory:j,sanitizeModel:$,isSafeModelId:Ce,cancelIntegratedRun:de,automaticEditorContext:De,resolveWorkspacePathSafe:U,registerRunState:le,unregisterRunState:ce,activeRunIds:Te}};
